...
//        softAssert.assertEquals(CommonUtils.getTextOfSelectedDropDownOption(nativeViewCHARMSParticipantDetailsPage.contactCountryInputField), ras_Screener_TestDataManager.COUNTRY_OPTION, "-- VERIFYING CONTACT COUNTRY --");
        softAssert.assertEquals(CommonUtils.getAttributeValueOfValueAttribute(nativeViewCHARMSParticipantDetailsPage.contactCountryInputField), ras_Screener_TestDataManager.COUNTRY_OPTION, "-- VERIFYING CONTACT COUNTRY --");
