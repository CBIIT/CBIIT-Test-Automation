...
public class MetforminScreenerStepsImpl extends PageInitializer {
    ...
    private void metforminReferralPageFinalQuestionsAssertion() {
        ...
        CharmsUtil.assertDropDownData(softAssert, metforminScreenerPage.dynamicLocatorForSelectElement("hear_about_this_study"), metforminScreener_TestDataManager.howDidYouTheParticipantHearAboutThisStudy, " How did you hear about this study? Value of the Final Questions tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorUsingNormalizeSpaceInSpan("Health Care Provider Name"), "Health Care Provider Name", " Health Care Provider Name label of the Final Questions tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorForInputElementsOfFamily("health_care_prov_name"), metforminScreener_TestDataManager.name, " Health Care Provider Name Value of the Final Questions tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorUsingNormalizeSpaceInSpan("Health Care Provider Address"), "Health Care Provider Address", " Health Care Provider Address label of the Final Questions tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorForTextArea("health_care_prov_address"), metforminScreener_TestDataManager.address, " Health Care Provider Address Value of the Final Questions tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorUsingNormalizeSpaceInSpan("Health Care Provider Phone Number"), "Health Care Provider Phone Number", " Health Care Provider Phone Number label of the Final Questions tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorForInputElementsOfFamily("health_care_prov_phone_number"), metforminScreener_TestDataManager.medicalPhoneNumber, " Health Care Provider Phone Number Value of the Final Questions tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorUsingNormalizeSpaceInSpan("Permission to contact Provider"), "Permission to contact Provider", " Permission to contact Provider label of the Final Questions tab in Metformin Referral page ");
        CharmsUtil.assertDropDownData(softAssert, metforminScreenerPage.dynamicLocatorForSelectElement("permission_to_contact_provi"), metforminScreener_TestDataManager.doWeHaveYourTheParticipantsPermissionToCallThisIndividualToSeekMoreInformation, " Permission to contact Provider Value of the Final Questions tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorUsingContainsText("Main reasons for participating in this study?"), "Main reasons for participating in this study? Select all that apply.", " Main reasons for participating in this study? Select all that apply. label of the Final Questions tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.nVMetforminScreenerMainReasonsForParticipating, metforminScreener_TestDataManager.whatAreTheMainReasonsForParticipatingInThisStudySelectAllThatApply, " Main reasons for participating in this study? Select all that apply. Value of the Final Questions tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorUsingContainsText("Receive genetic testing"), "Receive genetic testing", " Receive genetic testing label of the Final Questions tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorForTextArea("receive_genetic_testing"), metforminScreener_TestDataManager.receiveGeneticTesting, " Receive genetic testing Value of the Final Questions tab in Metformin Referral page "); }
    ...
    private void metforminReferralPageReferralPatientCancersAssertion() {
        ...
        CharmsUtil.clickOnElement(metforminScreenerPage.dynamicLocatorWithAUsingNormalizeSpace("Open Record"));
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorUsingSpanNormalizeSpace(MetforminScreenerConstants.TUMOR_TYPE), MetforminScreenerConstants.TUMOR_TYPE, "Tumor Type label of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.nVMetforminScreenerTumorTypeInput, metforminScreener_TestDataManager.tumorType, " Tumor Type Value  of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorUsingSpanNormalizeSpace(MetforminScreenerConstants.ADDITIONAL_INFORMATION), MetforminScreenerConstants.ADDITIONAL_INFORMATION, "Additional Information label of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorForCancerInputElements("please_specify"), metforminScreener_TestDataManager.additionalInformation, " Additional Information Value  of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorUsingSpanNormalizeSpace(MetforminScreenerConstants.MONTH_OF_DIAGNOSIS), MetforminScreenerConstants.MONTH_OF_DIAGNOSIS, "Month of diagnosis label of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertDropDownData(softAssert, metforminScreenerPage.dynamicLocatorForCancerSelectElements("month_of_diagnosis"), metforminScreener_TestDataManager.monthOfDiagnosis, " Month of diagnosis Value  of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorUsingSpanNormalizeSpace(MetforminScreenerConstants.YEAR_OF_DIAGNOSIS), MetforminScreenerConstants.YEAR_OF_DIAGNOSIS, "Year of diagnosis label of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorForCancerInputElements("year_of_diagnosis"), metforminScreener_TestDataManager.yearOfDiagnosis, " Year of diagnosis Value  of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorUsingSpanNormalizeSpace("Age at Diagnosis"), "Age at Diagnosis", "Age at Diagnosis label of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorForCancerInputElements("age_in_years_at_diagnosis"), metforminScreener_TestDataManager.ageAtDiagnosis, "Age at Diagnosis value of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorUsingSpanNormalizeSpace(MetforminScreenerConstants.CURRENTLY_BEING_TREATED), MetforminScreenerConstants.CURRENTLY_BEING_TREATED, "Currently being treated label of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertDropDownData(softAssert, metforminScreenerPage.dynamicLocatorForCancerSelectElements("currently_being_treated"), metforminScreener_TestDataManager.areYouTheParticipantCurrentlyReceivingTreatment, " Currently being treated Value of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorUsingSpanNormalizeSpace(MetforminScreenerConstants.TREATMENT_INSTITUTION), MetforminScreenerConstants.TREATMENT_INSTITUTION, "Treatment Institution label of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorForCancerInputElements("treatment_institution"), metforminScreener_TestDataManager.pleaseProvideTheNameOfTheInstitutionWhereTheCancerWasTreated, " Treatment Institution Value  of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorUsingSpanNormalizeSpace(MetforminScreenerConstants.TREATING_PHYSICIAN), MetforminScreenerConstants.TREATING_PHYSICIAN, "Treating Physician label of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorForCancerInputElements("treating_physician"), metforminScreener_TestDataManager.pleaseProvideTheNameOfTheTreatingPhysician, " Treating Physician Value  of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorUsingSpanNormalizeSpace("Name of institution or clinic where biopsy occurred"), "Name of institution or clinic where biopsy occurred", "Name of institution or clinic where biopsy occurred label of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorForCancerInputElements("biopsy_institution"), "", " Name of institution or clinic where biopsy occurred Value  of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorUsingSpanNormalizeSpace("Name of physician who performed the biopsy"), "Name of physician who performed the biopsy", "Name of physician who performed the biopsy label of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorForCancerInputElements("biopsy_physician"), "", " Name of physician who performed the biopsy Value  of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorUsingSpanNormalizeSpace("Name of Institution where Cancer was diagnosed"), "Name of Institution where Cancer was diagnosed", "Name of Institution where Cancer was diagnosed label of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorForCancerInputElements("institute_diagnosed"), metforminScreener_TestDataManager.pleaseProvideTheNameOfTheInstitutionWhereTheCancerWasDiagnosed, " Name of Institution where Cancer was diagnosed Value of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.dynamicLocatorUsingSpanNormalizeSpace("Additional Details"), "Additional Details", "Additional Details label of the Referral Patient Cancer tab in Metformin Referral page ");
        CharmsUtil.assertTextBoxData(softAssert, metforminScreenerPage.nVMetforminScreenerAdditionalDetailsInput, metforminScreener_TestDataManager.additionalDetails, " Additional Details Value of the Referral Patient Cancer tab in Metformin Referral page ");
    }
