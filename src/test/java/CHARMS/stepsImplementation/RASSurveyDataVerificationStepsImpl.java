...
import static CHARMS.pages.RAS_Survey_Native_View_Page.dynamicInputFieldLocator;
...
public class RASSurveyDataVerificationStepsImpl extends PageInitializer {
    ...
    public void ras_survey_Data_for_scenario_one_is_verified() {
        ...
        CommonUtils.clickOnElement(nativeViewCHARMSParticipantDetailsPage.openRecordButton);
        /**
     ...
     */
    public void verify_ras_survey_data_scenarioTwo_vision_section() {
        clickTab("Vision (");
