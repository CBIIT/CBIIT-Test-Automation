...
public class RAS_Survey_Data_Verification_Steps extends PageInitializer {
    ...
    public static void verify_ras_survey_data_scenarioTwo_bleeding_issues_section() {
        ...
        verifyCheckbox("true", ras_survey_native_view.participantBleedingIssuesDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Bleeding Issues - Easy bruising\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        ...
        verifyCheckbox("true", ras_survey_native_view.participantBleedingIssuesDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Bleeding Issues - Easy bruising\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyCheckbox("true", ras_survey_native_view.participantBleedingIssuesDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Bleeding Issues - Platelet dysfunction\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantBleedingIssuesTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteBleedingBruisingIssuesListedColumn7Option2, "* * * * * RAS SURVEY MISMATCH IN \"Bleeding Issues - Platelet dysfunction\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantBleedingIssuesNameOfTreatingHospitalOrPhysicianInputField, ras_Survey_TestDataManager.pleaseCompleteBleedingBruisingIssuesListedColumn8Option2, "* * * * * RAS SURVEY MISMATCH IN \"Bleeding Issues - Platelet dysfunction\" section 'Name of treating hospital or physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantBleedingIssuesDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteBleedingBruisingIssuesListedColumn1Option2, "* * * * * RAS SURVEY MISMATCH IN \"Bleeding Issues - Platelet dysfunction\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantBleedingIssuesDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Bleeding Issues - Platelet dysfunction\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyCheckbox("true", ras_survey_native_view.participantBleedingIssuesDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Bleeding Issues - Clotting disorder\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantBleedingIssuesTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteBleedingBruisingIssuesListedColumn7Option3, "* * * * * RAS SURVEY MISMATCH IN \"Bleeding Issues - Clotting disorder\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantBleedingIssuesNameOfTreatingHospitalOrPhysicianInputField, ras_Survey_TestDataManager.pleaseCompleteBleedingBruisingIssuesListedColumn8Option3, "* * * * * RAS SURVEY MISMATCH IN \"Bleeding Issues - Clotting disorder\" section 'Name of treating hospital or physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantBleedingIssuesDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteBleedingBruisingIssuesListedColumn1Option3, "* * * * * RAS SURVEY MISMATCH IN \"Bleeding Issues - Clotting disorder\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantBleedingIssuesDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Bleeding Issues - Clotting disorder\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        CommonUtils.hoverOverElement(locateByXpath("//tr[contains(@id,'row_x_naci_family_coho_rasopathy_iiq.x_naci_family_coho_participant_bleeding_issues.iiq')]//td//a[@aria-label='Preview record: Other (please specify)']"));
        JavascriptUtils.clickByJS(locateByXpath("//tr[contains(@id,'row_x_naci_family_coho_rasopathy_iiq.x_naci_family_coho_participant_bleeding_issues.iiq')]//td//a[@aria-label='Preview record: Other (please specify)']"));
        CommonUtils.sleep(800);
        CommonUtils.waitForClickability(locateByXpath("//a[normalize-space()='Open Record']"));
        JavascriptUtils.clickByJS(locateByXpath("//a[normalize-space()='Open Record']"));
        CommonUtils.sleep(800);
        ...
        verifyCheckbox("true", ras_survey_native_view.participantBleedingIssuesDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Bleeding Issues - Other (please specify)\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantBleedingIssuesTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteBleedingBruisingIssuesListedColumn7Option4, "* * * * * RAS SURVEY MISMATCH IN \"Bleeding Issues - Other (please specify)\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantBleedingIssuesNameOfTreatingHospitalOrPhysicianInputField, ras_Survey_TestDataManager.pleaseCompleteBleedingBruisingIssuesListedColumn8Option4, "* * * * * RAS SURVEY MISMATCH IN \"Bleeding Issues - Other (please specify)\" section 'Name of treating hospital or physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantBleedingIssuesDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteBleedingBruisingIssuesListedColumn1Option4, "* * * * * RAS SURVEY MISMATCH IN \"Bleeding Issues - Other (please specify)\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantBleedingIssuesDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Bleeding Issues - Other (please specify)\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
    }
    ...
    /**
     * This method verifies the RAS Survey data for scenario two in Native View within the "Blood Disorders" section.
     */
    public static void verify_ras_survey_data_scenarioTwo_blood_disorders_section() {
        ...
        verifyCheckbox("true", ras_survey_native_view.participantBloodDisordersDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Juvenile myelomonocytic leukemia\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn7Option3, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Juvenile myelomonocytic leukemia\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersNameOfTreatingHospitalOrPhysicianTextarea, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn8Option3, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Juvenile myelomonocytic leukemia\" section 'Name of treating hospital or physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn1Option3, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Juvenile myelomonocytic leukemia\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantBloodDisordersDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Juvenile myelomonocytic leukemia\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(ras_survey_native_view.participantBloodDisordersDateOfDiagnosisInputField, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn4Option7, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Other leukemia (please specify)\" section 'Date of diagnosis' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantBloodDisordersDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Other leukemia (please specify)\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn7Option7, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Other leukemia (please specify)\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersNameOfTreatingHospitalOrPhysicianTextarea, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn8Option7, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Other leukemia (please specify)\" section 'Name of treating hospital or physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn1Option7, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Other leukemia (please specify)\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantBloodDisordersDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Other leukemia (please specify)\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyCheckbox("true", ras_survey_native_view.participantBloodDisordersDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Thrombocytopenia\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn7Option4, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Thrombocytopenia\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersNameOfTreatingHospitalOrPhysicianTextarea, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn8Option4, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Thrombocytopenia\" section 'Name of treating hospital or physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn1Option4, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Thrombocytopenia\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantBloodDisordersDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Thrombocytopenia\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyCheckbox("true", ras_survey_native_view.participantBloodDisordersDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Marrow hypoplasia\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn7Option5, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Marrow hypoplasia\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersNameOfTreatingHospitalOrPhysicianTextarea, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn8Option5, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Marrow hypoplasia\" section 'Name of treating hospital or physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn1Option5, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Marrow hypoplasia\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantBloodDisordersDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Marrow hypoplasia\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyCheckbox("true", ras_survey_native_view.participantBloodDisordersDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Myeloproliferative disorder\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn7Option2, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Myeloproliferative disorder\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersNameOfTreatingHospitalOrPhysicianTextarea, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn8Option2, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Myeloproliferative disorder\" section 'Name of treating hospital or physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn1Option2, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Myeloproliferative disorder\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantBloodDisordersDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Myeloproliferative disorder\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyCheckbox("true", ras_survey_native_view.participantBloodDisordersDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Splenomegaly (when the spleen is enlarged)\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn7Option1, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Splenomegaly (when the spleen is enlarged)\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersNameOfTreatingHospitalOrPhysicianTextarea, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn8Option1, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Splenomegaly (when the spleen is enlarged)\" section 'Name of treating hospital or physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn1Option1, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Splenomegaly (when the spleen is enlarged)\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantBloodDisordersDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Splenomegaly (when the spleen is enlarged)\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyCheckbox("true", ras_survey_native_view.participantBloodDisordersDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - History of low white blood cell count\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn7Option6, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - History of low white blood cell count\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersNameOfTreatingHospitalOrPhysicianTextarea, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn8Option6, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - History of low white blood cell count\" section 'Name of treating hospital or physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn1Option6, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - History of low white blood cell count\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantBloodDisordersDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - History of low white blood cell count\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        CommonUtils.hoverOverElement(locateByXpath("//tr[contains(@id,'row_x_naci_family_coho_rasopathy_iiq.x_naci_family_coho_participant_blood_disorders.iiq')]//td//a[@aria-label='Preview record: Other (please specify)']"));
        JavascriptUtils.clickByJS(locateByXpath("//tr[contains(@id,'row_x_naci_family_coho_rasopathy_iiq.x_naci_family_coho_participant_blood_disorders.iiq')]//td//a[@aria-label='Preview record: Other (please specify)']"));
        CommonUtils.sleep(800);
        CommonUtils.waitForClickability(locateByXpath("//a[normalize-space()='Open Record']"));
        JavascriptUtils.clickByJS(locateByXpath("//a[normalize-space()='Open Record']"));
        CommonUtils.sleep(800);
        ...
        verifyCheckbox("true", ras_survey_native_view.participantBloodDisordersDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Other (please specify)\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn7Option8, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Other (please specify)\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersNameOfTreatingHospitalOrPhysicianTextarea, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn8Option8, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Other (please specify)\" section 'Name of treating hospital or physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantBloodDisordersDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheBloodDisordersIssuesListedColumn1Option8, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Other (please specify)\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantBloodDisordersDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Blood Disorders - Other (please specify)\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
    }
    ...
    /**
     * This method verifies the RAS Survey data for scenario two in Native View within the "Infections" section.
     */
    public static void verify_ras_survey_data_scenarioTwo_infections_section() {
        clickTab("Infections");
        ...
        verifyCheckbox("true", ras_survey_native_view.participantInfectionsDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Infections - Preview Frequent infections in infancy and childhood (no immunodeficiency)\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantInfectionsTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteTheImmunodeficienciesListedColumn7Option1, "* * * * * RAS SURVEY MISMATCH IN \"Infections - Preview Frequent infections in infancy and childhood (no immunodeficiency)\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantInfectionsNameOfTreatingHospitalOrPhysicianTextarea, ras_Survey_TestDataManager.pleaseCompleteTheImmunodeficienciesListedColumn8Option1, "* * * * * RAS SURVEY MISMATCH IN \"Infections - Preview Frequent infections in infancy and childhood (no immunodeficiency)\" section 'Name of treating hospital or physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantInfectionsDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheImmunodeficienciesListedColumn1Option1, "* * * * * RAS SURVEY MISMATCH IN \"Infections - Preview Frequent infections in infancy and childhood (no immunodeficiency)\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantInfectionsDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Infections - Preview Frequent infections in infancy and childhood (no immunodeficiency)\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyCheckbox("true", ras_survey_native_view.participantInfectionsDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Infections - Frequent infections in infancy and childhood (diagnosed with immunodeficiency)\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantInfectionsTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteTheImmunodeficienciesListedColumn7Option2, "* * * * * RAS SURVEY MISMATCH IN \"Infections - Frequent infections in infancy and childhood (diagnosed with immunodeficiency)\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantInfectionsNameOfTreatingHospitalOrPhysicianTextarea, ras_Survey_TestDataManager.pleaseCompleteTheImmunodeficienciesListedColumn8Option2, "* * * * * RAS SURVEY MISMATCH IN \"Infections - Frequent infections in infancy and childhood (diagnosed with immunodeficiency)\" section 'Name of treating hospital or physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantInfectionsDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheImmunodeficienciesListedColumn1Option2, "* * * * * RAS SURVEY MISMATCH IN \"Infections - Frequent infections in infancy and childhood (diagnosed with immunodeficiency)\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantInfectionsDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Infections - Frequent infections in infancy and childhood (diagnosed with immunodeficiency)\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        CommonUtils.hoverOverElement(locateByXpath("//tr[contains(@id,'row_x_naci_family_coho_rasopathy_iiq.x_naci_family_coho_participant_infection_history.iiq')]//td//a[@aria-label='Preview record: Other']"));
        JavascriptUtils.clickByJS(locateByXpath("//tr[contains(@id,'row_x_naci_family_coho_rasopathy_iiq.x_naci_family_coho_participant_infection_history.iiq')]//td//a[@aria-label='Preview record: Other']"));
        CommonUtils.sleep(800);
        CommonUtils.waitForClickability(locateByXpath("//a[normalize-space()='Open Record']"));
        JavascriptUtils.clickByJS(locateByXpath("//a[normalize-space()='Open Record']"));
        CommonUtils.sleep(800);
        ...
        verifyCheckbox("true", ras_survey_native_view.participantInfectionsDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Infections - Other\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantInfectionsTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteTheImmunodeficienciesListedColumn7Option3, "* * * * * RAS SURVEY MISMATCH IN \"Infections - Other\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantInfectionsNameOfTreatingHospitalOrPhysicianTextarea, ras_Survey_TestDataManager.pleaseCompleteTheImmunodeficienciesListedColumn8Option3, "* * * * * RAS SURVEY MISMATCH IN \"Infections - Other\" section 'Name of treating hospital or physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantInfectionsDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheImmunodeficienciesListedColumn1Option3, "* * * * * RAS SURVEY MISMATCH IN \"Infections - Other\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantInfectionsDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Infections - Other\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
    }
    ...
    /**
     * This method verifies the RAS Survey data for scenario two in Native View within the "Tumors" section.
     */
    public static void verify_ras_survey_data_scenarioTwo_tumors_section() {
        clickTab("Tumors");
        ...
        verifyCheckbox("true", ras_survey_native_view.participantTumorsDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Giant cell lesion of the jaw\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantTumorsDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheTableBelowForEachOfTheTumorsListedColumn1Option1, "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Giant cell lesion of the jaw\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantTumorsDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Giant cell lesion of the jaw\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        softAssertDropDownValueIsSelected(ras_survey_native_view.participantTumorsGeneticTestingDropdown, "Yes", "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Giant cell lesion of the jaw\" section 'Genetic testing' DROPDOWN * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyCheckbox("true", ras_survey_native_view.participantTumorsDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Papillomata (multiple wart-like growths on the skin)\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantTumorsDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheTableBelowForEachOfTheTumorsListedColumn1Option3, "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Papillomata (multiple wart-like growths on the skin)\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantTumorsDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Papillomata (multiple wart-like growths on the skin)\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        softAssertDropDownValueIsSelected(ras_survey_native_view.participantTumorsGeneticTestingDropdown, "Yes", "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Papillomata (multiple wart-like growths on the skin)\" section 'Genetic testing' DROPDOWN * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyCheckbox("true", ras_survey_native_view.participantTumorsDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Rhabdomyosarcoma (a soft tissue tumor, such as in the muscle)\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantTumorsDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheTableBelowForEachOfTheTumorsListedColumn1Option4, "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Rhabdomyosarcoma (a soft tissue tumor, such as in the muscle)\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantTumorsDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Rhabdomyosarcoma (a soft tissue tumor, such as in the muscle)\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        softAssertDropDownValueIsSelected(ras_survey_native_view.participantTumorsGeneticTestingDropdown, "Yes", "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Rhabdomyosarcoma (a soft tissue tumor, such as in the muscle)\" section 'Genetic testing' DROPDOWN * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyCheckbox("true", ras_survey_native_view.participantTumorsDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Neuroblastoma (a nerve cell tumor)\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantTumorsDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheTableBelowForEachOfTheTumorsListedColumn1Option5, "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Neuroblastoma (a nerve cell tumor)\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantTumorsDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Neuroblastoma (a nerve cell tumor)\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        softAssertDropDownValueIsSelected(ras_survey_native_view.participantTumorsGeneticTestingDropdown, "Yes", "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Neuroblastoma (a nerve cell tumor)\" section 'Genetic testing' DROPDOWN * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyCheckbox("true", ras_survey_native_view.participantTumorsDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Pigmented villonodulous synovitis\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantTumorsDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheTableBelowForEachOfTheTumorsListedColumn1Option2, "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Pigmented villonodulous synovitis\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantTumorsDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Pigmented villonodulous synovitis\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        softAssertDropDownValueIsSelected(ras_survey_native_view.participantTumorsGeneticTestingDropdown, "Yes", "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Pigmented villonodulous synovitis\" section 'Genetic testing' DROPDOWN * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        CommonUtils.hoverOverElement(locateByXpath("//tr[contains(@id,'row_x_naci_family_coho_rasopathy_iiq.x_naci_family_coho_participant_tumor_history.iiq')]//td//a[@aria-label='Preview record: Other (please specify)']"));
        JavascriptUtils.clickByJS(locateByXpath("//tr[contains(@id,'row_x_naci_family_coho_rasopathy_iiq.x_naci_family_coho_participant_tumor_history.iiq')]//td//a[@aria-label='Preview record: Other (please specify)']"));
        CommonUtils.sleep(800);
        CommonUtils.waitForClickability(locateByXpath("//a[normalize-space()='Open Record']"));
        JavascriptUtils.clickByJS(locateByXpath("//a[normalize-space()='Open Record']"));
        CommonUtils.sleep(800);
        ...
        verifyCheckbox("true", ras_survey_native_view.participantTumorsDateAgeOfFirstSymptomsUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Other (please specify)\" section 'Date/age of first symptoms unknown' CHECKBOX * * * * *");
        verifyInputField(ras_survey_native_view.participantTumorsDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheTableBelowForEachOfTheTumorsListedColumn1Option6, "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Other (please specify)\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantTumorsDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Other (please specify)\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        softAssertDropDownValueIsSelected(ras_survey_native_view.participantTumorsGeneticTestingDropdown, "Yes", "* * * * * RAS SURVEY MISMATCH IN \"Tumors - Other (please specify)\" section 'Genetic testing' DROPDOWN * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
    }
    ...
    /**
     * This method verifies the RAS Survey data for scenario two in Native View within the "Autoimmune History" section.
     */
    public static void verify_ras_survey_data_scenarioTwo_autoimmune_history_section() {
        ...
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryDateOfDiagnosisInputField, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn4Option1, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Autoimmune thyroiditis\" section 'Date of diagnosis' * * * * *");
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn7Option1, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Autoimmune thyroiditis\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryNameOfTreatingHospitalOrPhysicianTextarea, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn8Option1, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Autoimmune thyroiditis\" section 'Name of physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn1Option1, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Autoimmune thyroiditis\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantAutoimmuneHistoryDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Autoimmune thyroiditis\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryDateOfDiagnosisInputField, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn4Option2, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Lupus (SLE)\" section 'Date of diagnosis' * * * * *");
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn7Option2, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Lupus (SLE)\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryNameOfTreatingHospitalOrPhysicianTextarea, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn8Option2, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Lupus (SLE)\" section 'Name of physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn1Option2, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Lupus (SLE)\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantAutoimmuneHistoryDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Lupus (SLE)\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryDateOfDiagnosisInputField, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn4Option3, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Psoriasis\" section 'Date of diagnosis' * * * * *");
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn7Option3, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Psoriasis\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryNameOfTreatingHospitalOrPhysicianTextarea, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn8Option3, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Psoriasis\" section 'Name of physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn1Option3, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Psoriasis\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantAutoimmuneHistoryDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Psoriasis\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryAgeOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn2Option4, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Autoimmune blood condition (ie, neutropenic, thrombocytopenia). Please specify\" section 'Age at first symptoms' * * * * *");
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryDateOfDiagnosisInputField, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn4Option4, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Autoimmune blood condition (ie, neutropenic, thrombocytopenia). Please specify\" section 'Date of diagnosis' * * * * *");
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn7Option4, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Autoimmune blood condition (ie, neutropenic, thrombocytopenia). Please specify\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryNameOfTreatingHospitalOrPhysicianTextarea, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn8Option4, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Autoimmune blood condition (ie, neutropenic, thrombocytopenia). Please specify\" section 'Name of physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn1Option4, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Autoimmune blood condition (ie, neutropenic, thrombocytopenia). Please specify\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantAutoimmuneHistoryDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Autoimmune blood condition (ie, neutropenic, thrombocytopenia). Please specify\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        CommonUtils.hoverOverElement(locateByXpath("//tr[contains(@id,'row_x_naci_family_coho_rasopathy_iiq.x_naci_family_coho_participant_autoimmune_history.iiq')]//td//a[@aria-label='Preview record: Other (please specify)']"));
        JavascriptUtils.clickByJS(locateByXpath("//tr[contains(@id,'row_x_naci_family_coho_rasopathy_iiq.x_naci_family_coho_participant_autoimmune_history.iiq')]//td//a[@aria-label='Preview record: Other (please specify)']"));
        CommonUtils.sleep(800);
        CommonUtils.waitForClickability(locateByXpath("//a[normalize-space()='Open Record']"));
        JavascriptUtils.clickByJS(locateByXpath("//a[normalize-space()='Open Record']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryDateOfDiagnosisInputField, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn4Option5, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Other (please specify)\" section 'Date of diagnosis' * * * * *");
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryTreatmentTextarea, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn7Option5, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Other (please specify)\" section 'Treatment' * * * * *");
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryNameOfTreatingHospitalOrPhysicianTextarea, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn8Option5, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Other (please specify)\" section 'Name of physician' * * * * *");
        verifyInputField(ras_survey_native_view.participantAutoimmuneHistoryDateOfFirstSymptomInputField, ras_Survey_TestDataManager.pleaseCompleteTheAutoimmuneConditionsListedBelowColumn1Option5, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Other (please specify)\" section 'Date of first symptom' * * * * *");
        verifyCheckbox("true", ras_survey_native_view.participantAutoimmuneHistoryDateAgeOfFirstDiagnosisUnknownCheckbox, "* * * * * RAS SURVEY MISMATCH IN \"Autoimmune History - Other (please specify)\" section 'Date/age of diagnosis unknown' CHECKBOX * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
    }
    ...
    /**
     * This method verifies the RAS Survey data for scenario two in Native View within the "Brain Issues" section.
     */
    public static void verify_ras_survey_data_scenarioTwo_brain_issues_section() {
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Tethered spinal cord)\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableForEachOfTheConditionsListedBrainIssuesColumn1Option4, "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Tethered spinal cord\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date/age of first symptoms unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Tethered spinal cord\" section 'Date/age of first symptoms unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableForEachOfTheConditionsListedBrainIssuesColumn7Option4, "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Tethered spinal cord\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Cortical atrophy\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableForEachOfTheConditionsListedBrainIssuesColumn1Option5, "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Cortical atrophy\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date/age of first symptoms unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Cortical atrophy\" section 'Date/age of first symptoms unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableForEachOfTheConditionsListedBrainIssuesColumn7Option5, "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Cortical atrophy\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Hydrocephalus\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableForEachOfTheConditionsListedBrainIssuesColumn1Option2, "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Hydrocephalus\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date/age of first symptoms unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Hydrocephalus\" section 'Date/age of first symptoms unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableForEachOfTheConditionsListedBrainIssuesColumn7Option2, "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Hydrocephalus\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Syringomyelia\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableForEachOfTheConditionsListedBrainIssuesColumn1Option3, "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Syringomyelia\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date/age of first symptoms unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Syringomyelia\" section 'Date/age of first symptoms unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableForEachOfTheConditionsListedBrainIssuesColumn7Option3, "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Syringomyelia\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Chiari 1 malformation or cerebellar tonsillar ectopia\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableForEachOfTheConditionsListedBrainIssuesColumn1Option1, "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Chiari 1 malformation or cerebellar tonsillar ectopia\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date/age of first symptoms unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Chiari 1 malformation or cerebellar tonsillar ectopia\" section 'Date/age of first symptoms unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableForEachOfTheConditionsListedBrainIssuesColumn7Option1, "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Chiari 1 malformation or cerebellar tonsillar ectopia\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        CommonUtils.hoverOverElement(locateByXpath("//tr[contains(@id,'row_x_naci_family_coho_rasopathy_iiq.x_naci_family_coho_participants_brain_issues.iiq')]//td//a[@aria-label='Preview record: Other (please specify)']"));
        JavascriptUtils.clickByJS(locateByXpath("//tr[contains(@id,'row_x_naci_family_coho_rasopathy_iiq.x_naci_family_coho_participants_brain_issues.iiq')]//td//a[@aria-label='Preview record: Other (please specify)']"));
        CommonUtils.sleep(800);
        CommonUtils.waitForClickability(locateByXpath("//a[normalize-space()='Open Record']"));
        JavascriptUtils.clickByJS(locateByXpath("//a[normalize-space()='Open Record']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Other (please specify)\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableForEachOfTheConditionsListedBrainIssuesColumn1Option6, "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Other (please specify)\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date/age of first symptoms unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Other (please specify)\" section 'Date/age of first symptoms unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableForEachOfTheConditionsListedBrainIssuesColumn7Option6, "* * * * * RAS SURVEY MISMATCH IN \"Brain Issues - Other (please specify)\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
    }
    ...
    /**
     * This method verifies the RAS Survey data for scenario two in Native View within the "Seizure History" section.
     */
    public static void verify_ras_survey_data_scenarioTwo_seizure_history_section() {
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Epilepsy, resolved after course of treatment\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptoms"), ras_Survey_TestDataManager.pleaseCompleteTheTableBelowSeizureDisordersColumn1Option2, "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Epilepsy, resolved after course of treatment\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date/age of symptoms unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Epilepsy, resolved after course of treatment\" section 'Date/age of first symptoms unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableBelowSeizureDisordersColumn7Option2, "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Epilepsy, resolved after course of treatment\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Febrile or short-term seizures, requiring no treatment\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptoms"), ras_Survey_TestDataManager.pleaseCompleteTheTableBelowSeizureDisordersColumn1Option1, "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Febrile or short-term seizures, requiring no treatment\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date/age of symptoms unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Febrile or short-term seizures, requiring no treatment\" section 'Date/age of first symptoms unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableBelowSeizureDisordersColumn7Option1, "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Febrile or short-term seizures, requiring no treatment\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Seizures, uncontrolled by treatment, also known as intractable epilepsy\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptoms"), ras_Survey_TestDataManager.pleaseCompleteTheTableBelowSeizureDisordersColumn1Option4, "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Seizures, uncontrolled by treatment, also known as intractable epilepsy\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date/age of symptoms unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Seizures, uncontrolled by treatment, also known as intractable epilepsy\" section 'Date/age of first symptoms unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableBelowSeizureDisordersColumn7Option4, "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Seizures, uncontrolled by treatment, also known as intractable epilepsy\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Epilepsy, ongoing treatment\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptoms"), ras_Survey_TestDataManager.pleaseCompleteTheTableBelowSeizureDisordersColumn1Option3, "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Epilepsy, ongoing treatment\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date/age of symptoms unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Epilepsy, ongoing treatment\" section 'Date/age of first symptoms unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableBelowSeizureDisordersColumn7Option3, "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Epilepsy, ongoing treatment\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        CommonUtils.hoverOverElement(locateByXpath("//tr[contains(@id,'row_x_naci_family_coho_rasopathy_iiq.x_naci_family_coho_participant_seizure_history.iiq')]//td//a[@aria-label='Preview record: Other']"));
        JavascriptUtils.clickByJS(locateByXpath("//tr[contains(@id,'row_x_naci_family_coho_rasopathy_iiq.x_naci_family_coho_participant_seizure_history.iiq')]//td//a[@aria-label='Preview record: Other']"));
        CommonUtils.sleep(800);
        CommonUtils.waitForClickability(locateByXpath("//a[normalize-space()='Open Record']"));
        JavascriptUtils.clickByJS(locateByXpath("//a[normalize-space()='Open Record']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Other\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptoms"), ras_Survey_TestDataManager.pleaseCompleteTheTableBelowSeizureDisordersColumn1Option5, "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Other\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date/age of symptoms unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Other\" section 'Date/age of first symptoms unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableBelowSeizureDisordersColumn7Option5, "* * * * * RAS SURVEY MISMATCH IN \"Seizure History - Other\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
    }
    ...
    /**
     * This method verifies the RAS Survey data for scenario two in Native View within the "Behavioral & Psychiatric Histories" section.
     */
    public static void verify_ras_survey_data_scenarioTwo_behavioural_psychiatric_histories_section() {
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unkonwn"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Autism spectrum disorder\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn3Option1, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Autism spectrum disorder\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn7Option1, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Autism spectrum disorder\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unkonwn"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Mood problems (depression, rapid or drastic mood swings, etc)\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn1Option5, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Mood problems (depression, rapid or drastic mood swings, etc)\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn7Option5, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Mood problems (depression, rapid or drastic mood swings, etc)\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unkonwn"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Aggression\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn1Option9, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Aggression\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn7Option9, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Aggression\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unkonwn"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Schizophrenia\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn1Option2, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Schizophrenia\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn7Option2, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Schizophrenia\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unkonwn"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Obsessions or compulsions\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn1Option6, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Obsessions or compulsions\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn7Option6, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Obsessions or compulsions\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unkonwn"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Bipolar disorder\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn1Option3, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Bipolar disorder\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn7Option3, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Bipolar disorder\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unkonwn"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Post-traumatic stress disorder\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn1Option7, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Post-traumatic stress disorder\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn7Option7, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Post-traumatic stress disorder\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unkonwn"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Anxiety\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn1Option4, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Anxiety\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn7Option4, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Anxiety\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unkonwn"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Self-harm acts\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn1Option8, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Self-harm acts\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn7Option8, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Self-harm acts\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        CommonUtils.hoverOverElement(locateByXpath("//tr[contains(@id,'row_x_naci_family_coho_rasopathy_iiq.x_naci_family_coho_behavioral_psychiatric_history.iiq')]//td//a[@aria-label='Preview record: Other (please specify)']"));
        JavascriptUtils.clickByJS(locateByXpath("//tr[contains(@id,'row_x_naci_family_coho_rasopathy_iiq.x_naci_family_coho_behavioral_psychiatric_history.iiq')]//td//a[@aria-label='Preview record: Other (please specify)']"));
        CommonUtils.sleep(800);
        CommonUtils.waitForClickability(locateByXpath("//a[normalize-space()='Open Record']"));
        JavascriptUtils.clickByJS(locateByXpath("//a[normalize-space()='Open Record']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date/age of diagnosis unkonwn"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Other (please specify)\" section 'Date/age of diagnosis unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of first symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn1Option10, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Other (please specify)\" section 'Date of first symptom' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Treatment"), ras_Survey_TestDataManager.pleaseCompleteTheTableBehavioralAndPsychiatricConditionsColumn7Option10, "* * * * * RAS SURVEY MISMATCH IN \"Behavioral & Psychiatric Histories - Other (please specify)\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
    }
    ...
    public static void verify_ras_survey_data_scenarioTwo_strabismus_history_section() {
        ...
        verifyInputField(dynamicInputFieldLocator("First Symptom Time Unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Participant Strabismus Histories - Occlusion therapy\" section 'First Symptom Time Unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Date of diagnosis"), ras_Survey_TestDataManager.pleaseCompleteTheTableBelowRegardingStrabismusColumn4, "* * * * * RAS SURVEY MISMATCH IN \"Participant Strabismus Histories - Occlusion therapy\" section 'Date of diagnosis' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Diagnosis Time Unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Participant Strabismus Histories - Occlusion therapy\" section 'Diagnosis Time Unknown' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
    }
    ...
    /**
     * This method verifies the RAS Survey data for scenario two in Native View within the "Participant Nystagmus Histories" section.
     */
    public static void verify_ras_survey_data_scenarioTwo_participant_nystagmus_histories_section() {
        ...
        verifyInputField(dynamicInputFieldLocator("Date of first symptoms"), ras_Survey_TestDataManager.pleaseCompleteTheTableBelowRegardingNystagmusColumn1, "* * * * * RAS SURVEY MISMATCH IN \"Participant Nystagmus Histories - Mild or short-term nystagmus\" section 'Date of first symptoms' * * * * *");
        softAssertDropDownValueIsSelected(dynamicSelectDropdownLocator("Treatment"), "Yes", "* * * * * RAS SURVEY MISMATCH IN \"Participant Nystagmus Histories - Mild or short-term nystagmus\" section 'Treatment' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
    }
    ...
    /**
     * This method verifies the RAS Survey data for scenario two in Native View within the "Hearing Loss" section.
     */
    public static void verify_ras_survey_data_scenarioTwo_participant_hearing_loss_section() {
        ...
        verifyInputField(dynamicInputFieldLocator("Date of symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableHearingLossColumn1Option3, "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Mixed hearing loss\" section 'Date of symptom' * * * * *");
        softAssertDropDownValueIsSelected(dynamicSelectDropdownLocator("Treatment"), "Yes", "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Mixed hearing loss\" section 'Treatment' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Diagnosis Time Unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Mixed hearing loss\" section 'Diagnosis Time Unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("First Symptom Time Unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Mixed hearing loss\" section 'First Symptom Time Unknown' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date of symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableHearingLossColumn1Option1, "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Sensorineural hearing loss (SNHL)\" section 'Date of symptom' * * * * *");
        softAssertDropDownValueIsSelected(dynamicSelectDropdownLocator("Treatment"), "Yes", "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Sensorineural hearing loss (SNHL)\" section 'Treatment' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Diagnosis Time Unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Sensorineural hearing loss (SNHL)\" section 'Diagnosis Time Unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("First Symptom Time Unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Sensorineural hearing loss (SNHL)\" section 'First Symptom Time Unknown' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date of symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableHearingLossColumn1Option4, "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Hearing Loss, unsure which type\" section 'Date of symptom' * * * * *");
        softAssertDropDownValueIsSelected(dynamicSelectDropdownLocator("Treatment"), "Yes", "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Hearing Loss, unsure which type\" section 'Treatment' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Diagnosis Time Unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Hearing Loss, unsure which type\" section 'Diagnosis Time Unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("First Symptom Time Unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Hearing Loss, unsure which type\" section 'First Symptom Time Unknown' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date of symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableHearingLossColumn1Option2, "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Conductive hearing loss\" section 'Date of symptom' * * * * *");
        softAssertDropDownValueIsSelected(dynamicSelectDropdownLocator("Treatment"), "Yes", "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Conductive hearing loss\" section 'Treatment' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Diagnosis Time Unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Conductive hearing loss\" section 'Diagnosis Time Unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("First Symptom Time Unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Conductive hearing loss\" section 'First Symptom Time Unknown' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
        CommonUtils.hoverOverElement(locateByXpath("//tr[contains(@id,'row_x_naci_family_coho_rasopathy_iiq.x_naci_family_coho_participants_hearing_loss.iiq')]//td//a[@aria-label='Preview record: Other']"));
        JavascriptUtils.clickByJS(locateByXpath("//tr[contains(@id,'row_x_naci_family_coho_rasopathy_iiq.x_naci_family_coho_participants_hearing_loss.iiq')]//td//a[@aria-label='Preview record: Other']"));
        CommonUtils.sleep(800);
        CommonUtils.waitForClickability(locateByXpath("//a[normalize-space()='Open Record']"));
        JavascriptUtils.clickByJS(locateByXpath("//a[normalize-space()='Open Record']"));
        CommonUtils.sleep(800);
        ...
        verifyInputField(dynamicInputFieldLocator("Date of symptom"), ras_Survey_TestDataManager.pleaseCompleteTheTableHearingLossColumn1Option5, "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Other\" section 'Date of symptom' * * * * *");
        softAssertDropDownValueIsSelected(dynamicSelectDropdownLocator("Treatment"), "Yes", "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Other\" section 'Treatment' * * * * *");
        verifyInputField(dynamicInputFieldLocator("Diagnosis Time Unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Other\" section 'Diagnosis Time Unknown' * * * * *");
        verifyInputField(dynamicInputFieldLocator("First Symptom Time Unknown"), "true", "* * * * * RAS SURVEY MISMATCH IN \"Participant Hearing Loss - Other\" section 'First Symptom Time Unknown' * * * * *");
        CucumberLogUtils.logScreenshot();
        JavascriptUtils.clickByJS(locateByXpath("//button[@title='Back']"));
        CommonUtils.sleep(800);
    }
