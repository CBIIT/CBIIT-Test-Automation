...
public class RAS_Screener_TestDataManager extends PageInitializer {
    ...
    public String PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN5_OPTION1;
    public String PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN5_OPTION2;
    public String PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN5_OPTION3;
    public String PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN5_OPTION4;
    public String PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN6_OPTION1;
    public String PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN6_OPTION2;
    public String PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN6_OPTION3;
    public String PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN6_OPTION4;
    public String PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN7_OPTION1;
    public String PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN7_OPTION2;
    public String PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN7_OPTION3;
    public String PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN7_OPTION4;
    ...
    public String HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_FEEDING_PROBLEMS_OPTION;
    public String HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_NEUROCOGNITIVE_OPTION;
    public String HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_SKELETAL_DEFORMITIES_OPTION;
    public String HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_HEAD_CRANIOFACIAL_OPTION;
    public String HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_EYE_EAR_OPTION;
    public String HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_SKIN_HAIR_OPTION;
    public String HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_HEART_PROBLEMS_OPTION;
    public String HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_GENITAL_ABNORMALITIES_OPTION;
    public String HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_NON_CANCEROUS_TUMOR_OPTION;
    public String HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_ALL_OPTION;
    public String HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_OTHER_OPTION;
    ...
    public String WHAT_ARE_MAIN_REASONS_FOR_PARTICIPATING_IN_STUDY_OPTION_1;
    public String WHAT_ARE_MAIN_REASONS_FOR_PARTICIPATING_IN_STUDY_OPTION_2;
    public String WHAT_ARE_MAIN_REASONS_FOR_PARTICIPATING_IN_STUDY_OPTION_3;
    public String WHAT_ARE_MAIN_REASONS_FOR_PARTICIPATING_IN_STUDY_OPTION_4;
    public String WHAT_ARE_MAIN_REASONS_FOR_PARTICIPATING_IN_STUDY_ALL;
    public String WHAT_ARE_MAIN_REASONS_FOR_PARTICIPATING_IN_STUDY_OTHER_REASON_OPTION_4;
    ...
    public void dataInitializerRasScreener(String sheetName) {
        ...
        if (sheetName.equals("screenerScenario1") || sheetName.equals("screenerScenario2") || sheetName.equals("screenerScenarioAdult") || sheetName.equals("screenerScenarioAdult-NeedsLAR") ||sheetName.equals("screenerScenarioAgeUnder7") || sheetName.equals("screenerScenarioAge7-10") || sheetName.equals("screenerScenarioAge11-13") || sheetName.equals("screenerScenarioAge14-17")) {
            ...
            HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_FEEDING_PROBLEMS_OPTION = TEST_DATA_FOR_RAS_SCREENER.get("Feeding problems, failure to thrive, or other stomach/digestive problems");
            HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_NEUROCOGNITIVE_OPTION = TEST_DATA_FOR_RAS_SCREENER.get("Neurocognitive/ developmental delay such as: Intellectual disability and language impairment");
            HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_SKELETAL_DEFORMITIES_OPTION = TEST_DATA_FOR_RAS_SCREENER.get("Skeletal deformities such as: Short stature, short webbed neck, unusual chest shape, curved spine, muscle or joint problems, limb overgrowth ");
            HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_HEAD_CRANIOFACIAL_OPTION = TEST_DATA_FOR_RAS_SCREENER.get("Head/craniofacial abnormalities such as: Large head, broad or high forehead, short nose, small chin, swelling or bleeding of the gums, abnormal shape or movement of teeth");
            HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_EYE_EAR_OPTION = TEST_DATA_FOR_RAS_SCREENER.get("Eye/ear abnormalities such as: Widely spaced eyes, eye diseases, droopy eye lids, sparse/absent eye lashes/eyebrows, low set ears, vision or hearing impairment");
            HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_SKIN_HAIR_OPTION = TEST_DATA_FOR_RAS_SCREENER.get("Skin/hair abnormalities such as: soft loose skin, fine/thin/thick/dry/brittle/curly hair, slow growing hair, tumors or small skin tags near the nose or anus, lipomas, light to dark brown birth marks (cafe au lait spots), freckles in the armpits");
            HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_HEART_PROBLEMS_OPTION = TEST_DATA_FOR_RAS_SCREENER.get("Heart problems such as cardiomyopathy or pulmonary valve stenosis");
            HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_GENITAL_ABNORMALITIES_OPTION = TEST_DATA_FOR_RAS_SCREENER.get("Genital abnormalities such as undescended testes");
            HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_NON_CANCEROUS_TUMOR_OPTION = TEST_DATA_FOR_RAS_SCREENER.get("Non-cancerous tumors");
            HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_ALL_OPTION = TEST_DATA_FOR_RAS_SCREENER.get("Have you ever been diagnosed with the following conditions?  Select all that apply.  If you do not see the exact condition diagnosed, please select the closest answer. All");
            HAVE_YOU_BEEN_DIAGNOSED_WITH_FOLLOWING_CONDITIONS_OTHER_OPTION = TEST_DATA_FOR_RAS_SCREENER.get("Other: such as endocrine issues, bleeding disorders, seizures, tethered cord");
            ...
            WHAT_ARE_MAIN_REASONS_FOR_PARTICIPATING_IN_STUDY_OPTION_1 = TEST_DATA_FOR_RAS_SCREENER.get("What are the main reasons for participating in this study?  Select all that apply.  Please elaborate on the reason in the corresponding textbox. Option 1");
            WHAT_ARE_MAIN_REASONS_FOR_PARTICIPATING_IN_STUDY_OPTION_2 = TEST_DATA_FOR_RAS_SCREENER.get("What are the main reasons for participating in this study?  Select all that apply.  Please elaborate on the reason in the corresponding textbox. Option 2");
            WHAT_ARE_MAIN_REASONS_FOR_PARTICIPATING_IN_STUDY_OPTION_3 = TEST_DATA_FOR_RAS_SCREENER.get("What are the main reasons for participating in this study?  Select all that apply.  Please elaborate on the reason in the corresponding textbox. Option 3");
            WHAT_ARE_MAIN_REASONS_FOR_PARTICIPATING_IN_STUDY_OPTION_4 = TEST_DATA_FOR_RAS_SCREENER.get("What are the main reasons for participating in this study?  Select all that apply.  Please elaborate on the reason in the corresponding textbox. Option 4");
            WHAT_ARE_MAIN_REASONS_FOR_PARTICIPATING_IN_STUDY_ALL = TEST_DATA_FOR_RAS_SCREENER.get("What are the main reasons for participating in this study?  Select all that apply.  Please elaborate on the reason in the corresponding textbox. All");
            WHAT_ARE_MAIN_REASONS_FOR_PARTICIPATING_IN_STUDY_OTHER_REASON_OPTION_4 = TEST_DATA_FOR_RAS_SCREENER.get("What are the main reasons for participating in this study?  Select all that apply.  Please elaborate on the reason in the corresponding textbox. Option 4 Other");
            ...
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN1_OPTION1 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Tumor Type Option 1");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN1_OPTION2 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Tumor Type Option 2");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN1_OPTION3 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Tumor Type Option 3");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN1_OPTION4 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Tumor Type Option 4");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN2_OPTION1 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Additional Details Option 1");
            ...
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN3_OPTION1 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Specify date or age of diagnosis Option 1");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN3_OPTION2 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Specify date or age of diagnosis Option 2");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN3_OPTION3 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Specify date or age of diagnosis Option 3");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN3_OPTION4 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Specify date or age of diagnosis Option 4");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN4_OPTION1 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Month of diagnosis Option 1");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN4_OPTION2 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Month of diagnosis Option 2");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN4_OPTION3 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Month of diagnosis Option 3");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN4_OPTION4 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Month of diagnosis Option 4");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN5_OPTION1 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Year of diagnosis Option 1");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN5_OPTION2 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Year of diagnosis Option 2");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN5_OPTION3 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Year of diagnosis Option 3");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN5_OPTION4 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Year of diagnosis Option 4");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN6_OPTION1 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Age at diagnosis Option 1");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN6_OPTION2 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Age at diagnosis Option 2");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN6_OPTION3 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Age at diagnosis Option 3");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN6_OPTION4 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Age at diagnosis Option 4");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN7_OPTION1 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Currently receiving treatment Option 1");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN7_OPTION2 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Currently receiving treatment Option 2");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN7_OPTION3 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Currently receiving treatment Option 3");
            PLEASE_COMPLETE_THE_BOX_BELOW_BY_SELECTING_WHICH_PRIMARY_CANCERS_COLUMN7_OPTION4 = TEST_DATA_FOR_RAS_SCREENER.get("Please complete the box below by selecting which primary cancers were diagnosed and at what age and year they occurred. If cancer spread from one place to another, please only indicate the original cancers and not the number of sites where cancer spread. Currently receiving treatment Option 4");
