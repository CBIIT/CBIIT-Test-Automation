Feature: The following scenarios verify the functionality on Change Password page
  ...
  @PasswordPolicySuccess  @andreyeve @CHANGPASS-8 @Regression @Smoke @selenium
  ...
  @PasswordPolicyCharacterLimitFailure @CHANGPASS-9 @andreyeve  @Regression @Smoke @selenium
  ...
  @PasswordPolicyLoginNameFailure @CHANGPASS-10 @andreyeve @Regression @Smoke @selenium
  ...
  @PasswordPolicyReuseOldPasswordFailure @CHANGPASS-11 @andreyeve @Regression @Smoke @selenium
  ...
  @PasswordPolicyUnallowedCharacters @CHANGPASS-12 @andreyeve @Regression @Smoke @selenium
  ...
  @PasswordPolicyAllRequiredCharacters @CHANGPASS-13 @andreyeve @Regression @Smoke @selenium
