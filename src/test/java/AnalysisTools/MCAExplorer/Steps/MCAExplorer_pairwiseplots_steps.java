...
public class MCAExplorer_pairwiseplots_steps extends PageInitializer {
	...
	//@When("user selects {string} in Plot Type dropdown")
	//public void user_selects_in_plot_type_dropdown(String string) {
...
//	}
	...
	@When("user selects the {int} in Chromosome levels dropdown")
	public void user_selects_the_in_chromosome_levels_dropdown(Integer int1) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	@When("user enter the start and end in range fields")
	public void user_enter_the_start_and_end_in_range_fields() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	...
	public void user_selects_study_copy_number_state_and_age_range_in_both_group_a_and_group_b() {
		...
		//CommonUtils.sendKeys(mcaExplorerPage.groupA_age_Start,  "5");
		//CommonUtils.sendKeys(mcaExplorerPage.groupA_age_End,  "20");
	...
	public void user_can_verify_that_chart_header_is(String string) {
	   ...
	   try {
		Assert.assertEquals(chart_header_text, "Study: PLCOUK Biobank; Types: Loss; Age: 5-20");
