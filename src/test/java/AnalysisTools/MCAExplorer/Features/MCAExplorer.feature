...
Feature: MCAExplorer features
  ...
  @TC1 @satya @Regression @NCIATWP-6311 @NCIATWP-6723 @NCIATWP-6298 @NCIATWP-6722
  ...
  @TC4 @satya @Regression @NCIATWP-5316 @NCIATWP-5326 @NCIATWP-6270
  ...
  @TC5 @satya @Regression @NCIATWP-6766 @NCIATWP-5541
  ...
  @TC6 @satya @Regression @NCIATWP-6310 @NCIATWP-6298 @NCIATWP-6722
  ...
  @TC7 @satya @Regression @NCIATWP-6310 @NCIATWP-6298
  ...
  @TC8 @satya @Regression @NCIATWP-5324 @NCIATWP-6310
  ...
  @TC9 @satya @Regression @NCIATWP-6605 @NCIATWP-5320
  ...
  @TC10 @satya @Regression @NCIATWP-6268 @NCIATWP-5545 @NCIATWP-5577 @NCIATWP-5338
  ...
  @TC12 @satya @Regression @NCIATWP-6478 @NCIATWP-5327
