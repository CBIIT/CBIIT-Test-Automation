...
public class NIFESubmit_Steps extends PageInitializer {
    ...
    public void user_clicks_on_policies_link_and_verify_it_in_NIFE() {
        Playwright_Common_Utils.clickAndAssertNewPage(NIFESubmitPage.policies, NIFESubmit_Constants.policieslink);
    }
    ...
    public void user_clicks_on_the_vd_policy_link_and_verify_it_in_NIFE() {
        Playwright_Common_Utils.clickAndAssertNewPage(NIFESubmitPage.vdpolicy, NIFESubmit_Constants.vdpolicyLink);
    }
    ...
    public void user_clicks_on_the_accessibility_link_and_verify_it_in_NIFE() {
        Playwright_Common_Utils.clickAndAssertNewPage(NIFESubmitPage.accessibility, NIFESubmit_Constants.accessibilityLink);
    }
    ...
    public void user_clicks_on_the_viewing_file_link_and_verify_it_in_NIFE() {
        Playwright_Common_Utils.clickAndAssertNewPage(NIFESubmitPage.viewingFileAccessibility, NIFESubmit_Constants.FileaccessibilityLink);
    }

    @Then("User clicks on the FIOS link and verify it in NIFE")
    public void user_clicks_on_the_fios_link_and_verify_it_in_NIFE() {
        Playwright_Common_Utils.clickAndAssertNewPage(NIFESubmitPage.FOIA, NIFESubmit_Constants.foialink);
    }

    @Then("User clicks on hhs link and verify it in NIFE")
    public void user_clicks_on_hhs_link_and_verify_it_in_NIFE() {
        Playwright_Common_Utils.clickAndAssertNewPage(NIFESubmitPage.HHS, NIFESubmit_Constants.hhsLink);
    }

    @Then("User clicks on NIH link and verify it in NIFE")
    public void user_clicks_on_nih_link_and_verify_it_in_NIFE() {
        Playwright_Common_Utils.clickAndAssertNewPage(NIFESubmitPage.NIH, NIFESubmit_Constants.nihLink);
    }
    ...
    public void user_clicks_on_usa_gov_link_and_verify_it_in_NIFE() {
        Playwright_Common_Utils.clickAndAssertNewPage(NIFESubmitPage.USAGov, NIFESubmit_Constants.usagovlink);
    }
