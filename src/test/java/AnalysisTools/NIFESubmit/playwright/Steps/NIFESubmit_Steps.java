...
public class NIFESubmit_Steps extends PageInitializer {
    ...
    public void user_clicks_on_the_home_tab() {NIFESubmitStepsImpl.clickHomeTab();
    }

    @Then("Verify User is on the Home Tab")
    public void verify_user_is_on_the_home_tab() {assertThat(PlaywrightUtils.page).hasTitle(NIFESubmitPage.NIFEPageTitle);
    }

    @Then("User clicks on the Submit Metadata and View Images")
    public void User_clicks_on_the_submit_metadata_and_view_images() {NIFESubmitStepsImpl.clickSubmitMetadataAndViewImages();
    }

    @Then("User clicks on the SUBMIT METADATA tab")
    public void user_clicks_on_the_submit_metadata_tab() {PlaywrightUtils. page.locator(NIFESubmitPage.submitMetadataTab).click();
    }

    @Then("Verify User is on the SUBMIT METADATA Tab")
    public void verify_user_is_on_the_submit_metadata_tab() {NIFESubmitStepsImpl.verifySubmitMetadata();
    }

    @Then("User imports the excel file")
    public void user_imports_the_excel_file() {NIFESubmitStepsImpl.importExcelFile();
    }
    ...
    public void user_clicks_on_nci_link_and_verify_it_in_NIFE() {NIFESubmitStepsImpl.verifyNCILink();
    }
    ...
    public void user_clicks_on_the_links_and_verify_the_associated_title() {NIFESubmitStepsImpl.clickAndAssertNewPageTitle();
    }

    @Then("User enters all the required details in study information section")
    public void user_enters_all_the_required_details_in_study_information_section() {NIFESubmitStepsImpl.enterRequiredDetails();
    }
    ...
    public void user_clicks_on_the_reset_button() {PlaywrightUtils.page.locator(NIFESubmitPage.resetButtonLocator).click();
    }

    @Then("Verify user is not able to submit metadata successfully")
    public void verify_user_is_not_able_to_submit_metadata_successfully() {NIFESubmitStepsImpl.verifyErrorMessageOnSubmmitAfterReset();
    }

    @Then("User downloads the metadata file using download button")
    public void user_downloads_the_metadata_file_using_download_button() {NIFESubmitStepsImpl.clickDownloadButton();
    }

    @Then("User clicks on the add biosample")
    public void user_clicks_on_the_add_biosample() {NIFESubmitStepsImpl.addBiosample();
    }
