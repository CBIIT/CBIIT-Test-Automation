...
public class ThreeDVizSNP_steps extends PageInitializer {
	...
	public void user_navigates_to_3DVizSNP_explorer_page() {WebDriverUtils.webDriver.get(EnvUtils.getApplicationUrl("ThreeDVizSNP"));}
	...
	public void uploadVcfFile() {ThreeDVizSNPStepImp.uploadVcfFile();}

	@When("User clicks Visualize Button")
	public void user_clicks_visualize_button() {threeDVizSNPPage.visulizeButton.click();}

	@When("User clicks choose file and upload the vcf file")
	public void user_clicks_choose_file_and_upload_the_vcf_file() {ThreeDVizSNPStepImp.uploadExampleVCFFile();}

	@Then("User should see the vcf text and one file upload filed")
	public void user_should_see_the_vcf_text_and_one_file_upload_filed() {ThreeDVizSNPStepImp.verifyFileUploadText();}

	@When("User clicks submit button")
	public void user_clicks_submit_button() {threeDVizSNPPage.submitButton.click();}

	@When("User should click OK in Alert")
	public void user_should_click_ok_in_alert() {ThreeDVizSNPStepImp.dismissPopUpAlert();}
	...
	public void clickOnVarient() {threeDVizSNPPage.firstVarient.click();}

	@Then("Verify that selected varient is getting highlighted and exact dimensions are getting displayed")
	public void verifySelectedVarient() {ThreeDVizSNPStepImp.dismissPopUpAlert();}
	...
	public void validateButtons() {ThreeDVizSNPStepImp.DownloadFilesForSvgPngAndJson();}

	@Then("Verify that all the mini windows are interactable")
	public void interactWithAllMiniWindow() {ThreeDVizSNPStepImp.miniWindowInteraction();}
