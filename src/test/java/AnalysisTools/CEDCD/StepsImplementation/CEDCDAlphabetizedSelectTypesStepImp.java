...
public class CEDCDAlphabetizedSelectTypesStepImp extends PageInitializer {
	...
	public void alphabetizedComparison() {
		...
		actualSpecimenTypeValues
				.add(cedcdBiospecimenCountsPage.specimenTypeDropDownBuffyCoatAndOrLymphocytesValue.getText());
		...
		actualSpecimenTypeValues
				.add(cedcdBiospecimenCountsPage.specimenTypeDropDownTumorTissueFreshFrozenValue.getText());
