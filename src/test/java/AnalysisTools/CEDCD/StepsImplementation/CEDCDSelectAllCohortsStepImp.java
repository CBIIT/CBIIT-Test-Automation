...
public class CEDCDSelectAllCohortsStepImp extends PageInitializer {
	...
	/**
	 * This method clicks on the check box that selects all cohorts and the view
	 * selected cohort data button
	 */
	...
	/**
	 * This method returns the number of cohorts, highlights the number in red and
	 * logs screenshot
	 */
