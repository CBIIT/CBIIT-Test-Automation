...
public class CEDCDCohortPage {
	...
	/** C.7 Anthropometry (e.g., weight, height, waist circumference) Baseline No Value */
	@FindBy (xpath = "//input[@id='anthropometryBaseLine_0']")
	public WebElement c7BaselineNoRadio;
	
	/** C.7 Anthropometry (e.g., weight, height, waist circumference) Baseline Yes Value */
	@FindBy (xpath = "//input[@id='anthropometryBaseLine_1']")
	public WebElement c7BaselineYesRadio;
	
	/** C.7 Anthropometry (e.g., weight, height, waist circumference) Follow Up No Value */
	@FindBy (xpath = "//input[@id='anthropometryFollowUp_0']")
	public WebElement c7FollowUpNoRadio;
	
	/** C.7 Anthropometry (e.g., weight, height, waist circumference) Follow Up Yes Value */
	...
	/** C.11 Prescription Medication Use (not related to cancer treatment) Baseline No Value */
	@FindBy (xpath = "//input[@id='prescriptionBaseLine_0']")
	public WebElement c11BaselineNoRadio;
	
	/** C.11 Prescription Medication Use (not related to cancer treatment) Baseline Yes Value */
	@FindBy (xpath = "//input[@id='prescriptionBaseLine_1']")
	public WebElement c11BaselineYesRadio;
	
	/** C.11 Prescription Medication Use (not related to cancer treatment) Follow Up No Value */
	@FindBy (xpath = "//input[@id='prescriptionFollowUp_0']")
	public WebElement c11FollowUpNoRadio;
	
	/** C.11 Prescription Medication Use (not related to cancer treatment) Follow Up Yes Value */
	@FindBy (xpath = "//input[@id='prescriptionFollowUp_1']")
	public WebElement c11FollowUpYesRadio;
	
	/**===================================*/
	
	/** C.12 Non-prescription Medication Use (not related to cancer treatment) Baseline No Value */
	@FindBy (xpath = "//input[@id='nonprescriptionBaseLine_0']")
	public WebElement c12BaselineNoRadio;
	
	/** C.12 Non-prescription Medication Use (not related to cancer treatment) Baseline Yes Value */
	@FindBy (xpath = "//input[@id='nonprescriptionBaseLine_1']")
	public WebElement c12BaselineYesRadio;
	
	/** C.12 Non-prescription Medication Use (not related to cancer treatment) Follow Up No Value */
	@FindBy (xpath = "//input[@id='nonprescriptionFollowUp_0']")
	public WebElement c12FollowUpNoRadio;
	
	/** C.12 Non-prescription Medication Use (not related to cancer treatment) Follow Up Yes Value */
	...
	/** C.15 Use of tobacco products other than cigarettes check box BASELINE check boxes */
	/** Cigars value */
	...
	/** C.28 Physical function meassures (e.g. grip strength, gait speed, etc.) Baseline No Value */
	@FindBy (xpath = "//input[@id='physicalMeasureBaseLine_0']")
	public WebElement c28BaselineNoRadio;
	
	/** C.28 Physical function meassures (e.g. grip strength, gait speed, etc.) Baseline Yes Value */
	@FindBy (xpath = "//input[@id='physicalMeasureBaseLine_1']")
	public WebElement c28BaselineYesRadio;
	
	/** C.28 Physical function meassures (e.g. grip strength, gait speed, etc.) Follow Up No Value */
	@FindBy (xpath = "//input[@id='physicalMeasureFollowUp_0']")
	public WebElement c28FollowUpNoRadio;
	
	/** C.28 Physical function meassures (e.g. grip strength, gait speed, etc.) Follow Up Yes Value */
	@FindBy (xpath = "//input[@id='physicalMeasureFollowUp_1']")
	public WebElement c28FollowUpYesRadio;
	
	/**===================================*/
	
	/** C.29 Environmental or Occupational Exposures (e.g. air contaminants/quality, occupational exposures and history, water source) Baseline No Value */
	@FindBy (xpath = "//input[@id='exposureBaseLine_0']")
	public WebElement c29BaselineNoRadio;
	
	/** C.29 Environmental or Occupational Exposures (e.g. air contaminants/quality, occupational exposures and history, water source) Baseline Yes Value */
	@FindBy (xpath = "//input[@id='exposureBaseLine_1']")
	public WebElement c29BaselineYesRadio;
	
	/** C.29 Environmental or Occupational Exposures (e.g. air contaminants/quality, occupational exposures and history, water source) Follow Up No Value */
	@FindBy (xpath = "//input[@id='exposureFollowUp_0']")
	public WebElement c29FollowUpNoRadio;
	
	/** C.29 Environmental or Occupational Exposures (e.g. air contaminants/quality, occupational exposures and history, water source) Follow Up Yes Value */
	@FindBy (xpath = "//input[@id='exposureFollowUp_1']")
	public WebElement c29FollowUpYesRadio;
	
	/**===================================*/
	
	/** C.30 Residential history Information (zip code, GIS) over time? Baseline No Value */
	@FindBy (xpath = "//input[@id='residenceBaseLine_0']")
	public WebElement c30BaselineNoRadio;
	
	/** C.30 Residential history Information (zip code, GIS) over time? Baseline Yes Value */
	@FindBy (xpath = "//input[@id='residenceBaseLine_1']")
	public WebElement c30BaselineYesRadio;
	
	/** C.30 Residential history Information (zip code, GIS) over time? Follow Up No Value */
	@FindBy (xpath = "//input[@id='residenceFollowUp_0']")
	public WebElement c30FollowUpNoRadio;
	
	/** C.30 Residential history Information (zip code, GIS) over time? Follow Up Yes Value */
