Feature: These are the scenarios for the Home page on the JPSurv Application
  ...
  @Smoke @satya @playwright @NCIATWP-2205
  ...
  @Smoke @satya @playwright @NCIATWP-6670 @NCIATWP-4478
  Scenario: Verify all the links available in the JPSurv website
    Given User navigates to JPSurv home page
  ...
  @Smoke @satya @playwright @NCIATWP-1698 @NCIATWP-4434
  ...
  @Smoke @satya @playwright @NCIATWP-4322
  ...
  @Smoke @satya @playwright @NCIATWP-7693 @NCIATWP-7692 @NCIATWP-7662 @NCIATWP-6662
  ...
  @Smoke @satya @playwright @NCIATWP-7763 @NCIATWP-7690
  ...
  @Smoke @satya @playwright @NCIATWP-8384 @NCIATWP-2232 @NCIATWP-1699 @NCIATWP-4383
  ...
  @Smoke @satya @playwright @NCIATWP-1697
  ...
  @Smoke @satya @playwright @CIATWP-8046 @NCIATWP-8045 @NCIATWP-1714
  ...
  @Smoke @satya @playwright @NCIATWP-7664 @NCIATWP-7657 @NCIATWP-2190
  ...
  @Smoke @satya @playwright @NCIATWP-4625
  ...
  @Smoke @satya @playwright @NCIATWP-2749
