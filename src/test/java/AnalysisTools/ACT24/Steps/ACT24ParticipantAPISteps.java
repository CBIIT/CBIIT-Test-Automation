...
public class ACT24ParticipantAPISteps {
    ...
    public void the_get_call_to_retrieve_participant_list_is_requested() {
    }
    ...
    public void the_get_call_to_retrieve_retrieve_and_recall_data_from_resource_is_requested() {
    }
