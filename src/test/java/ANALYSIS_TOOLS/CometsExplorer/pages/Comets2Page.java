package ANALYSIS_TOOLS.CometsExplorer.pages;
...
public class Comets2Page {
	...
	/**
	 * This element is the "Input data has passed QC (metabolite and sample names
	 * match in all input files)" success message
	 */
	...
	/**
	 * This element is the "Age.2.1 Gender stratified" value from the Choose Model
	 * drop down
	 */
	 ...
	 * Please download the file below to the COMETS harmonization group for
	 * meta-analysis." success message
	 */
