...
public class CEDCDBiospecimenCountsPage extends CommonUtils {
	...
	/**
	 * This element selects "Buffy Coat and/or Lymphocytes" from the Specimen Type
	 * drop down
	 */
	...
	/**
	 * This element selects "Tumor Tissue Fresh/Frozen" from the Specimen Type drop
	 * down
	 */
	...
	/**
	 * This element returns the list of selections from the Specimen Type (still
	 * returns all values from specimen type, cancer type, cohorts) drop down
	 */
	...
	/**
	 * This element is a list of the Cancer Type drop down values on the Biospecimen
	 * tab
	 */
