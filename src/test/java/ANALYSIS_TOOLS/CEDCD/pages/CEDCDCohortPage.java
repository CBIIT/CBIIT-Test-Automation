package ANALYSIS_TOOLS.CEDCD.pages;
...
public class CEDCDCohortPage extends CommonUtils {
    ...
    /**
     * Specify the types of specimens you collected, whether the specimen was
     * collected at baseline, and/or collected at other time points.
     */
    ...
    /**
     * G.7 Did you collect repeated samples over multiple timepoints for the same
     * individuals?
     */
    ...
    /**
     * G.8 If your cohort does not currently collect tumor blocks, do you have
     * information on where the blocks are kept/stored?
     */
    ...
    /**
     * G.15d What is the number of participants with metabolomics data in your
     * study?
     */
    ...
    /**
     * G.15f Which type(s) of analytical platform was used, (e.g., NMR, Orbitrap
     * mass spectrometry, QTOF mass spectrometry)? Text Box
     */
    @FindBy(xpath = "//textarea[@name='bioAnalyticalPlatform']")
    public WebElement g15FTextBox;

    /**
     * G.15g Which separation platform(s) was used (e.g., GC, HILIC, RPLC, Ion
     * pairing LC)? Text Box
     */
    ...
    /**
     * Buffy Coat and/or Lymphocytes/Cervical carcinoma in situ (CIN II/III, CIS,
     * AIS)
     */
    ...
    /**
     * This is the webelement for the Select a Cohort Please select the cohort you
     * wish to update from the list below. Text
     */
