...
public class CEDCDSearchCohortsPage extends CommonUtils {
    ...
    /**
     * This list of webelements will return the number of cohorts selected plus the
    ...
    /**
     * This element clicks on the "Depression" value from the Categories of Data
     * Collected drop down
     */
    ...
    /**
     * This list of WebElements returns all the values from the Categories of Data
     * Collected
     */
