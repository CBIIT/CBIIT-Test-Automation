package ANALYSIS_TOOLS.GWASTarget.steps;

import APPS_COMMON.PageInitializers.PageInitializer;
import com.nci.automation.web.*;
import io.cucumber.java.en.*;
import org.testng.Assert;
import static com.nci.automation.web.TestProperties.getGwasTargetUrl;
...
public class GWASTargetAnalysisSteps extends PageInitializer {
    ...
    public void the_user_is_on_the_gwas_target_analysis_page() {
        WebDriverUtils.webDriver.get(getGwasTargetUrl());
