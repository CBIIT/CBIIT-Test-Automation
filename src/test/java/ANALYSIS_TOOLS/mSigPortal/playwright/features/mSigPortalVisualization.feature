Feature:These are the scenarios for the Visualization tab of mSigPortal website
  ...
  @satya1 @Smoke @Regression @playwright @NCIATWP-5609
  ...
  @satya1 @Smoke @Regression @playwright @NCIATWP-5711
  ...
  @satya1 @Smoke @Regression @playwright @NCIATWP-5907
  ...
  Scenario: Verify the user is able to check SBS96 Plot is displayed or not
    ...
    Then Verify that profile type is selected "SBS" and matrix size as "96"
