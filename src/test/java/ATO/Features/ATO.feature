...
Feature: ATO testing
  ...
  @CreatePackage @Regression @Smoke @Satya @Test123
  Scenario: ATO validation of create new package
    ...
    And User enters the dates
    And User enters the note as "Test Automation"
    And User clicks submit button

  @CancelPackage @Regression @Satya
  ...
  @eAuthentication @Regression @Satya
  ...
  @SystemSecurityPlan  @Regression @Satya
  ...
  @IdentityAcceeManagement @Regression @Satya
  ...
  @AuditAndAccountability @Regression @Satya
  ...
  @ConfigurationManagementPlan @Regression @Satya
  ...
  @ContingencyPlan @Regression @Satya
  ...
  @IncidentResponseContactList @Regression @Satya
  Scenario: Validate Contingency Plan form of the package
    Given User opens ATO application in browser
    When User will login to ato application
    Then User clicks on "Native View" in header menu
   ...
   @SignATOButton @Smoke @Regression @satya
  ...
  @CreateThreepackages @ValidateStatus @Regression @satya
 ...
 @Createsamenamepackages
  ...
  @ValidateReviewCOmments  @Regression @Satya1
  Scenario: User validate the status of items is in pending state
    ...
    @RenewPackage  @Regression @Satya1 @ResumeButton @Sprint12
  Scenario: User creates new package and renews it when due and checks status after cancelling that package
    ...
    @DeletePackage
    Scenario: User creates a new package and then deletes it
    Given User opens ATO application in browser
    When User will login to ato application
    Then User clicks on "Native View" in header menu
    And User filters value as "ATO"
