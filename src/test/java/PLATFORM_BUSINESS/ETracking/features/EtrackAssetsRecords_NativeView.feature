Feature: Etrack Assets Records Test Scenarios
  ...
  @ETRACK-2 @ETRACK-14 @chaudhryma @Regression @selenium
  ...
  @ETRACK-6 @ETRACK-9 @chaudhryma @Regression @selenium
  ...
  @ETRACK-3 @ETRACK-15 @chaudhryma @Regression @selenium
  ...
  @ETRACK-4 @ETRACK-16 @chaudhryma @Regression @selenium
  ...
  @ETRACK-5 @ETRACK-17 @chaudhryma @Regression @selenium
  ...
  @ETRACK-12 @ETRACK-19 @chaudhryma @Regression @selenium
