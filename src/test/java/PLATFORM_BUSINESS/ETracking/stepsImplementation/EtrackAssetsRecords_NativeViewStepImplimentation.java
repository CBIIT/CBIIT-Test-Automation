...
public class EtrackAssetsRecords_NativeViewStepImplimentation extends PageInitializer {
    ...
    public static void aEtrackingUserOpensAnAssetRecord() {
        ...
        CommonUtils.waitForVisibility(etrackAssetsRecords_NativeViewPage.nVEtrackAssetsNewRecordStockroomTextBox);
        ...
        CommonUtils.waitForVisibility(etrackAssetsRecords_NativeViewPage.nVEtrackAssetsNewRecordQuantityTextBox);
        ...
        CommonUtils.waitForVisibility(etrackAssetsRecords_NativeViewPage.nVEtrackAssetsAllRecordSearchTextBox);
