Feature: Unauthenticated applicant Scenarios
  ...
  @Regression @Nekrashevich @SSJ-124 @SSJ-365 @selenium @SNOW_UPDATED
  ...
  @Regression @Nekrashevich @SSJ-31 @selenium @SNOW_UPDATED
  ...
  @Regression @Nekrashevich @SSJ-122 @SSJ-36 @selenium @SNOW_UPDATED
  ...
  @Regression @Nekrashevich @SSJ-27 @selenium @SNOW_UPDATED
