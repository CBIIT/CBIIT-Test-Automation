...
public class SEERDataAccessRequest_Constants {
    ...
    /* SEER Acknowledgment of Treatment Data Limitations Agreement */
    public static final String I_UNDERSTAND_THE_LIMITATIONS_OF_TREATEMENT_DATA = "SEER Acknowledgment of Treatment Data Limitations\n" +
            ...
            "Interpretation of time in days from diagnosis to treatment\n" +
            "If both the full date of diagnosis and the date of first cancer treatment are known, and the number of days between the two events is greater than 730 days (2 years), then a value of 731 (731+ days) is assigned. If any component of the date of diagnosis or date of initial treatment is unknown, a value of blank is assigned. The time is capped at 730 days (2 years) after diagnosis because treatment administered after this mark 2 years would not typically be the first course of treatment. As a reminder, if active surveillance is the first cancer management modality, the  then the time to treatment will reflect the time to decision to follow active surveillance.\n" +
