...
public class DUA_Constants {
    ...
    /** --------------- SEER RESEARCH USER DUA FOR TEST URL --------------- */
    ...
    /** --------------- SEER RESEARCH USER DUA FOR SANDBOX URL --------------- */
//    public static final String SEER_DATA_ACCESS_REQUEST_URL = "https://service-sandbox.nci.nih.gov/seer-data-access?id=seer_data_access_request&sysparm_user=Be16e2288727da104d2a8599cebb35f0 \n";

    /** --------------- SEER RESEARCH PLUS USER DUA FOR TEST URL --------------- */
    ...
    /** --------------- SEER RESEARCH PLUS USER DUA FOR SANDBOX URL --------------- */
//    public static final String SEER_DATA_ACCESS_REQUEST_INSTITUTION_URL = "https://service-sandbox.nci.nih.gov/seer-data-access?id=seer_data_access_request&sysparm_user=58cf2ea48767da104d2a8599cebb3557 ";
    ...
    public static final String BEST_PRACTICE_ASSURANCE = "Best Practices Assurance for Securing NCI-supported Registry Data\n" +
            "Introduction\n" +
    ...
    public static final String NCCR_REASEARCH_DATA_USER_AGREEMENT ="National Childhood Cancer Registry (NCCR) Research Data Use Agreement\n" +
            ...
            "Compliance: Authorized User will use Data in full compliance with all applicable laws and NIH policies and guidance documents. To the extent NIH policies or guidance documents are inconsistent with the terms of this Agreement, the terms of this Agreement will supersede NIH policies or guidance.\n" +
            "No Data Linkage across Databases: Authorized User will not attempt to link data from individual NCCR Databases with Research Plus or other Specialized or Customized Databases. This includes, but is not limited to, combining two or more NCCR or SEER Databases to which Authorized User has access. Analyses using Authorized data for approved projects with a government-provided encrypted identifier are permitted.\n" +
            ...
            "No Release to Others: Authorized User will not release, in full or in part, nor permit others to release, the Data to any other person. All members of a research team who wish to have access to the Data must sign a separate NCCR Research Data Use Agreement. Authorized User will not disclose Data in any Federal, State, or local civil, criminal, administrative, legislative, or other proceeding without advance written approval of the NCI SRP. Authorized User will not make copies or remove data from their approved Institution except as authorized by this Agreement.\n" +
            "No Attempt to identify any Geographic Area: Authorized User will not attempt to identify or infer any geographic area if they are not specifically released in the Database (e.g., identify state, registry, or country, etc. if they are not included in the specific Database).\n" +
            "No Attempt to identify any Data Source: Authorized User will not attempt to identify or infer any data source or individual healthcare provider or healthcare facility (e.g., hospital, laboratory, oncology office, etc.\n" +
