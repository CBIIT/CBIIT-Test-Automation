...
public class SEERUserRegistrationPageStepImpl extends PageInitializer {
     ...
     */
    public static void aSEERUserRegistrationHasBeenSuccessfullySubmitted()  {
     ...
     * @ If any error occurs during the re-registration process.
     */
    public static void theUserShouldSeePageWhenReRegistering(String youAlreadyHaveAccessToSeerResearchData) {
        WebDriverUtils.webDriver.get(getSeerOdsUrl());
