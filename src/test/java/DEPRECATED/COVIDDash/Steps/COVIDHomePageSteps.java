package DEPRECATED.COVIDDash.Steps;
...
public class COVIDHomePageSteps extends PageInitializer {
    ...
    public void user_navigates_to_the_COVID_Biorepository_login_page(Integer int1) {
    ...
    public void attaches_a_Related_URL() {
        pageCache.getCOVIDHomePage().attachURL();
    }

    @Then("the User is able to successfully submit the study {string}")
    public void the_User_is_able_to_successfully_submit_the_study(String ibrNumber) {
    ...
    public void a_Reviewer_navigates_to_the_COVID_Biorepository_login_page(Integer int1) {
    ...
    public void impersonating_a_reviewer() {
