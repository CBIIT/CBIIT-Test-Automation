...
public class BasePage {
	...
	protected void clickOnElement(By element) {
		wait.until(ExpectedConditions.visibilityOf(find(element)));
	...
	/** Method will return all options for selections **/
	protected List<WebElement> getAllOptions(WebElement selectEl) {
		Select select = new Select(selectEl);
	...
	protected void selectOptionByIndex(WebElement selectEl, int index) {
		try {
			Select select = new Select(selectEl);
