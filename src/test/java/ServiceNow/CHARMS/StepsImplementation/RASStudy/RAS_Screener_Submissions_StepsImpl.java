    ...
    public static void rasScreenerSubmissions(String sheetName) {
        ...
        for (int i = 0; i < 60; i++) {
            ...
            try {
                 ...
                 */
                else if (rasopathyQuestionnairePage.question.isDisplayed() && rasopathyQuestionnairePage.question.getText().trim().contentEquals(IN_WHICH_COUNTRY_DO_YOU_CURRENTLY_LIVE)) {
