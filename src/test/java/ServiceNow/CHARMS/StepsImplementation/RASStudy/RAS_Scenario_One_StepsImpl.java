...
public class RAS_Scenario_One_StepsImpl extends PageInitializer {
    ...
    public void rasScreenerScenarioSelector(String sheetName) {
        if (sheetName.contentEquals("screenerScenario1")) {
            ...
            ras_scenario_one_stepsImpl.rasScreenerSubmissionScenario1();
    ...
    public void rasScreenerVerificationScenarioSelector(String sheetName) {
        if (sheetName.contentEquals("screenerScenario1")) {
            ras_Screener_TestDataManager.dataInitializerRasScreener(sheetName);
            ras_scenario_one_stepsImpl.verifying_RAS_Screener_Scenario_1_Data(sheetName);
        }
    ...
    public void rasConsentScenarioSelector(String sheetName) {
        ...
        ras_Screener_TestDataManager.dataInitializerRasScreener(sheetName);
        ras_scenario_one_stepsImpl.nativeViewConsentFlowProcessScenario1(sheetName);
    }
    ...
    public void iiqScenarioSelector(String sheetNameIiq) {
        if (sheetNameIiq.contentEquals("IIQScenario1")) {
            ...
            ras_scenario_one_stepsImpl.rasScreenerIIQFormScenario1();
    ...
    public void rasSurveyScenarioSelector(String sheetName) {
        if (sheetName.contentEquals("RASSurveyScenario1")) {
            ...
            ras_scenario_one_stepsImpl.rasScreenerSurveyScenario1PartOne();
            ras_scenario_one_stepsImpl.rasScreenerSurveyScenario1PartTwo();
            ras_scenario_one_stepsImpl.rasScreenerSurveyScenario1PartThree();
            ras_scenario_one_stepsImpl.rasScreenerSurveyScenario1PartFour();
            ras_scenario_one_stepsImpl.rasScreenerSurveyScenario1PartFive();
            ras_scenario_one_stepsImpl.rasScreenerSurveyScenario1PartSix();
            ras_scenario_one_stepsImpl.rasScreenerSurveyScenario1PartSeven();
            ras_scenario_one_stepsImpl.rasScreenerSurveyScenario1PartEight();
            ras_scenario_one_stepsImpl.rasScreenerSurveyScenario1PartNine();
            ras_scenario_one_stepsImpl.rasScreenerSurveyScenario1PartTen();
    ...
    public void theParticipantWillBeAbleToRewindTheForm() {
        ...
        while (rasopathyQuestionnairePage.rasSurveyPreviousButton.isDisplayed()) {
            ras_scenario_one_stepsImpl.clickOnSurveyPreviousButton();
        }
    }
    ...
    public void verifying_RAS_Screener_Scenario_1_Data(String sheetName) {
        ...
        CommonUtils.clickOnElement(nativeViewCHARMSDashboardPage.rasStudyOpenRecordButton);
        CucumberLogUtils.logScreenshot();
        ras_scenario_one_stepsImpl.verifyingDropDownOption(participantDetailsPage.vitalStatusYesDropDownOption, "-- VERIFYING VITAL STATUS --");
