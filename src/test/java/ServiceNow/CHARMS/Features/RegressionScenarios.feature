Feature: MyRAS Study Regression Scenarios
  ...
  Scenario: Proxy Screener Submission with data verification
    ...
    When the myRas user signs in with Username "charmsras5@yahoo.com" and Password "RASTest2021$$"
  ...
  Scenario: CGB IIQ Submission
    ...
    And enters email address "charmsras5@yahoo.com" and One Time Pin code to proceed with the form
  ...
  Scenario: RAS Survey Submission - Regression
    ...
    And enters Okta email address "charmsras5@yahoo.com" and One Time Pin code to proceed with the RAS Survey
  ...
  @juarezds @e2e-Regression @Regression @Updated @Progression
  Scenario: Proxy Screener Submission with data verification
    Given a proxy is on the RASopathies Longitudinal Cohort Study login page
