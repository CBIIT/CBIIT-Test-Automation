...
#    Then screener data from "<ScreenerScenario>" is verified
    ...
    Examples:
      ...
      | charmsras1@yahoo.com | Charms123$ | screenerScenario1 | IIQScenario1 | RASSurveyScenario1 |
      | charmsras1@yahoo.com | Charms123$ | screenerScenario2 | IIQScenario2 | RASSurveyScenario2 |
