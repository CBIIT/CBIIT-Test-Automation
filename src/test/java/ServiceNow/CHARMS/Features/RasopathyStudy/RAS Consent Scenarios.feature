Feature: RAS Consent Scenarios
  ...
  @muzipovay2 @RAS_STUDY @CP2-3603 @CP2-3637 @CP2-3680 @CP2-3825 @CP2-3640 @selenium @RAS_Regression @Progression
...
#    And "Download Study Consent" text shows on participant portal and when clicked downloads "Consent Record"
  ...
  @muzipovay2 @RAS_STUDY @CP2-3603 @CP2-3637 @CP2-3738 @CP2-3751 @CP2-3738 @selenium @RAS_Regression
