Feature: RAS Consent Scenarios
  ...
  @muzipovay2 @RAS_STUDY @CP2-3603 @CP2-3637 @selenium @Regression
  Scenario Outline: Verifying e-consent workflow for an minor aged 11-13, and then verifying that a Download Study Consent/Assent widgets show on portal and when clicked download the most recent Consent/Assent Record
    Given test automation account "<AccountResetScriptURL>" has been reset
