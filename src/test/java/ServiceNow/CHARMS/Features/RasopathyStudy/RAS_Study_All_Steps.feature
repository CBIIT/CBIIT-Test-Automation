...
#    And the consent is submitted for "<ScreenerScenario>"
    Examples:
      ...
      | consent_participant@yopmail.com | Charms123$ | screenerScenario1 | RASScenario_Consent_Age_Adult | Complete      | 1           | CHARMS e-consent | https://service-test.nci.nih.gov/nav_to.do?uri=sys_script_fix.do?sys_id=b8daf9fa872096107e87a8a60cbb3597 |
