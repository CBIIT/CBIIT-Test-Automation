Feature: RAS Survey Scenarios (Preview)
    ...
    @juarezds @RASSurveyPreview  @Regression
    Scenario: RASSurvey Preview Self Submission #submit page next button has been commented out/disabled
        ...
        And enters Biological Mother birth city "LOS' ANGELES", select Mothers Age "23" and enters Father birth city "PUERTO' VALL'ARTA",and selects Fathers age "26" for What was your biological parents age in Years when you were born? page - myRAS Survey
    ...
    Scenario: RAS Survey Proxy Scenario  #submit page next button has been commented out/disabled
        ...
        And selects All that apply and enters in other condition "ABNORMAL BONE STRUCTURE's" for Was Christina Ramirez diagnosed with any of the following conditions during your mothers pregnancy? These are conditions often detected on routine fetal ultrasound page  - myRAS Survey
    ...
    Scenario: RAS Survey Proxy Scenario  #submit page next button has been commented out/disabled
        ...
        And clicks YES button for is Christina still alive -myRAS Survey
        And clicks YES button for Has Christina ever been included in a published case report or otherwise represented in a public manner by a healthcare provider or researcher page - myRAS Survey
        And enters information about a previous cancer study "PROXY SCENARIO FLOW - PUBLISHED IN ANOTHER CANCER STUDY" Please provide any additional information about the authors, year of publication or PubMed ID (PMID), if available. page - myRAS Survey
        And clicks Next button for The next set of questions will ask about birth and neonatal history. page - myRAS Survey
        And enters Christinas Biological Mother birth city "LOS ANGELES", select Mothers Age "23" and enters Father birth city "PUERTO VALLARTA",and selects Fathers age "26" for What was your biological parents age in Years when you were born? page - myRAS Survey
        And clicks YES Was Christina Ramirez diagnosed with hypoglycemia (low blood sugar) during the newborn period - myRAS Survey
        ...
        And clicks + sign to add other allergy "MOSQUITO BITES" and enters "ITCHING" for allergic reaction and clicks + sign for second allergy "BEE STINGS" and enters "SWELLING OF THE THROAT" for Please complete the table below for all other items to which Christina is allergic that were not included in medication or food allergies. - myRAS Survey
        And clicks YES button Has Christina ever had an operation or biopsy? -myRAS Survey
        And clicks + sign to add type of surgery "C ' SECTION" and enters "20" for age of surgery and selects reason for surgery "Child 'testing' birth" and enters " INOVA, ARLINGTON, VA, USA" for hospital name in Please provide the information for each biopsy and surgery in the table below. -myRAS Survey
        And clicks YES button Has Christina ever been hospitalized for any reason other than a surgery or childbirth? -myRAS Survey
        And clicks + sign to add reason for hospitalization "LONG TERM BLOODY NOSE" and enters "9 NOVEMBER 2020" for when it occured and enters for hospital "INOVA, FAIRFAX, VA, USA" for Please provide the information for each hospitalization in the table below. To add a new hospitalization, please click on the + sign in the upper left corner of the table. -myRAS Survey
        And clicks Next button The next set of questions will ask about GI (gastrointestinal) symptoms or conditions. -myRAS Survey
        And clicks YES button Has Christina ever been evaluated by a gastroenterologist?  These are doctors that specialize in the GI tract and liver. The GI tract includes your esophagus, stomach, small intestine, large intestine/colon, liver and pancreas.  Gastroenterologists often diagnose conditions such as inflammatory bowel disease Crohns disease or ulcerative colitis, Celiac disease, ulcers, and pancreas inflammation pancreatitis.   -myRAS Survey
    ...
    Scenario: RASSurvey Preview Self Submissions Unsure Unknown Flow #submit page next button has been commented out/disabled
        Given a participant is on the Rassurvey Questionaire login page - myRAS Survey
        And logs in via Okta with username "diego1@test.com" and password "123456" on login page - myRAS Survey
        And clicks on survey next button after reviewing the survey details to start on the myRAS Survey questions. page - myRAS Survey
        And clicks next button on The first block of questions will collect basic demographic information. page - myRAS Survey
        ...
        And clicks Unsure/Unknown option for Were you diagnosed with hypoglycemia (low blood sugar) during the newborn period. page - myRAS Survey
        And selects Unsure/Unknown option for Were you diagnosed with any of the following conditions during your mothers pregnancy? page - myRAS Survey
        # And clicks Unsure/Unknown option for During her pregnancy with you, did your mother have any prenatal tests to identify fetal birth defects or fetal medical problems? page - myRAS Survey
        # And selects Unsure/Unknown option for Was your biological mother diagnosed with any of the following conditions prior to or during her pregnancy with you? Please select all that apply. page - myRAS Survey
        # And selects Unsure/Unknown option for During her pregnancy with you, did your biological mother take any medications, vitamins, or supplements for any reason? - myRAS Survey
        # And selects Unsure of what medication/supplements/vitamins taken during pregnancy option for Please select all medications your mother took during her pregnancy with you. Select all that apply. page - myRAS Survey
        # And selects Unsure/Unknown option for Did your biological mother use any tobacco products during her pregnancy with you? Some examples include: cigarettes, cigars, pipes, or chewing tobacco. page - myRAS Survey
        # And selects Unsure/Unknown option for Did your biological mother use any vaping products during her pregnancy with you? Some examples include: electronic cigarettes, vape pens, or mechanical modified nicotine delivery system (MODs). page - MyRAS Survey
        # And selects Unsure/Unknown option for Did your biological mother drink any alcoholic beverages during her pregnancy with you? page - myRAS Survey
        # And selects Unsure/Unknown option for Did your biological mother use any recreational drugs during her pregnancy with you? page -myRAS Survey
        # And selects Unsure/Unknown option for Did your biological mother ever live or work in a place where others smoked cigarettes, pipes or cigars around her pregnancy with you? page - myRAS Survey
        # And selects Unsure/Unknown option for Please describe your biological parents occupation (s) during your mother's pregnancy with you? Please list all of the occupations during the pregnancy. page -myRAS Survey
        # And selects Unsure/Unknown option for What is the height of your biological mother and father? Please complete the table below. - myRAS Survey
        # And clicks next button on The next set of questions will ask about hormone-related growth. page - myRAS Survey
        # And selects Unsure/Unknown option for Have you ever been evaluated by an endocrinologist for any reason? page - myRAS Survey
        # And selects Unsure/Unknown option for Have you ever had growth hormone testing? page - myRAS Survey
        # And selects Unsure/Unknown option for Have you ever received growth hormone treatment? page - myRAS Survey
        # And selects Unsure/Unknown option for How many times have you received growth hormone treatment? page - myRAS Survey
        # And clicks next button on The next set of questions will ask about development. Development includes things such as crawling/walking and speaking/understanding language. page - myRAS Survey
        # And selects Unsure/Unknown option for Were you ever diagnosed with hypotonia as an infant or child? page - myRAS Survey
        # And selects Unsure/Unknown option for At what age were you able to sit without support? page - myRAS Survey
        # And selects Unsure/Unknown option for At what age were you able to walk without support? page - myRAS Survey
        # And selects Unsure/Unknown option for Have you ever received physical therapy? page - myRAS Survey
        # And selects Unsure/Unknown option for How would you describe your current speech capabilities? page - myRAS Survey
        # And selects Unsure/Unknown option for Have you ever received speech therapy? page - myRAS Survey
        # And selects Unsure/Unknown option for Between the ages of 3 and 6 years old (preschool years), were you ever diagnosed with issues of cognitive development? page - myRAS Survey
        # And selects Unsure/Unknown option for Between the ages of 6 and 10 (elementary school age) please select the option that best describes your schooling. page - myRAS Survey
        # And selects Unsure/Unknown option for Between the ages of 10 and 17 (middle and high school age) please select the option that best describes your schooling. page - myRAS Survey
        # And selects Bachelors degree(4-year degree with BA, BS, AB, BBA) option for Please indicate the highest degree or level of schooling you have completed  page - myRAS Survey
        # And selects Unsure/Unknown option for What is your current employment status? page - myRAS Survey
        # And selects next button for Have you ever been diagnosed with any of the following learning differences?  Please select all that apply. page - myRAS Survey
        # And selects Unsure/Unknown option for If you have ever had formal IQ testing and have a copy, please upload it here. page - myRAS Survey
        # And clicks next button on The next set of questions will ask about medical conditions associated with the heart. page - myRAS Survey
        # And clicks next button on The next set of questions will ask about hormone-related growth. page - myRAS Survey


        And clicks Unsure/Unknown option for Do you have jaw or temporomandibular joint pain? page - myRAS Survey
        And clicks Unsure/Unknown option for Do you have frequent headaches? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you had any orthodontic treatment? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you had any facial or dental trauma? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you had elective jaw surgery? page - myRAS Survey
        And clicks Unsure/Unknown option for Do you have a history of cancer in the mouth or jaw? page - myRAS Survey
        And clicks Unsure/Unknown option for Do you have a family member with a jaw abnormality? page - myRAS Survey
        And clicks Unsure/Unknown option for Do you have any numbness in or around your mouth? page - myRAS Survey
        And clicks Unsure/Unknown option for Do you have any mouth sores? page - myRAS Survey
        And clicks Unsure/Unknown option for Do your teeth feel sensitive to hot or cold foods? page - myRAS Survey
        And clicks Unsure/Unknown option for Do you have problems moving your lips, tongue or mouth? page - myRAS Survey
        And clicks Unsure/Unknown option for Overall -- Is there anything unusual about your teeth or mouth, extra teeth, missing teeth, severe dental diseases, jawbone problems, enamel problems, etc.?  page - myRAS Survey
        And clicks Unsure/Unknown option for Have you had trouble pronouncing any words because of problems with your teeth, mouth or dentures? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you felt that your sense of taste has worsened because of problems with your teeth, mouth or dentures? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you had painful aching in your mouth? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you found it uncomfortable to eat any foods because of problems with your teeth, mouth or dentures? page - myRAS Survey
        And clicks Unsure/Unknown option for Are you self-conscious because of your teeth, mouth or dentures? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you felt tense because of problems with your teeth, mouth or dentures? page - myRAS Survey
        And clicks Unsure/Unknown option for Has your diet been unsatisfactory because of problems with your teeth, mouth or dentures? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you found it difficult to relax because of problems with your teeth, mouth or dentures? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you been a bit embarrassed because of problems with your teeth, mouth or dentures? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you been irritable with other people because of problems with your teeth, mouth or dentures? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you had difficulty doing your usual jobs because of problems with your teeth, mouth or dentures? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you felt that life in general is less satisfying because of problems with your teeth, mouth or dentures? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you been totally unable to function because of problems with your teeth, mouth or dentures? page - myRAS Survey
        And clicks next button for The next set of questions ask about fluid balance and if any fluid builds up throughout the body. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been diagnosed with a lymphatic system issue? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been diagnosed with any of the following lymphatic system issues? page - myRAS Survey
        And enters "X" for Dont know Date or Age of First Symptoms and "X" for Dont know Date or Age Diagnosis and selects Unsure/Dont know Treatment for Please complete the table below to the best of your ability about the onset of symptoms, when you were diagnosed and if any procedures or medications were undertaken. page - myRAS Survey
        And clicks next on The next set of questions will ask about the kidneys. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been evaluated by a nephrologist? These are doctors that specialize in the kidneys. They often diagnose conditions related to kidney function and help people get dialysis if their kidneys are not working well. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been diagnosed with a kidney problem? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been diagnosed with any of the following kidney problems? Please select all that apply. page - myRAS Survey
        And clicks next on The next set of questions ask about hair and skin qualities. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been evaluated by a dermatologist? page - myRAS Survey
        And Selects Other and enters "UNSURE/UNKNOWN" for please specify text box for Please choose the best term(s) to describe your hair. Please select all that apply. page - myRAS Survey
        And clicks Unsure/Unknown option for Is the texture or amount of your hair similar to biological family members, such as your mother, father, sibling, and children? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been diagnosed with any of the following issues involving patches of thickened skin, also known as hyperkeratotis skin? Please select all that apply. page - myRAS Survey
        And clicks Unsure/Unknown option for Do you have any of the following pigmented skin findings? Select all that apply. page - myRAS Survey
        And clicks Unsure/Unknown option for Do you have any hemangiomas? Hemangiomas are bright red marks on the skin made up of blood vessels, which may appear as a mass or lump. A hemangioma may appear in infancy or childhood and fade over time. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been diagnosed with any of the following skin tumors? Please select all that apply. page - myRAS Survey
        And clicks next on The next set of questions ask about skeletal conditions. Skeletal conditions involve the bones throughout the body. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been evaluated by an orthopaedic surgeon? Orthopaedic surgeons are doctors who specialize in the bones and muscles. They diagnose and treat a range of conditions including broken bones, osteosarcoma, and torn ligaments. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you been diagnosed with any of the following skeletal findings in the thoracic area? The thoracic area includes the chest and ribs. Please select all that apply. page - myRAS Survey
        And clicks Unsure/Unknown option for Do you have any issues with curving of the spine? This would often be diagnosed or evaluated by an orthopaedic surgeon. Examples include scoliosis and kyphosis. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been diagnosed with any of the following types of curvature of the spine? Please select all that apply. page - myRAS Survey
        And clicks Unsure/Unknown option for Has your neck been described as short or webbed? Individuals with a short, webbed neck may have a low hairline or extra skin where the neck meets the shoulders. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been diagnosed with joint issues? These conditions are often diagnosed by neurologists, rheumatologists and orthopaedic surgeons. Examples include ulnar deviation, Achilles tendon contracture, hip dysplasia. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been diagnosed with the following joint issues? Please select all that apply. page - myRAS Survey
        And clicks next on The next set of questions ask about blood disorders. Blood disorders include immune system problems (white blood cells) or bleeding/clotting issues (platelets) or other bone marrow problems (where white blood cells, red blood cells and platelets are produced). page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever had an evaluation by a hematologist or oncologist? Hematologists are physicians who specialize in the blood system, including white blood cells, platelets, red blood cells and clotting factors. Oncologists are physicians who specialize in cancer. page - myRAS Survey
        And clicks Unsure/Unknown option for Do you have issues with bleeding or bruising? Examples include easy bruising, poor blood clotting. These conditions are often evaluated and diagnosed by a hematologist (a physician who specializes in the blood). page - myRAS Survey
        And clicks Unsure/Unknown option for Do you have any of the following issues with bleeding or bruising? Please select all that apply. page - myRAS Survey
        And clicks Unsure/Unknown option for Do you have any known blood disorders or symptoms of blood disorders? Examples include an enlarged spleen, leukemia, low platelets or low blood cells. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been diagnosed with any of the following blood disorders or symptoms of blood disorders? Please select all that apply. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been diagnosed with any of the following tumors? Please select all that apply. page - myRAS Survey
        And clicks Unsure/Unknown option for Do you have a history of frequent infections (typically recurrent sinus infections or pneumonia) or immunodeficiency? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been evaluated by an immunologist or rheumatologist? These are physicians who specialize in the immune system and how it functions. They diagnose conditions such as lupus, autoimmune thyroiditis, and psoriasis. page - myRAS Survey
        And clicks Unsure/Unknown option for How would you describe infection frequency and your immune system? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been diagnosed with an autoimmune disorder? An autoimmune disorder is when the immune system attacks the body's own healthy tissues; can include Hashimoto thyroiditis, lupus, or autoimmune thrombocytopenia, etc. page - myRAS Survey
        And clicks Unsure/Unknown option for With what autoimmune disorder have you been diagnosed? page - myRAS Survey
        And clicks next on The next set of questions ask about conditions associated with the central nervous system. The central nervous system includes the brain and spinal cord. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been evaluated by a neurologist or neurosurgeon? These are physicians who specialize in the brain and spinal cord. They diagnose conditions such as seizures, brain tumors, and brain malformations. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been diagnosed with a structural brain abnormality? Examples include Chiari 1 malformation, hydrocephalus, tethered spinal cord. These conditions are often diagnosed using a CT or MRI scan and evaluated by neurosurgeons. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been diagnosed with any of the following issues of the brain? page - myRAS Survey
        And clicks Unsure/Unknown option for Do you have a history of seizures? page - myRAS Survey
        And clicks Unsure/Unknown option for Please select all seizure disorders for which you have been diagnosed. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been evaluated by a psychiatrist, psychologist or behavioral pediatrician? These medical providers often diagnose conditions such as depression, anxiety, learning difficulties, and developmental disorders. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been diagnosed with a behavioral or psychiatric condition? Examples include mood disorders (depression), self-harm acts, anxiety, bipolar disorder, autism spectrum disorder, aggression. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been diagnosed with a behavioral or psychiatric condition? Please select all that apply. page - myRAS Survey
        And enters "UNSURE/UNKNOWN" and clicks next on Please list and describe any additional neurologic conditions here that were not covered by the previous questions. page - myRAS Survey
        And clicks next on The next set of questions ask about vision and hearing. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever been diagnosed with ptosis (droopiness of the upper eyelid)? page - myRAS Survey
        And clicks Unsure/Unknown option for Did you require treatment for ptosis? page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever had any issues with your vision or eyesight? Examples include nearsightedness (when things in the distance look fuzzy), astigmatism, "lazy eye". page - myRAS Survey
        And clicks Unsure/Unknown option for Please select all the vision/eyesight conditions for which you have been diagnosed. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever experienced strabismus? Strabismus is when the eyes are not aligned properly; one may wander up, down or sideways. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you ever experienced nystagmus? Nystagmus is when the eye makes sudden, uncontrolled movements, like tremors. page - myRAS Survey
        And clicks Unsure/Unknown option for Have you experienced hearing loss? page - myRAS Survey
        And Selects Other and enters "UNSURE/UNKNOWN" for Have you experienced any of the following types of hearing loss? Please select all that apply. page - myRAS Survey
