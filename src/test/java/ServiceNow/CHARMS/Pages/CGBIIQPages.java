...
public class CGBIIQPages extends CommonUtils {
	...
	/**
	 * This is the element for the next button (Can be used for any next button on
	 * questoinnaire)
	 */
	@FindBy(xpath = "//input[@name='NextButton']")
	public WebElement nextButton;

	/** Element of Statement of confidentiality text */
	@FindBy(xpath = "//div[contains(text(),'Completion of this questionnaire')]")
	public WebElement statementOfConfidentialityText;

	/** Element of instructions text */
	@FindBy(xpath = "//div[contains(text(),'Some of this information')]")
	public WebElement instructionsText;

	/** Div of general background info section text */
	@FindBy(xpath = "//div[contains(text(),'general background')]")
	public WebElement generalBackgroundText;
	...
	/**
	 * This element is for the the Native Hawaiian or Other Pacific Islander race
	 * check box
	 */
	...
	/**
	 * This how was the Proband conceived Yes, donor sperm and egg value radio
	 * button
	 */
	...
	/** How much was the Participant when they were born? (in lbs) */
	...
	/**
	 * How long was the circumference of the Participant Head when they were born?
	 * (in
	 * Inches)
	 */
	...
	/**
	 * Unit of measurement for how much was the Participant when they were born? (in
	 * lbs)
	 */
	...
	/**
	 * Unit of measurement for how long was the circumference of the Participant
	 * Head
	...
	/**
	 * Unit of measurement for how much was the Proband when they were born? (in
	 * lbs)
	 */
	...
	/**
	 * This webelement is the Adrenal Gland selection of the Please select or report
	 * the primary cancer(s) or benign tumor(s) that have been diagnosed
	 */
	...
	/**
	 * State and address of Facility where the Proband was Diagnosed{New tag type =
	 * textarea}
	 */
	@FindBy(xpath = "(//textarea[@type='text'])[1]")
	public WebElement facilityAddressWhereProbandWasDiagnosedTextArea;
	...
	/**
	 * State and address of Facility where the Proband was Treated{New tag type =
	 * textarea}
	 */
	@FindBy(xpath = "(//textarea[@type='text'])[2]")
	public WebElement facilityAddressWhereProbandWasTreatedTextArea;
	...
	/**
	 * Selected answer that best summarizes the findings of the evaluation Proband
	 * Flow
	 */
	@FindBy(xpath = "//select[@id='QR~QID70#3~1']")
	...
	@FindBy(xpath = "//input[@name='QR~QID174#1~3~1~TEXT']")
	public WebElement numericalWeightAt18;

	/** Weight of Proband at 30 years old Proxy Flow */
	@FindBy(xpath = "//input[@name='QR~QID174#1~4~1~TEXT']")
	...
	@FindBy(xpath = "//input[@name='QR~QID173#1~1~1~TEXT']")
	...
	@FindBy(xpath = "//input[@name='QR~QID173#1~4~1~TEXT']")
	public WebElement numericalWeightAt30ProbandFlow;

	/** Weight of Proband at 40 years old */
	@FindBy(xpath = "//input[@name='QR~QID173#1~5~1~TEXT']")
