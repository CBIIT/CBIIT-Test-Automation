...
public class RASSurveyPage {
	...
	/*
	 * ----------------- BEGINNING OF TO CONFIRM, ARE YOU COMPLETING THIS FORM FOR
	 * YOURSELF OR FOR SOMEONE ELSE? PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF TO CONFIRM, ARE YOU COMPLETING THIS FORM FOR
	 * YOURSELF OR FOR SOMEONE ELSE? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINNING OF PLEASE PROVIDE ANY ADDITIONAL INFORMATION
	 * ABOUT THE AUTHORS, YEAR OF PUBLICATION OR PUBMED ID (PMID), IF AVAILABLE PAGE
	 * -----------------
	 */
	...
	/*
	 * ----------------- END OF PLEASE PROVIDE ANY ADDITIONAL INFORMATION ABOUT THE
	 * AUTHORS, YEAR OF PUBLICATION OR PUBMED ID (PMID), IF AVAILABLE PAGE
	 * -----------------
	 */

	/*
	 * ----------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW REGARDING YOUR
	...
	/*
	 * ----------------- BEGINNING OF WERE YOU DIAGNOSED WITH ANY OF THE FOLLOWING
	 * CONDITIONS DURING YOUR MOTHER'S PREGNANCY?
	 * THESE ARE CONDITIONS OFTEN DETECTED ON ROUTINE FETAL ULTRASOUND. PLEASE
	...
	/*
	 * ----------------- END OF WERE YOU DIAGNOSED WITH ANY OF THE FOLLOWING
	 * CONDITIONS DURING YOUR MOTHER'S PREGNANCY?
	 * THESE ARE CONDITIONS OFTEN DETECTED ON ROUTINE FETAL ULTRASOUND. PLEASE
	 * SELECT ALL THAT APPLY. PAGE -----------------
	 */
	...
	/*
	 * ----------------- BEGINNING OF PLEASE INDICATE THE RESULTS OF THE PRENATAL
	...
	/*
	 * ----------------- END OF PLEASE INDICATE THE RESULTS OF THE PRENATAL TESTS
	 * ADMINISTERED TO
	 * YOUR BIOLOGICAL MOTHER DURING HER PREGNANCY WITH YOU. PAGE -----------------
	 */

	/*
	 * ----------------- BEGINNING OF WAS YOUR BIOLOGICAL MOTHER DIAGNOSED WITH ANY
	 * OF THE FOLLOWING
	...
	/*
	 * ----------------- END OF WAS YOUR BIOLOGICAL MOTHER DIAGNOSED WITH ANY OF THE
	 * FOLLOWING
	 * CONDITIONS PRIOR TO OR DURING HER PREGNANCY WITH YOU? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINNING OF PLEASE SELECT ALL MEDICATIONS YOUR MOTHER TOOK
	 * DURING HER PREGNANCY WITH YOU. PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF PLEASE SELECT ALL MEDICATIONS YOUR MOTHER TOOK
	 * DURING HER PREGNANCY WITH YOU. PAGE -----------------
	 */

	/*
	 * ----------------- BEGINNING OF PLEASE PROVIDE DETAILS ON THE NAME OF THE
	 * MEDICATION TAKEN, REASON IT WAS TAKEN AND APPROXIMATE LENGTH OF TIME IT WAS
	 * TAKEN.
	 * IF YOU ARE UNSURE OF THE NAME OF OR REASON FOR THE MEDICATION, WRITE 'UNSURE'
	 * OR PLACE AN 'X' IN THE TEXT BOX. PAGE -----------------
	 */
	 ...
	 * TAKEN, REASON IT WAS TAKEN AND APPROXIMATE LENGTH OF TIME IT WAS TAKEN.
	 * IF YOU ARE UNSURE OF THE NAME OF OR REASON FOR THE MEDICATION, WRITE 'UNSURE'
	 * OR PLACE AN 'X' IN THE TEXT BOX. PAGE -----------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE DESCRIBE YOUR BIOLOGICAL PARENTS'
	 * OCCUPATION(S) DURING YOUR MOTHER'S PREGNANCY WITH YOU? PLEASE LIST ALL OF THE
	 * OCCUPATIONS DURING THE PREGNANCY. PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF PLEASE DESCRIBE YOUR BIOLOGICAL PARENTS' OCCUPATION(S)
	 * DURING YOUR MOTHER'S PREGNANCY WITH YOU? PLEASE LIST ALL OF THE OCCUPATIONS
	 * DURING THE PREGNANCY. PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF WHAT IS THE HEIGHT OF YOUR BIOLOGICAL MOTHER AND
	 * FATHER? PLEASE COMPLETE THE TABLE BELOW PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF WHAT IS THE HEIGHT OF YOUR BIOLOGICAL MOTHER AND
	 * FATHER? PLEASE COMPLETE THE TABLE BELOW PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF WHAT IS THE NAME OF THE ENDOCRINOLOGIST WHO
	 * COMPLETED YOUR EXAMINATION? PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF WHAT IS THE NAME OF THE ENDOCRINOLOGIST WHO COMPLETED
	 * YOUR EXAMINATION? PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF WHAT WAS YOUR HEIGHT BEFORE STARTING GROWTH
	 * HORMONE? PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF WHAT WAS YOUR HEIGHT BEFORE STARTING GROWTH HORMONE?
	 * PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF HOW MANY TIMES HAVE YOU RECEIVED GROWTH HORMONE
	 * TREATMENT? PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF HOW MANY TIMES HAVE YOU RECEIVED GROWTH HORMONE
	 * TREATMENT? PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE PROVIDE THE DETAILS OF GROWTH HORMONE
	 * REPLACEMENT BY COMPLETING THE TABLE BELOW. PAGE ---------------
	 */
	...
	// TYPE OF GROWTH HORMONE TREATMENT#1 ARE YOU STILL ON GROWTH HORMONE? NO RADIO
	// BUTTON
	...
	// TYPE OF GROWTH HORMONE TREATMENT#2 ARE YOU STILL ON GROWTH HORMONE? NO RADIO
	// BUTTON
	...
	// TYPE OF GROWTH HORMONE TREATMENT#3 ARE YOU STILL ON GROWTH HORMONE? NO RADIO
	// BUTTON
	...
	/*
	 * --------------- END OF PLEASE PROVIDE THE DETAILS OF GROWTH HORMONE
	 * REPLACEMENT BY COMPLETING THE TABLE BELOW. PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF AT WHAT AGE WERE YOU ABLE TO SIT WITHOUT
	 * SUPPORT? PAGE ---------------
	 */

	// TYPE OF AT WHAT AGE WERE YOU ABLE TO SIT WITHOUT SUPPORT? 12-18 MONTHS RADIO
	// BUTTON
	...
	/*
	 * --------------- BEGINNING OF AT WHAT AGE WERE YOU ABLE TO WALK WITHOUT
	 * SUPPORT? PAGE ---------------
	 */

	// TYPE OF AT WHAT AGE WERE YOU ABLE TO WALK WITHOUT SUPPORT? 12 -18 MONTHS
	// RADIO BUTTON
	@FindBy(xpath = "(//label[@for='QR~QID84~3'])[2]")
	public WebElement atWhatAgeWereYouAbleToWalkWithoutSupportCheckRadioButton;

	/*
	 * --------------- END OF AT WHAT AGE WERE YOU ABLE TO WALK WITHOUT SUPPORT?
	 * PAGE ---------------
	 */

	/*
	 * ----------------- BEGINNING OF AT WHAT AGE WERE YOU ABLE TO USE SIMPLE
	 * TWO-WORD PHRASES? PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF WHAT AGE WERE YOU ABLE TO USE SIMPLE TWO-WORD
	 * PHRASES? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINNING OF HOW WOULD YOU DESCRIBE YOUR CURRENT SPEECH
	 * CAPABILITIES? PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF HOW WOULD YOU DESCRIBE YOUR CURRENT SPEECH
	 * CAPABILITIES? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINNING OF BETWEEN THE AGES OF 3 AND 6 YEARS OLD
	 ...
	 * UNDERSTANDING, AND PROCESSING INFORMATION OR MAKING DECISIONS. PAGE
	 * -----------------
	 */
	...
	/*
	 * ----------------- END OF BETWEEN THE AGES OF 3 AND 6 YEARS OLD (PRESCHOOL
	 * YEARS), WERE YOU EVER DIAGNOSED WITH ISSUES OF COGNITIVE DEVELOPMENT?
	 * COGNITIVE DEVELOPMENT CAN INCLUDE DIFFICULTIES IN LEARNING, UNDERSTANDING,
	 * AND PROCESSING INFORMATION OR MAKING DECISIONS. PAGE -----------------
	 */

	/*
	 * ----------------- BEGINNING OF BETWEEN THE AGES OF 6 AND 10 (ELEMENTARY
	 * SCHOOL AGE) PLEASE SELECT THE OPTION THAT BEST DESCRIBES YOUR SCHOOLING. PAGE
	 * -----------------
	 */
	...
	/*
	 * ----------------- END OF BETWEEN THE AGES OF 6 AND 10 (ELEMENTARY SCHOOL AGE)
	 * PLEASE SELECT THE OPTION THAT BEST DESCRIBES YOUR SCHOOLING. PAGE
	 * -----------------
	 */

	/*
	 * ----------------- BEGINNING OF BETWEEN THE AGES OF 10 AND 17 (MIDDLE AND HIGH
	 * SCHOOL AGE) PLEASE SELECT THE OPTION THAT BEST DESCRIBES YOUR SCHOOLING. PAGE
	 * -----------------
	 */
	...
	/*
	 * ----------------- END OF BETWEEN THE AGES OF 10 AND 17 (MIDDLE AND HIGH
	 * SCHOOL AGE) PLEASE SELECT THE OPTION THAT BEST DESCRIBES YOUR SCHOOLING. PAGE
	 * -----------------
	 */

	/*
	 * ----------------- BEGINNING OF PLEASE INDICATE THE HIGHEST DEGREE OR LEVEL OF
	 * SCHOOLING YOU HAVE COMPLETED PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF PLEASE INDICATE THE HIGHEST DEGREE OR LEVEL OF
	 * SCHOOLING YOU HAVE COMPLETED PAGE -----------------
	 */
	...
	/*
	 * ----------------- BEGINNING OF WHAT IS THE NAME OF THE CARDIOLOGIST WHO
	 * COMPLETED YOUR HEART EVALUATION? PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF WHAT IS THE NAME OF THE CARDIOLOGIST WHO COMPLETED
	 * YOUR HEART EVALUATION? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINNING OF Please complete the table below for the
	 * following symptom(s), indicating when these symptoms occurred and where these
	 * symptoms were evaluated. You only have to provide the age or date for each
	 * symptom (not both). If you don't recall when the symptom first started or
	...
	// “HEART PALPITATIONS/IRREGULAR HEARTBEAT FIRST HOSPITAL EVALUATION AGE" TEXT
	// BOX
	...
	// “HEART PALPITATIONS/IRREGULAR HEARTBEAT FIRST HOSPITAL EVALUATION
	// DATE(MM/YY)" TEXT BOX
	...
	// “HEART PALPITATIONS/IRREGULAR HEARTBEAT FIRST HOSPITAL EVALUATION DON'T KNOW"
	// TEXT BOX
	...
	// “HEART PALPITATIONS/IRREGULAR HEARTBEAT MOST RECENT HOSPITAL EVALUATION" TEXT
	// BOX
	...
	// “TRANSIENT ISCHEMIC ATTACK (TIA) FIRST HOSPITAL EVALUATION DATE(MM/YY)" TEXT
	// BOX
	@FindBy(xpath = "(//input[contains(@type,'text')])[86]")
	public WebElement transientIschemicAttackFirstHospitalEvaluationDateTextBox;

	// “TRANSIENT ISCHEMIC ATTACK (TIA) FIRST HOSPITAL EVALUATION DON'T KNOW" TEXT
	// BOX
	...
	// “NEVER HAD ANY OF THESE SYMPTOMS FIRST HOSPITAL EVALUATION DATE(MM/YY)" TEXT
	// BOX
	@FindBy(xpath = "(//input[contains(@type,'text')])[94]")
	public WebElement neverHadAnyOfTheseSymptomsFirstHospitalEvaluationDateTextBox;

	// “NEVER HAD ANY OF THESE SYMPTOMS FIRST HOSPITAL EVALUATION DON'T KNOW" TEXT
	// BOX
	...
	/*
	 * ----------------- END OF PLEASE COMPLETE THE TABLE BELOW FOR THE FOLLOWING
	 * SYMPTOM(S), INDICATING WHEN THESE SYMPTOMS OCCURRED AND WHERE THESE SYMPTOMS
	 * WERE EVALUATED. YOU ONLY HAVE TO PROVIDE THE AGE OR DATE FOR EACH SYMPTOM
	 * (NOT BOTH). IF YOU DON'T RECALL WHEN THE SYMPTOM FIRST STARTED OR WHEN IT
	 * MOST RECENTLY OCCURRED, PLACE AN 'X' UNDER "DON'T KNOW." PAGE
	 * -----------------
	 */

	/*
	 * ----------------- BEGINNING OF HAVE YOU EVER HAD ANY OF THE FOLLOWING
	 * TREATMENTS FOR HEART PROBLEMS? PLEASE SELECT ALL THAT APPLY. PAGE
	 * -----------------
	 */
	...
	/*
	 * ----------------- END OF HAVE YOU EVER HAD ANY OF THE FOLLOWING TREATMENTS
	 * FOR HEART PROBLEMS? PLEASE SELECT ALL THAT APPLY. PAGE -----------------
	 */

	/*
	 * ----------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW BY PROVIDING
	 * INFORMATION FOR THE FIRST TREATMENT AND THE MOST RECENT TREATMENT. YOU ONLY
	 * NEED TO PROVIDE THE AGE AT WHICH SYMPTOMS OCCURRED OR DATE (NOT BOTH). IF YOU
	 * DO NOT RECALL THE DETAILS, PLEASE PLACE AN 'X' IN THE 'DON'T KNOW' BOX. PAGE
	 * -----------------
	 */
	...
	/*
	 * ----------------- END OF PLEASE COMPLETE THE TABLE BELOW BY PROVIDING
	 * INFORMATION FOR THE FIRST TREATMENT AND THE MOST RECENT TREATMENT. YOU ONLY
	 * NEED TO PROVIDE THE AGE AT WHICH SYMPTOMS OCCURRED OR DATE (NOT BOTH). IF YOU
	 * DO NOT RECALL THE DETAILS, PLEASE PLACE AN 'X' IN THE 'DON'T KNOW' BOX. PAGE
	 * -----------------
	...
	/*
	 * --------------- BEGINNING OF PROVIDE ANY DETAILS KNOWN FOR THE CONDITION(S)
	 * FOR WICH YOU HAVE BEEN DIAGNOSTED. PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF PROVIDE ANY DETAILS KNOWN FOR THE CONDITION(S) FOR
	 * WICH YOU HAVE BEEN DIAGNOSTED. PAGE ---------------
	 */
	...
	/*
	 * --------------- BEGINNING OF TABLE OF ALL MEDICATIONS YOU ARE ALLERGIC TO .
	 * PAGE ---------------
	 */
	...
	/*
	 * --------------- BEGINNING OF TABLE OF ALL FOOD OF WHICH YOU ARE ALLERGIC TO .
	 * PAGE ---------------
	 */
	...
	/*
	 * --------------- BEGINNING OF TABLE OF ALL "OTHER" ITEMS TO WHICH YOU ARE
	 * ALLERGIC THAT WERE NOT INCLUDED IN MEDICATION OR FOOD ALLERGIES. . PAGE
	 * ---------------
	 */
	...
	/*
	 * --------------- END OF TABLE OF ALL "OTHER" ITEMS TO WHICH YOU ARE ALLERGIC
	 * THAT WERE NOT INCLUDED IN MEDICATION OR FOOD ALLERGIES. . PAGE
	 * ---------------
	 */

	/*
	 * --------------- BEGINNING OF TABLE OF INFORMATION FOR EACH BIOPSY AND SURGERY
	 * IN THE TABLE BELOW.. PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF TABLE OF INFORMATION FOR EACH BIOPSY AND SURGERY IN
	 * THE TABLE BELOW.. PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF PLEASE PROVIDE THE INFORMATION FOR EACH
	 * HOSPITALIZATION IN THE TABLE BELOW.
	 * TO ADD A NEW HOSPITALIZATION, PLEASE CLICK ON THE '+' SIGN IN THE UPPER LEFT
	 * CORNER OF THE TABLE. PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF THE DETAILS FOR THE GASTROENTEROLOGIST WHO
	 * COMPLETED THE EVALUATION PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF THE DETAILS FOR THE GASTROENTEROLOGIST WHO COMPLETED
	 * THE EVALUATION PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF AT WHAT AGE WAS THE NASOGASTRIC OR NASOJEJUNAL
	 * TUBE PLACED? PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF AT WHAT AGE WAS THE NASOGASTRIC OR NASOJEJUNAL TUBE
	 * PLACED? PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF AT WHAT AGE WAS THE GASTROSTOMY (G-TUBE) OR
	 * GASTROSTOMY-JEJUNOSTOMY (GJ) TUBE PLACED? PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF AT WHAT AGE WAS THE GASTROSTOMY (G-TUBE) OR
	 * GASTROSTOMY-JEJUNOSTOMY (GJ) TUBE PLACED? PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF AT WHAT AGE WAS THE GASTROSTOMY (G-TUBE) OR
	 * GASTROSTOMY-JEJUNOSTOMY (GJ) TUBE REMOVED? PAGE ---------------
	 */
	...
	/*
	 * --------------- BEGINNING OF WHICH OF THE FOLLOWING SYMPTOMS RELATED TO THE
	 * GI SYSTEM HAVE OCCURRED? PLEASE SELECT ALL THAT APPLY. PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF WHICH OF THE FOLLOWING SYMPTOMS RELATED TO THE GI
	 * SYSTEM HAVE OCCURRED? PLEASE SELECT ALL THAT APPLY. PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF THE SYMPTOMS LISTED BELOW WERE PREVIOUS SYMPTOMS
	 * OR CURRENT (ONGOING) SYMPTOMS. PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF THE SYMPTOMS LISTED BELOW WERE PREVIOUS SYMPTOMS OR
	 * CURRENT (ONGOING) SYMPTOMS. PAGE ---------------
	 */
	...
	/*
	 * --------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW REGARDING
	 * HEARTBURN/REFLUX SYMPTOMS. PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF PLEASE COMPLETE THE TABLE BELOW REGARDING
	 * HEARTBURN/REFLUX SYMPTOMS. PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW REGARDING NAUSEA
	 * SYMPTOMS. PAGE ---------------
	 */

	// HAS BOTHERSOME NAUSEA OCCURRED FOR AT LEAST 2 WEEKS NOT RELATED TO MEALS? YES
	// RADIO BUTTON
	@FindBy(xpath = ("//label[@for='QR~QID130#1~1~1']"))
	public WebElement bothersomeNauseaForAtLeast2WeeksNotRelatedToMealsYesRadioButton;

	// HAS NAUSEA THAT IS NOT RELATED TO VOMITING OCCURING(THAT HAS OCCURRED FOR
	// ATLEAST 2 WEEKS? YES RADIO BUTTON
	...
	// PLEASE INCLUDE THE AGES AT WHICH NAUSEA MEDICATIONS WERE TAKEN AND
	// MEDICATIONS WERE TAKEN AND THE MEDICATION NAME? TEXTBOX
	...
	/*
	 * --------------- END OF PLEASE COMPLETE THE TABLE BELOW REGARDING NAUSEA
	 * SYMPTOMS. PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE COMPLETE THE NEXT SET OF QUESTIONS
	 * REGARDING ABDOMINAL PAIN. PAGE ---------------
	 */

	// EVER HAD WAVES OF SEVERE, DISTRESSING,ACUTE PAIN AT THE BELLY-BUTTON OR
	// ENTIRE ABDOMEN? YES RADIO BUTTON
	...
	// DOES ABDOMINAL PAIN PREVENT THE COMPLETION OF USUAL ACTIVITIES? YES RADIO
	// BUTTON
	...
	// IS THE PAIN NOT RELATED TO EATING, MENSTRUAL CYCLES OR OTHER ILLNESS? YES
	// RADIO BUTTON
	...
	// HAS ABDOMINAL PAIN EVER CAUSED AWAKENING FROM SLEEP AT NIGHT? YES RADIO
	// BUTTON
	...
	// IS ABDOMINAL PAIN ASSOCIATED WITH IRRITATION TO BRIGHT LIGHT? YES RADIO
	// BUTTON
	...
	/*
	 * --------------- END OF PLEASE COMPLETE THE NEXT SET OF QUESTIONS REGARDING
	 * ABDOMINAL PAIN. PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF HOW MANY MEDICATIONS HAVE BEEN TAKEN FOR
	 * ABDOMINAL PAIN? PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF HOW MANY MEDICATIONS HAVE BEEN TAKEN FOR ABDOMINAL
	 * PAIN? PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW REGARDING THE
	...
	/*
	 * --------------- BEGINNING OF PLEASE COMPLETE THE NEXT SET OF QUESTIONS
	 * REGARDING VOMITING. PAGE ---------------
	 */

	// EVER HAD AT LEAST 2 MONTHS WITH 1 OR MORE EPISODES OF VOMITING PER WEEK? YES
	// RADIO BUTTON
	...
	// IS VOMITING RELATED TO MEDICATION, SURGERY OR OTHER HEALTH ISSUE? YES RADIO
	// BUTTON
	...
	// EVER HAVE 2 OR MORE EPISODES OF INTENSE NAUSEA AND VOMITING THAT LASTS HOURS
	// TO DAYS WITHIN A 6-MONTH PERIOD? YES RADIO BUTTON
	...
	// DO EPISODES OF VOMITING SEEM SIMILAR TO EACH OTHER WHEN THEY OCCUR? YES RADIO
	// BUTTON
	...
	// ARE THERE WEEKS TO MONTHS WITHOUT SYMPTOMS OF NAUSEA/VOMITING BETWEEN
	// EPISODES? YES RADIO BUTTON
	...
	/*
	 * --------------- END OF HOW MANY MEDICATIONS HAVE BEEN TAKEN FOR VOMITING?
	 * PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE COMPLETE THE LIST BELOW BY DESCRIBING ANY
	 * MEDICATIONS TAKEN FOR VOMITING AND THE AGE WHEN THESE MEDICATIONS WERE TAKEN.
	 * PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF PLEASE COMPLETE THE LIST BELOW BY DESCRIBING ANY
	 * MEDICATIONS TAKEN FOR VOMITING AND THE AGE WHEN THESE MEDICATIONS WERE TAKEN.
	 * PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE ANSWER THE BELOW QUESTIONS REGARDING
	 * JAUNDICE (YELLOWING OF THE SKIN). PAGE ---------------
	 */

	// WHAT AGE DID JAUNDICE OCCUR? PLEASE SPECIFY IF DAYS/WEEKS/MONTHS/YEARS OLD. 1
	// DAY TEXT BOX
	...
	/*
	 * --------------- END OF PLEASE ANSWER THE BELOW QUESTIONS REGARDING JAUNDICE
	 * (YELLOWING OF THE SKIN). PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF TO WHAT FOODS ARE YOU AVERSE? DESCRIBE FOODS
	 * THAT YOU AVOID BECAUSE YOU DO NOT LIKE THE TEXTURE OR OTHER PHYSICAL
	 * QUALITIES OF THE FOOD. PAGE ---------------
	 */

	// DESCRIBE FOODS THAT YOU AVOID BECAUSE YOU DO NOT LIKE THE TEXTURE OR OTHER
	// PHYSICAL QUALITIES OF THE FOOD. EGGS TEXT BOX
	...
	/*
	 * --------------- END OF TO WHAT FOODS ARE YOU AVERSE? DESCRIBE FOODS THAT YOU
	 * AVOID BECAUSE YOU DO NOT LIKE THE TEXTURE OR OTHER PHYSICAL QUALITIES OF THE
	 * FOOD. PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE ANSWER THE NEXT TWO QUESTIONS ABOUT
	 * DIARRHEA. PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF PLEASE ANSWER THE NEXT TWO QUESTIONS ABOUT DIARRHEA.
	 * PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW REGARDING
	 * DIARRHEA. IF MEDICATIONS HAVE NEVER BEEN USED, PLEASE PUT 'N/A' IN THE BOX.
	 * PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF PLEASE COMPLETE THE TABLE BELOW REGARDING DIARRHEA. IF
	 * MEDICATIONS HAVE NEVER BEEN USED, PLEASE PUT 'N/A' IN THE BOX. PAGE
	 * ---------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE COMPLETE THE TABLE REGARDING
	 * CONSTIPATION. PAGE ---------------
	 */
	...
	// POSTURING OR EXCESSIVE ATTEMPTS TO AVOID HAVING A BOWEL MOVEMENT. YES RADIO
	// BUTTON
	...
	// HAVING BOWEL MOVEMENTS IN PLACES INAPPROPRIATE OR NOT SOCIALLY ACCEPTABLE.
	// YES RADIO BUTTON
	...
	/*
	 * --------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW REGARDING
	 * ENCOPRESIS. IF MEDICATIONS HAVE NEVER BEEN USED, PLEASE PUT 'N/A' IN THE BOX.
	 * PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF PLEASE COMPLETE THE TABLE BELOW REGARDING ENCOPRESIS.
	 * IF MEDICATIONS HAVE NEVER BEEN USED, PLEASE PUT 'N/A' IN THE BOX. PAGE
	 * ---------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW REGARDING WEIGHT
	 * LOSS. PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF PLEASE COMPLETE THE TABLE BELOW REGARDING WEIGHT LOSS.
	 * PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING PLEASE COMPLETE THE INFORMATION BELOW REGARDING
	 * DECREASED APPETITE. PAGE ---------------
	 */
	...
	// HAVE NUTRITIONAL SUPPLEMENTS/FEEDS EVER BEEN TAKEN OR RECEIVED? YES, RADIO
	// BUTTON
	...
	// WHAT SUPPLEMENTAL NUTRITION HAVE BEEN TAKEN? PLEASE SELECT ALL THAT APPLY.
	// DRINK PEDIASURE CHECK BOX
	...
	/*
	 * --------------- END PLEASE COMPLETE THE INFORMATION BELOW REGARDING DECREASED
	 * APPETITE. PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF AT WHAT AGE (APPROXIMATELY) WERE YOU TOILET
	 * TRAINED? PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF AT WHAT AGE (APPROXIMATELY) WERE YOU TOILET TRAINED?
	 * PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE COMPLETE THE INFORMATION BELOW REGARDING
	 * URINATION. PAGE ---------------
	 */
	...
	// HAVE THERE BEEN ANY EPISODES OF REPEATED URINARY ACCIDENTS AFTER BEING TOILET
	// TRAINED? YES RADIO BUTTON
	...
	/*
	 * --------------- END OF PLEASE COMPLETE THE INFORMATION BELOW REGARDING
	 * URINATION. PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE COMPLETE THE INFORMATION BELOW REGARDING
	 * BOWEL MOVEMENTS. PAGE ---------------
	 */
	...
	// HAVE THERE BEEN ANY EPISODES OF REPEATED BOWEL MOVEMENT ACCIDENTS AFTER BEING
	// TOILET TRAINED? YES RADIO BUTTON
	...
	/*
	 * --------------- END OF PLEASE COMPLETE THE INFORMATION BELOW REGARDING BOWEL
	 * MOVEMENTS. PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF HOW MANY BOWEL MOVEMENTS DO YOU HAVE PER WEEK?
	 * PAGE ---------------
	 */
	...
	/*
	 * --------------- BEGINNING OF WHAT IS THE LONGEST AMOUNT OF TIME THAT HAS
	 * PASSED WITHOUT YOU HAVING A BOWEL MOVEMENT? PAGE ---------------
	 */

	// WHAT IS THE LONGEST AMOUNT OF TIME THAT HAS PASSED WITHOUT YOU HAVING A BOWEL
	// MOVEMENT? DROP DOWN
	...
	/*
	 * --------------- END OF WHAT IS THE LONGEST AMOUNT OF TIME THAT HAS PASSED
	 * WITHOUT YOU HAVING A BOWEL MOVEMENT? PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE USE THE BRISTOL STOOL CHART SHOWN BELOW
	 * AND SELECT THE CHOICE THAT BEST REPRESENTS WHAT TYPICAL BOWEL MOVEMENTS LOOK
	 * LIKE. PAGE ---------------
	 */

	// BRISTOL STOOL CHART SHOWN BELOW AND SELECT THE CHOICE THAT BEST REPRESENTS
	// WHAT TYPICAL BOWEL MOVEMENTS LOOK LIKE. TYPE 1 RADIO BUTTON
	...
	/*
	 * --------------- END PLEASE USE THE BRISTOL STOOL CHART SHOWN BELOW AND SELECT
	 * THE CHOICE THAT BEST REPRESENTS WHAT TYPICAL BOWEL MOVEMENTS LOOK LIKE. PAGE
	 * ---------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE INDICATE WHICH OF THE FOLLOWING
	 * PROCEDURES HAVE BEEN PERFORMED. PLEASE SELECT ALL THAT APPLY. PAGE
	 * ---------------
	 */

	// PLEASE INDICATE WHICH OF THE FOLLOWING PROCEDURES HAVE BEEN PERFORMED. PLEASE
	// SELECT ALL THAT APPLY. OTHER GI TEST (PLEASE SPECIFY) EXAM TEXT BOX
	...
	/*
	 * --------------- END OF PLEASE INDICATE WHICH OF THE FOLLOWING PROCEDURES HAVE
	 * BEEN PERFORMED. PLEASE SELECT ALL THAT APPLY. PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE PROVIDE THE INFORMATION BELOW FOR THE
	 * FIRST PROCEDURE OF EACH KIND THAT WAS PERFORMED.
	 * IN THE NEXT QUESTION, WE WILL ASK ABOUT THE MOST RECENT PROCEDURE AND ANY
	 * FINDINGS. PAGE ---------------
	 */
	...
	// DIGITAL RECTAL EXAM PLEASE SELECT THIS COLUMN IF ONLY ONE PROCEDURE HAS BEEN
	// PERFORMED RADIO BUTTON
	...
	// UPPER ENDOSCOPY PLEASE SELECT THIS COLUMN IF ONLY ONE PROCEDURE HAS BEEN
	// PERFORMED RADIO BUTTON
	...
	// COLONOSCOPY PLEASE SELECT THIS COLUMN IF ONLY ONE PROCEDURE HAS BEEN
	// PERFORMED RADIO BUTTON
	...
	// ANORECTAL MANOMETRY PLEASE SELECT THIS COLUMN IF ONLY ONE PROCEDURE HAS BEEN
	// PERFORMED RADIO BUTTON
	...
	// PH PROBE OR IMPEDANCE STUDY HOSPITAL NAME, CITY, STATE/PROVINCE, COUNTRY TEXT
	// BOX
	@FindBy(xpath = ("(//input[contains(@type,'text')])[20]"))
	public WebElement phProbeOrImpedanceStudyHospitalNameCityStateProvinceCountryTextBox;

	// PH PROBE OR IMPEDANCE STUDY PLEASE SELECT THIS COLUMN IF ONLY ONE PROCEDURE
	// HAS BEEN PERFORMED RADIO BUTTON
	...
	// UPPER GI SWALLOW STUDY PLEASE SELECT THIS COLUMN IF ONLY ONE PROCEDURE HAS
	// BEEN PERFORMED RADIO BUTTON
	...
	// MODIFIED BARIUM SWALLOW STUDY HOSPITAL NAME, CITY, STATE/PROVINCE, COUNTRY
	// TEXT BOX
	@FindBy(xpath = ("(//input[contains(@type,'text')])[28]"))
	public WebElement modifiedBariumSwallowStudyHospitalNameCityStateProvinceCountryTextBox;

	// MODIFIED BARIUM SWALLOW STUDY PLEASE SELECT THIS COLUMN IF ONLY ONE PROCEDURE
	// HAS BEEN PERFORMED RADIO BUTTON
	...
	// GASTRIC EMPTYING STUDY PLEASE SELECT THIS COLUMN IF ONLY ONE PROCEDURE HAS
	// BEEN PERFORMED RADIO BUTTON
	...
	// ANAL SEIZURES EXAM PLEASE SELECT THIS COLUMN IF ONLY ONE PROCEDURE HAS BEEN
	// PERFORMED RADIO BUTTON
	...
	/*
	 * --------------- END OF PLEASE PROVIDE THE INFORMATION BELOW FOR THE FIRST
	 * PROCEDURE OF EACH KIND THAT WAS PERFORMED.
	 * IN THE NEXT QUESTION, WE WILL ASK ABOUT THE MOST RECENT PROCEDURE AND ANY
	 * FINDINGS. PAGE ---------------
	 */
	...
	/*
	 * --------------- BEGINNING OF PLEASE PROVIDE THE INFORMATION BELOW FOR THE
	 * PULMONOLOGIST WHO COMPLETED YOUR EVALUATION. PAGE ---------------
	 */
	...
	/*
	 * ----------------- BEGINING OF PLEASE PROVIDE THE INFORMATION BELOW FOR WHERE
	 * DENTAL CARE IS RECEIVED. PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF PLEASE PROVIDE THE INFORMATION BELOW FOR WHERE
	 * DENTAL CARE IS RECEIVED. PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF WHEN DID YOU LAST VISIT A DENTIST? PLEASE USE
	 * FORMAT MONTH/YEAR AS MM/YY. PAGE -----------------
	 */

	// WHEN DID YOU LAST VISIT A DENTIST? PLEASE USE FORMAT MONTH/YEAR AS MM/YY TEXT
	// BOX
	@FindBy(xpath = "//input[@type='TEXT']")
	public WebElement whenDidYouLastVisitADentistTextBox;

	/*
	 * ----------------- END OF WHEN DID YOU LAST VISIT A DENTIST? PLEASE USE FORMAT
	 * MONTH/YEAR AS MM/YY. PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF WHAT WAS THE REASON FOR YOUR LAST DENTAL VISIT?
	 * PAGE -----------------
	 */
	...
	/*
	 * ----------------- BEGINING OF OVERALL, HOW WOULD YOU RATE THE OVERALL HEALTH
	 * OF YOUR TEETH AND GUMS? PAGE -----------------
	 */

	// OVERALL, HOW WOULD YOU RATE THE OVERALL HEALTH OF YOUR TEETH AND GUMS? FAIR
	// RADIO BUTTON
	@FindBy(xpath = "(//label[contains(@for,'QR~QID176~3')])[2]")
	public WebElement overallHealthOfTeethAndGumsFairRadioButton;

	/*
	 * ----------------- END OF OVERALL, HOW WOULD YOU RATE THE OVERALL HEALTH OF
	 * YOUR TEETH AND GUMS? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF Overall, how would you rate your dental hygiene
	 * routine (regular tooth brushing, flossing, and your home oral mouth rinse)?
	 * PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF OVERALL, HOW WOULD YOU RATE YOUR DENTAL HYGIENE
	 * ROUTINE (REGULAR TOOTH BRUSHING, FLOSSING, AND YOUR HOME ORAL MOUTH RINSE)?
	 * PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF DID THE FACIAL OR DENTAL TRAUMA REQUIRE
	 * SURGERY? PAGE -----------------
	 */

	// DID THE FACIAL OR DENTAL TRAUMA REQUIRE SURGERY? YES (PLEASE SPECIFY)RADIO
	// BUTTON
	@FindBy(xpath = "(//label[contains(@for,'QR~QID185~1')])[2]")
	public WebElement didTheFacialOrDentalTraumaRequireSurgeryYesRadioButton;

	/*
	 * ----------------- END OF DID THE FACIAL OR DENTAL TRAUMA REQUIRE SURGERY?
	 * PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF DO YOU HAVE A HISTORY OF CANCER IN THE MOUTH OR
	 * JAW?
	 * SOME EXAMPLES INCLUDE LYMPHOMA, MINOR SALIVARY GLAND, MUCOSAL MELANOMA,
	 * SARCOMA, OR SQUAMOUS CELL CARCINOMA PAGE -----------------
	 */

	// DO YOU HAVE A HISTORY OF CANCER IN THE MOUTH OR JAW? SOME EXAMPLES... YES
	// RADIO BUTTON
	...
	/*
	 * ----------------- BEGINING OF DO YOU HAVE A FAMILY MEMBER WITH A JAW
	 * ABNORMALITY? PAGE -----------------
	 */

	// DO YOU HAVE A FAMILY MEMBER WITH A JAW ABNORMALITY? YES (PLEASE SPECIFY)
	// RADIO BUTTON
	@FindBy(xpath = "(//label[contains(@for,'QR~QID190~1')])[2]")
	public WebElement doYouHaveAFamilyMemberWithJawAbnormalityYesRadioButton;

	/*
	 * ----------------- END OF DO YOU HAVE A FAMILY MEMBER WITH A JAW ABNORMALITY?
	 * PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF OVERALL -- IS THERE ANYTHING UNUSUAL ABOUT YOUR
	 * TEETH OR MOUTH
	 * (EXTRA TEETH, MISSING TEETH, SEVERE DENTAL DISEASES, JAWBONE PROBLEMS, ENAMEL
	 * PROBLEMS, ETC.)? PAGE -----------------
	 */

	// OVERALL -- IS THERE ANYTHING UNUSUAL ABOUT YOUR TEETH OR MOUTH...? YES
	// (PLEASE SPECIFY)RADIO BUTTON
	...
	/*
	 * ----------------- END OF OVERALL -- IS THERE ANYTHING UNUSUAL ABOUT YOUR
	 * TEETH OR MOUTH
	 * (EXTRA TEETH, MISSING TEETH, SEVERE DENTAL DISEASES, JAWBONE PROBLEMS, ENAMEL
	 * PROBLEMS, ETC.)? PAGE -----------------
	 */
	...
	/*
	 * ----------------- BEGINING OF HAVE YOU HAD TROUBLE PRONOUNCING ANY WORDS
	 * BECAUSE OF PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE
	 * -----------------
	 */

	// HAVE YOU HAD TROUBLE PRONOUNCING ANY WORDS BECAUSE OF PROBLEMS WITH YOUR
	// TEETH, MOUTH OR DENTURES? OCCASIONALLY RADIO BUTTON
	...
	/*
	 * ----------------- END OF HAVE YOU HAD TROUBLE PRONOUNCING ANY WORDS BECAUSE
	 * OF PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF HAVE YOU FELT THAT YOUR SENSE OF TASTE HAS
	 * WORSENED BECAUSE OF PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE
	 * -----------------
	 */

	// HAVE YOU FELT THAT YOUR SENSE OF TASTE HAS WORSENED BECAUSE OF PROBLEMS WITH
	// YOUR TEETH, MOUTH OR DENTURES? OCCASIONALLY RADIO BUTTON
	...
	/*
	 * ----------------- END OF HAVE YOU FELT THAT YOUR SENSE OF TASTE HAS WORSENED
	 * BECAUSE OF PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE
	 * -----------------
	 */
	...
	/*
	 * ----------------- BEGINING OF HAVE YOU FOUND IT UNCOMFORTABLE TO EAT ANY
	 * FOODS BECAUSE OF PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE
	 * -----------------
	 */
	...
	/*
	 * ----------------- END OF HAVE YOU FOUND IT UNCOMFORTABLE TO EAT ANY FOODS
	 * BECAUSE OF PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE
	 * -----------------
	 */

	/*
	 * ----------------- BEGINING OF ARE YOU SELF-CONSCIOUS BECAUSE OF YOUR TEETH,
	 * MOUTH OR DENTURES? PAGE -----------------
	 */

	// ARE YOU SELF-CONSCIOUS BECAUSE OF YOUR TEETH, MOUTH OR DENTURES? OCCASIONALLY
	// RADIO BUTTON
	...
	/*
	 * ----------------- END OF ARE YOU SELF-CONSCIOUS BECAUSE OF YOUR TEETH, MOUTH
	 * OR DENTURES? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF HAVE YOU FELT TENSE BECAUSE OF PROBLEMS WITH
	 * YOUR TEETH, MOUTH OR DENTURES? PAGE -----------------
	 */

	// HAVE YOU FELT TENSE BECAUSE OF PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES?
	// OCCASIONALLY RADIO BUTTON
	...
	/*
	 * ----------------- END OF HAVE YOU FELT TENSE BECAUSE OF PROBLEMS WITH YOUR
	 * TEETH, MOUTH OR DENTURES? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF HAS YOUR DIET BEEN UNSATISFACTORY BECAUSE OF
	 * PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE -----------------
	 */

	// HAS YOUR DIET BEEN UNSATISFACTORY BECAUSE OF PROBLEMS WITH YOUR TEETH, MOUTH
	// OR DENTURES? OCCASIONALLY RADIO BUTTON
	...
	/*
	 * ----------------- END OF HAS YOUR DIET BEEN UNSATISFACTORY BECAUSE OF
	 * PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF HAVE YOU HAD TO INTERRUPT MEALS BECAUSE OF
	 * PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE -----------------
	 */

	// HAVE YOU HAD TO INTERRUPT MEALS BECAUSE OF PROBLEMS WITH YOUR TEETH, MOUTH OR
	// DENTURES? OCCASIONALLY RADIO BUTTON
	...
	/*
	 * ----------------- END OF HAVE YOU HAD TO INTERRUPT MEALS BECAUSE OF PROBLEMS
	 * WITH YOUR TEETH, MOUTH OR DENTURES? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF HAVE YOU FOUND IT DIFFICULT TO RELAX BECAUSE OF
	 * PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE -----------------
	 */

	// HAVE YOU FOUND IT DIFFICULT TO RELAX BECAUSE OF PROBLEMS WITH YOUR TEETH,
	// MOUTH OR DENTURES? OCCASIONALLY RADIO BUTTON
	...
	/*
	 * ----------------- END OF HAVE YOU FOUND IT DIFFICULT TO RELAX BECAUSE OF
	 * PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF HAVE YOU BEEN A BIT EMBARRASSED BECAUSE OF
	 * PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF HAVE YOU BEEN A BIT EMBARRASSED BECAUSE OF PROBLEMS
	 * WITH YOUR TEETH, MOUTH OR DENTURES? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF HAVE YOU BEEN IRRITABLE WITH OTHER PEOPLE
	 * BECAUSE OF PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE
	 * -----------------
	 */

	// HAVE YOU BEEN IRRITABLE WITH OTHER PEOPLE BECAUSE OF PROBLEMS WITH YOUR
	// TEETH, MOUTH OR DENTURES? OCCASIONALLY RADIO BUTTON
	...
	/*
	 * ----------------- END OF HAVE YOU BEEN IRRITABLE WITH OTHER PEOPLE BECAUSE OF
	 * PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF HAVE YOU HAD DIFFICULTY DOING YOUR USUAL JOBS
	 * BECAUSE OF PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE
	 * -----------------
	 */
	...
	/*
	 * ----------------- END OF HAVE YOU HAD DIFFICULTY DOING YOUR USUAL JOBS
	 * BECAUSE OF PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE
	 * -----------------
	 */

	/*
	 * ----------------- BEGINING OF HAVE YOU FELT THAT LIFE IN GENERAL IS LESS
	 * SATISFYING BECAUSE OF PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE
	 * -----------------
	 */

	// HAVE YOU FELT THAT LIFE IN GENERAL IS LESS SATISFYING BECAUSE OF PROBLEMS
	// WITH YOUR TEETH, MOUTH OR DENTURES? OCCASIONALLY RADIO BUTTON
	...
	/*
	 * ----------------- END OF HAVE YOU FELT THAT LIFE IN GENERAL IS LESS
	 * SATISFYING BECAUSE OF PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE
	 * -----------------
	 */

	/*
	 * ----------------- BEGINING OF HAVE YOU BEEN TOTALLY UNABLE TO FUNCTION
	 * BECAUSE OF PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE
	 * -----------------
	 */
	...
	/*
	 * ----------------- END OF HAVE YOU BEEN TOTALLY UNABLE TO FUNCTION BECAUSE OF
	 * PROBLEMS WITH YOUR TEETH, MOUTH OR DENTURES? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF PLEASE COMPLETE THE TABLE BELOW TO THE BEST OF
	 * YOUR ABILITY ABOUT THE ONSET OF SYMPTOMS,
	 * WHEN YOU WERE DIAGNOSED AND IF ANY PROCEDURES OR MEDICATIONS WERE UNDERTAKEN.
	 * PAGE -----------------
	 */

	// NEONATAL LYMPHEDEMA (LYMPH BUILD UP TYPICALLY IN THE ARMS AND LEGS. THIS
	// OCCURS IN THE FIRST MONTH OF LIFE) DATE OF FIRST SYMPTOMS TEXT BOX
	@FindBy(xpath = "//tbody/tr[1]/td[3]/input[1]")
	public WebElement neonatalLymphedemaDateOfFirstSymptomsTextBox;

	// NEONATAL LYMPHEDEMA (LYMPH BUILD UP TYPICALLY IN THE ARMS AND LEGS. THIS
	// OCCURS IN THE FIRST MONTH OF LIFE) AGE OF FIRST SYMPTOMS TEXT BOX
	@FindBy(xpath = "//tbody/tr[1]/td[4]/input[1]")
	public WebElement neonatalLymphedemaAgeOfFirstSymptomsTextBox;

	// NEONATAL LYMPHEDEMA (LYMPH BUILD UP TYPICALLY IN THE ARMS AND LEGS. THIS
	// OCCURS IN THE FIRST MONTH OF LIFE) DATE OF DIAGNOSIS TEXT BOX
	@FindBy(xpath = "//tbody/tr[1]/td[8]/input[1]")
	public WebElement neonatalLymphedemaDateOfDiagnosisTextBox;

	// NEONATAL LYMPHEDEMA (LYMPH BUILD UP TYPICALLY IN THE ARMS AND LEGS. THIS
	// OCCURS IN THE FIRST MONTH OF LIFE) AGE OF DIAGNOSIS TEXT BOX
	@FindBy(xpath = "//tbody/tr[1]/td[9]/input[1]")
	public WebElement neonatalLymphedemaAgeOfDiagnosisTextBox;

	// NEONATAL LYMPHEDEMA (LYMPH BUILD UP TYPICALLY IN THE ARMS AND LEGS. THIS
	// OCCURS IN THE FIRST MONTH OF LIFE) MEDICATION TYPE OR PROCEDURE TEXT BOX
	@FindBy(xpath = "//tbody/tr[1]/td[13]/input[1]")
	public WebElement neonatalLymphedemaMedicationOrProcedureTextBox;

	// NEONATAL LYMPHEDEMA (LYMPH BUILD UP TYPICALLY IN THE ARMS AND LEGS. THIS
	// OCCURS IN THE FIRST MONTH OF LIFE) NAME OF TREATING HOSPITAL OR PHYSICIAN AND
	// ADDRESS OF HOSPITAL TEXT BOX
	@FindBy(xpath = "//tbody/tr[1]/td[16]/input[1]")
	public WebElement neonatalLymphedemaNameOfTreatingHospitalOrPhysicianAndAddressOfHospitalTextBox;

	// LYMPHEDEMA (LYMPH FLUID BUILDS UP AND CAUSES SWELLING IN THE ARMS AND LEGS.
	// THIS OCCURS AFTER ONE MONTH OF AGE) DATE OF FIRST SYMPTOMS TEXT BOX
	@FindBy(xpath = "//tbody/tr[2]/td[3]/input[1]")
	public WebElement lymphedemaDateOfFirstSymptomsTextBox;

	// LYMPHEDEMA (LYMPH FLUID BUILDS UP AND CAUSES SWELLING IN THE ARMS AND LEGS.
	// THIS OCCURS AFTER ONE MONTH OF AGE) AGE OF FIRST SYMPTOMS TEXT BOX
	@FindBy(xpath = "//tbody/tr[2]/td[4]/input[1]")
	public WebElement lymphedemaAgeOfFirstSymptomsTextBox;

	// LYMPHEDEMA (LYMPH FLUID BUILDS UP AND CAUSES SWELLING IN THE ARMS AND LEGS.
	// THIS OCCURS AFTER ONE MONTH OF AGE) DATE OF DIAGNOSIS TEXT BOX
	@FindBy(xpath = "//tbody/tr[2]/td[8]/input[1]")
	public WebElement lymphedemaDateOfDiagnosisTextBox;

	// LYMPHEDEMA (LYMPH FLUID BUILDS UP AND CAUSES SWELLING IN THE ARMS AND LEGS.
	// THIS OCCURS AFTER ONE MONTH OF AGE) AGE OF DIAGNOSIS TEXT BOX
	@FindBy(xpath = "//tbody/tr[2]/td[9]/input[1]")
	public WebElement lymphedemaAgeOfDiagnosisTextBox;

	// LYMPHEDEMA (LYMPH FLUID BUILDS UP AND CAUSES SWELLING IN THE ARMS AND LEGS.
	// THIS OCCURS AFTER ONE MONTH OF AGE) MEDICATION TYPE OR PROCEDURE TEXT BOX
	@FindBy(xpath = "//tbody/tr[2]/td[13]/input[1]")
	public WebElement lymphedemaMedicationOrProcedureTextBox;

	// LYMPHEDEMA (LYMPH FLUID BUILDS UP AND CAUSES SWELLING IN THE ARMS AND LEGS.
	// THIS OCCURS AFTER ONE MONTH OF AGE) NAME OF TREATING HOSPITAL OR PHYSICIAN
	// AND ADDRESS OF HOSPITAL TEXT BOX
	@FindBy(xpath = "//tbody/tr[2]/td[16]/input[1]")
	public WebElement lymphedemaNameOfTreatingHospitalOrPhysicianAndAddressOfHospitalTextBox;

	// CONGENITAL CHYLOTHORAX (LYMPH FLUID BUILDS UP IN THE LUNG; DIAGNOSED WITHIN
	// THE FIRST MONTH OF LIFE) DATE OF FIRST SYMPTOMS TEXT BOX
	@FindBy(xpath = "//tbody/tr[3]/td[3]/input[1]")
	public WebElement congenitalChylothoraxDateOfFirstSymptomsTextBox;

	// CONGENITAL CHYLOTHORAX (LYMPH FLUID BUILDS UP IN THE LUNG; DIAGNOSED WITHIN
	// THE FIRST MONTH OF LIFE) AGE OF FIRST SYMPTOMS TEXT BOX
	@FindBy(xpath = "//tbody/tr[3]/td[4]/input[1]")
	public WebElement congenitalChylothoraxAgeOfFirstSymptomsTextBox;

	// CONGENITAL CHYLOTHORAX (LYMPH FLUID BUILDS UP IN THE LUNG; DIAGNOSED WITHIN
	// THE FIRST MONTH OF LIFE) DATE OF DIAGNOSIS TEXT BOX
	@FindBy(xpath = "//tbody/tr[3]/td[8]/input[1]")
	public WebElement congenitalChylothoraxDateOfDiagnosisTextBox;

	// CONGENITAL CHYLOTHORAX (LYMPH FLUID BUILDS UP IN THE LUNG; DIAGNOSED WITHIN
	// THE FIRST MONTH OF LIFE) AGE OF DIAGNOSIS TEXT BOX
	@FindBy(xpath = "//tbody/tr[3]/td[9]/input[1]")
	public WebElement congenitalChylothoraxAgeOfDiagnosisTextBox;

	// CONGENITAL CHYLOTHORAX (LYMPH FLUID BUILDS UP IN THE LUNG; DIAGNOSED WITHIN
	// THE FIRST MONTH OF LIFE) MEDICATION TYPE OR PROCEDURE TEXT BOX
	@FindBy(xpath = "//tbody/tr[3]/td[13]/input[1]")
	public WebElement congenitalChylothoraxMedicationOrProcedureTextBox;

	// CONGENITAL CHYLOTHORAX (LYMPH FLUID BUILDS UP IN THE LUNG; DIAGNOSED WITHIN
	// THE FIRST MONTH OF LIFE) NAME OF TREATING HOSPITAL OR PHYSICIAN AND ADDRESS
	// OF HOSPITAL TEXT BOX
	@FindBy(xpath = "//tbody/tr[3]/td[16]/input[1]")
	public WebElement congenitalChylothoraxNameOfTreatingHospitalOrPhysicianAndAddressOfHospitalTextBox;

	// PLEURAL EFFUSION/CHYLOTHORAX (LYMPH FLUID BUILDS UP IN THE LUNG; DIAGNOSED
	// AFTER ONE MONTH OF AGE) DATE OF FIRST SYMPTOMS TEXT BOX
	@FindBy(xpath = "//tbody/tr[4]/td[3]/input[1]")
	public WebElement pleuralEffusionChylothoraxDateOfFirstSymptomsTextBox;

	// PLEURAL EFFUSION/CHYLOTHORAX (LYMPH FLUID BUILDS UP IN THE LUNG; DIAGNOSED
	// AFTER ONE MONTH OF AGE) AGE OF FIRST SYMPTOMS TEXT BOX
	@FindBy(xpath = "//tbody/tr[4]/td[4]/input[1]")
	public WebElement pleuralEffusionChylothoraxAgeOfFirstSymptomsTextBox;

	// PLEURAL EFFUSION/CHYLOTHORAX (LYMPH FLUID BUILDS UP IN THE LUNG; DIAGNOSED
	// AFTER ONE MONTH OF AGE) DATE OF DIAGNOSIS TEXT BOX
	@FindBy(xpath = "//tbody/tr[4]/td[8]/input[1]")
	public WebElement pleuralEffusionChylothoraxDateOfDiagnosisTextBox;

	// PLEURAL EFFUSION/CHYLOTHORAX (LYMPH FLUID BUILDS UP IN THE LUNG; DIAGNOSED
	// AFTER ONE MONTH OF AGE) AGE OF DIAGNOSIS TEXT BOX
	@FindBy(xpath = "//tbody/tr[4]/td[9]/input[1]")
	public WebElement pleuralEffusionChylothoraxAgeOfDiagnosisTextBox;

	// PLEURAL EFFUSION/CHYLOTHORAX (LYMPH FLUID BUILDS UP IN THE LUNG; DIAGNOSED
	// AFTER ONE MONTH OF AGE) MEDICATION TYPE OR PROCEDURE TEXT BOX
	@FindBy(xpath = "//tbody/tr[4]/td[13]/input[1]")
	public WebElement pleuralEffusionChylothoraxMedicationOrProcedureTextBox;

	// PLEURAL EFFUSION/CHYLOTHORAX (LYMPH FLUID BUILDS UP IN THE LUNG; DIAGNOSED
	// AFTER ONE MONTH OF AGE) NAME OF TREATING HOSPITAL OR PHYSICIAN AND ADDRESS OF
	// HOSPITAL TEXT BOX
	@FindBy(xpath = "//tbody/tr[4]/td[16]/input[1]")
	public WebElement pleuralEffusionChylothoraxNameOfTreatingHospitalOrPhysicianAndAddressOfHospitalTextBox;

	// LYMPHANGIOMA (LYMPH FLUID UNDER THE SKIN THAT APPEARS AS A SWELLING, MASS, OR
	// CYST; MOST OFTEN OCCURS IN THE HEAD, NECK OR BREAST AREA DATE OF FIRST
	// SYMPTOMS TEXT BOX
	@FindBy(xpath = "//tbody/tr[5]/td[3]/input[1]")
	public WebElement lymphangiomaDateOfFirstSymptomsTextBox;

	// LYMPHANGIOMA (LYMPH FLUID UNDER THE SKIN THAT APPEARS AS A SWELLING, MASS, OR
	// CYST; MOST OFTEN OCCURS IN THE HEAD, NECK OR BREAST AREA AGE OF FIRST
	// SYMPTOMS TEXT BOX
	@FindBy(xpath = "//tbody/tr[5]/td[4]/input[1]")
	public WebElement lymphangiomaAgeOfFirstSymptomsTextBox;

	// LYMPHANGIOMA (LYMPH FLUID UNDER THE SKIN THAT APPEARS AS A SWELLING, MASS, OR
	// CYST; MOST OFTEN OCCURS IN THE HEAD, NECK OR BREAST AREA DATE OF DIAGNOSIS
	// TEXT BOX
	@FindBy(xpath = "//tbody/tr[5]/td[8]/input[1]")
	public WebElement lymphangiomaDateOfDiagnosisTextBox;

	// LYMPHANGIOMA (LYMPH FLUID UNDER THE SKIN THAT APPEARS AS A SWELLING, MASS, OR
	// CYST; MOST OFTEN OCCURS IN THE HEAD, NECK OR BREAST AREA AGE OF DIAGNOSIS
	// TEXT BOX
	@FindBy(xpath = "//tbody/tr[5]/td[9]/input[1]")
	public WebElement lymphangiomaAgeOfDiagnosisTextBox;

	// LYMPHANGIOMA (LYMPH FLUID UNDER THE SKIN THAT APPEARS AS A SWELLING, MASS, OR
	// CYST; MOST OFTEN OCCURS IN THE HEAD, NECK OR BREAST AREA MEDICATION TYPE OR
	// PROCEDURE TEXT BOX
	@FindBy(xpath = "//tbody/tr[5]/td[13]/input[1]")
	public WebElement lymphangiomaMedicationOrProcedureTextBox;

	// LYMPHANGIOMA (LYMPH FLUID UNDER THE SKIN THAT APPEARS AS A SWELLING, MASS, OR
	// CYST; MOST OFTEN OCCURS IN THE HEAD, NECK OR BREAST AREA NAME OF TREATING
	// HOSPITAL OR PHYSICIAN AND ADDRESS OF HOSPITAL TEXT BOX
	...
	// CHRONIC ABDOMINAL PAIN NAME OF TREATING HOSPITAL OR PHYSICIAN AND ADDRESS OF
	// HOSPITAL TEXT BOX
	...
	// POOR LYMPHATIC DRAINAGE NAME OF TREATING HOSPITAL OR PHYSICIAN AND ADDRESS OF
	// HOSPITAL TEXT BOX
	 ...
	 * ABILITY ABOUT THE ONSET OF SYMPTOMS,
	 * WHEN YOU WERE DIAGNOSED AND IF ANY PROCEDURES OR MEDICATIONS WERE UNDERTAKEN.
	 * PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF PLEASE LIST THE INFORMATION BELOW FOR THE
	 * NEPHROLOGIST WHO COMPLETED YOUR EVALUATION. PAGE -----------------
	 */

	// PLEASE LIST THE INFORMATION BELOW FOR THE NEPHROLOGIST WHO COMPLETED YOUR
	// EVALUATION. NAME OF DOCTOR TEXT BOX
	@FindBy(xpath = "//tbody/tr[1]/td[2]/input[1]")
	public WebElement informationForNephrologistNameOfDoctorTextBox;

	// PLEASE LIST THE INFORMATION BELOW FOR THE NEPHROLOGIST WHO COMPLETED YOUR
	// EVALUATION. CITY, STATE TEXT BOX
	@FindBy(xpath = "//tbody/tr[2]/td[2]/input[1]")
	public WebElement informationForNephrologistCityStateTextBox;

	// PLEASE LIST THE INFORMATION BELOW FOR THE NEPHROLOGIST WHO COMPLETED YOUR
	// EVALUATION. HOSPITAL OR MEDICAL AFFILIATION TEXT BOX
	@FindBy(xpath = "//tbody/tr[3]/td[2]/input[1]")
	public WebElement informationForANephrologistHospitalOrMedicalAffiliationTextBox;

	/*
	 * ----------------- END OF PLEASE LIST THE INFORMATION BELOW FOR THE
	 * NEPHROLOGIST WHO COMPLETED YOUR EVALUATION. PAGE -----------------
	 */

	/*
	 * ----------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW TO THE BEST OF
	 * YOUR ABILITY REGARDING DATE OF ONSET OF SYMPTOMS, DIAGNOSIS AND IF ANY
	 * MEDICATIONS OR PROCEDURES WERE UNDERTAKEN. IF YOU DO NOT RECALL THE DETAILS
	 * FOR EACH CONDITION LISTED, PLEASE PLACE AN 'X' IN THE BOX. PAGE
	 * -----------------
	 */
	...
	// PLEASE PROVIDE ADDRESS OF HOSPITAL OR OFFICE (NAME CITY, STATE/PROVINCE,
	// COUNTRY)
	@FindBy(xpath = "//tbody/tr[1]/td[16]/input[1]")
	...
	/*
	 * ----------------- BEGINING OF DO YOU HAVE ANY HEMANGIOMAS? HEMANGIOMAS ARE
	 * BRIGHT RED MARKS ON THE SKIN MADE UP OF BLOOD VESSELS, WHICH MAY APPEAR AS A
	 * MASS OR LUMP. A HEMANGIOMA MAY APPEAR IN INFANCY OR CHILDHOOD AND FADE OVER
	 * TIME. PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF DO YOU HAVE ANY HEMANGIOMAS? HEMANGIOMAS ARE BRIGHT
	 * RED MARKS ON THE SKIN MADE UP OF BLOOD VESSELS, WHICH MAY APPEAR AS A MASS OR
	 * LUMP. A HEMANGIOMA MAY APPEAR IN INFANCY OR CHILDHOOD AND FADE OVER TIME.
	 * PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF PLEASE COMPLETE THE TABLE BELOW FOR EACH OF THE
	 * JOINT ISSUES LISTED. FOR EACH CONDITION, PLEASE INCLUDE THE DATE OR AGE WHEN
	 * SYMPTOMS FIRST OCCURRED AND DATE OR AGE AT DIAGNOSIS (YOU DO NOT NEED TO
	 * INCLUDE BOTH THE DATE AND AGE). IF YOU DO NOT RECALL THE DETAILS, PLEASE
	 * PLACE AN 'X' IN THE COLUMN 'DON'T KNOW.' IF NO TREATMENT WAS REQUIRED, PLEASE
	 * PUT 'NONE' IN THE 'TREATMENT' COLUMN. PAGE -----------------
	 */
	...
	/*
	 * ----------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW FOR EACH OF
	 * THE BLEEDING/BRUISING ISSUES LISTED. FOR EACH CONDITION, PLEASE PROVIDE YOUR
	 * AGE OR DATE WHEN SYMPTOMS FIRST STARTED AND AT DIAGNOSIS (YOU ONLY NEED TO
	 * PROVIDE DATE OR AGE, BUT NOT BOTH). IF YOU DO NOT RECALL THE DETAILS, PLEASE
	 * PLACE AN 'X' IN THE 'DON'T KNOW' COLUMN. IF NO TREATMENT WAS REQUIRED, PLEASE
	 * WRITE 'NONE' IN THE TREATMENT COLUMN. PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF PLEASE COMPLETE THE TABLE BELOW FOR EACH OF THE
	 * BLEEDING/BRUISING ISSUES LISTED. FOR EACH CONDITION, PLEASE PROVIDE YOUR AGE
	 * OR DATE WHEN SYMPTOMS FIRST STARTED AND AT DIAGNOSIS (YOU ONLY NEED TO
	 * PROVIDE DATE OR AGE, BUT NOT BOTH). IF YOU DO NOT RECALL THE DETAILS, PLEASE
	 * PLACE AN 'X' IN THE 'DON'T KNOW' COLUMN. IF NO TREATMENT WAS REQUIRED, PLEASE
	 * WRITE 'NONE' IN THE TREATMENT COLUMN. PAGE -----------------
	 */
	...
	/*
	 * ----------------- BEGINNING OF Have you ever been diagnosed with any of the
	 * following blood disorders or symptoms of blood disorders? Please select all
	 * that apply. STEPS PAGE-----------------
	 */
	...
	/*
	 * ----------------- END OF Have you ever been diagnosed with any of the
	 * following blood disorders or symptoms of blood disorders? Please select all
	 * that apply. STEPS PAGE-----------------
	 */
	 ...
	 * BLOOD DISORDERS ISSUES LISTED. FOR EACH CONDITION LISTED, PLEASE INCLUDE
	 * EITHER YOUR AGE OR DATE OF SYMPTOMS AND DIAGNOSIS (YOU DO NOT NEED TO INCLUDE
	 * BOTH DATE AND AGE). IF YOU DO NOT RECALL THE DETAILS, PLEASE PLACE AN 'X' IN
	 * THE COLUMN 'DON'T KNOW'. IF NO TREATMENT WAS REQUIRED, PLEASE WRITE 'NONE' IN
	...
	// PLEASE PROVIDE ADDRESS OF HOSPITAL OR OFFICE (NAME CITY, STATE/PROVINCE,
	// COUNTRY WHERE EVALUATION WAS COMPLETED) TEXT BOX
	@FindBy(xpath = "//tbody/tr[1]/td[16]/input[1]")
	 ...
	 * BOTH DATE AND AGE). IF YOU DO NOT RECALL THE DETAILS, PLEASE PLACE AN 'X' IN
	 * THE COLUMN 'DON'T KNOW'. IF NO TREATMENT WAS REQUIRED, PLEASE WRITE 'NONE' IN
	 * THE 'TREATMENT' COLUMN. STEPS PAGE -----------------
	 */

	/*
	 * ----------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW FOR EACH OF
	 * THE TUMORS LISTED. PLEASE INCLUDE YOUR AGE OR DATE WHEN SYMPTOMS FIRST
	 * STARTED AND DIAGNOSIS (YOU DO NOT NEED TO INCLUDE BOTH AGE AND DATE). IF YOU
	 * DO NOT RECALL THE DETAILS, PLEASE PLACE AN 'X' UNDER THE 'DON'T KNOW' COLUMN.
	 * PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF PLEASE COMPLETE THE TABLE BELOW FOR EACH OF THE
	 * TUMORS LISTED. PLEASE INCLUDE YOUR AGE OR DATE WHEN SYMPTOMS FIRST
	 * STARTED AND DIAGNOSIS (YOU DO NOT NEED TO INCLUDE BOTH AGE AND DATE). IF YOU
	 * DO NOT RECALL THE DETAILS, PLEASE PLACE AN 'X' UNDER THE 'DON'T KNOW' COLUMN.
	 * PAGE -----------------
	 */
	...
	/*
	 * ----------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW FOR EACH OF
	 * THE IMMUNODEFICIENCIES LISTED. FOR EACH, PLEASE PROVIDE THE DATE OR AGE AT
	 * WHICH SYMPTOMS OCCURRED AND DIAGNOSIS (YOU DO NOT NEED TO INCLUDE BOTH AGE
	 * AND DATE). IF YOU DO NOT RECALL DETAILS, PLEASE PLACE AN 'X' IN THE 'DON'T
	 * KNOW' COLUMN. IF NO TREATMENT HAS BEEN REQUIRED, PLACE 'NONE' IN
	 * THE'TREATMENT' COLUMN. PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF PLEASE COMPLETE THE TABLE BELOW FOR EACH OF THE
	 * IMMUNODEFICIENCIES LISTED. FOR EACH, PLEASE PROVIDE THE DATE OR AGE AT
	 * WHICH SYMPTOMS OCCURRED AND DIAGNOSIS (YOU DO NOT NEED TO INCLUDE BOTH AGE
	 * AND DATE). IF YOU DO NOT RECALL DETAILS, PLEASE PLACE AN 'X' IN THE 'DON'T
	 * KNOW' COLUMN. IF NO TREATMENT HAS BEEN REQUIRED, PLACE 'NONE' IN
	 * THE'TREATMENT' COLUMN. PAGE -----------------
	...
	/*
	 * ----------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW FOR EACH OF
	 * THE AUTOIMMUNE CONDITIONS LISTED BELOW. PLEASE PROVIDE THE DATE OR AGE WHEN
	 * SYMPTOMS FIRST OCCURRED AND DIAGNOSIS (YOU DO NOT NEED TO INCLUDE BOTH AGE
	 * AND DATE). IF YOU DO NOT RECALL THE DETAILS, PLEASE PLACE AN 'X' IN THE
	 * 'DON'T KNOW' BOX. IF NO TREATMENT WAS REQUIRED, PLEASE STATE 'NONE' IN THE
	 * 'TREATMENT' COLUMN. PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF PLEASE COMPLETE THE TABLE BELOW FOR EACH OF THE
	 * AUTOIMMUNE CONDITIONS LISTED BELOW. PLEASE PROVIDE THE DATE OR AGE WHEN
	 * SYMPTOMS FIRST OCCURRED AND DIAGNOSIS (YOU DO NOT NEED TO INCLUDE BOTH AGE
	 * AND DATE). IF YOU DO NOT RECALL THE DETAILS, PLEASE PLACE AN 'X' IN THE
	 * 'DON'T KNOW' BOX. IF NO TREATMENT WAS REQUIRED, PLEASE STATE 'NONE' IN THE
	 * 'TREATMENT' COLUMN. PAGE -----------------
	...
	/*
	 * ----------------- BEGINNING OF PLEASE PROVIDE THE INFORMATION FOR THE
	 * NEUROLOGIST OR NEUROSURGEON WHO COMPLETED YOUR EVALUATION. PAGE
	 * -----------------
	 */
	...
	/*
	 * ----------------- END OF PLEASE PROVIDE THE INFORMATION FOR THE NEUROLOGIST
	 * OR NEUROSURGEON WHO COMPLETED YOUR EVALUATION. PAGE -----------------
	 */

	/*
	 * ----------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW FOR EACH OF
	 * THE CONDITIONS LISTED. FOR EACH CONDITION, PLEASE LIST EITHER THE DATE OR AGE
	...
	/*
	 * ----------------- END OF PLEASE COMPLETE THE TABLE BELOW FOR EACH OF THE
	 * CONDITIONS LISTED. FOR EACH CONDITION, PLEASE INCLUDE THE AGE OR DATE WHEN
	 * SYMPTOMS OCCURRED AND WHEN DIAGNOSED (YOU DO NOT NEED TO INCLUDE BOTH AGE AND
	 * DATE). IF YOU DO NOT RECALL, PLEASE PLACE AN 'X' IN THE 'DON'T KNOW' BOX.
	 * PAGE -----------------
	 */

	/*
	 * ----------------- BEGINNING OF HAVE YOU EVER BEEN EVALUATED BY A
	 * PSYCHIATRIST, PSYCHOLOGIST OR BEHAVIORAL PEDIATRICIAN? THESE MEDICAL
	 * PROVIDERS OFTEN DIAGNOSE CONDITIONS SUCH AS DEPRESSION, ANXIETY, LEARNING
	 * DIFFICULTIES, AND DEVELOPMENTAL DISORDERS. PAGE ----------------
	 */
	...
	/*
	 * ----------------- END OF HAVE YOU EVER BEEN EVALUATED BY A PSYCHIATRIST,
	 * PSYCHOLOGIST OR BEHAVIORAL PEDIATRICIAN? THESE MEDICAL PROVIDERS OFTEN
	 * DIAGNOSE CONDITIONS SUCH AS DEPRESSION, ANXIETY, LEARNING DIFFICULTIES, AND
	 * DEVELOPMENTAL DISORDERS. PAGE -----------------
	 */

	/*
	 * ----------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW FOR EACH OF
	 * THE DIAGNOSED BEHAVIORAL AND/OR PSYCHIATRIC CONDITIONS LISTED. FOR EACH
	 * CONDITION, PLEASE LIST THE DATE OR AGE OF SYMPTOM ONSET AND DIAGNOSIS (YOU DO
	 * NOT NEED TO INCLUDE BOTH AGE AND DATE). IF YOU DO NOT RECALL, PLEASE PLACE AN
	 * 'X' IN THE 'DON'T KNOW' BOX. IF NO TREATMENT WAS REQUIRED, PLACE 'NONE' IN
	 * THE 'TREATMENT' COLUMN. PAGE -----------------
	 */
	...
	/*
	 * ----------------- BEGINING OF PLEASE LIST AND DESCRIBE ANY ADDITIONAL
	 * NEUROLOGIC CONDITIONS HERE THAT WERE NOT COVERED BY THE PREVIOUS QUESTIONS.
	 * PAGE -----------------
	 */
	 ...
	 * STRABISMUS. PLEASE LIST THE AGE OR DATE WHEN SYMPTOMS FIRST STARTED AND WHEN
	 * THE DIAGNOSIS WAS MADE (YOU DO NOT NEED TO INCLUDE BOTH DATE AND AGE). IF YOU
	 * DO NOT RECALL, PLACE AN 'X' IN THE 'DON'T KNOW' COLUMN. IF NO TREATMENT WAS
	...
	/*
	 * ----------------- BEGINING OF PLEASE COMPLETE THE TABLE BELOW REGARDING
	 * NYSTAGMUS. PLEASE INCLUDE THE AGE OR DATE WHEN SYMPTOMS FIRST OCCURRED AND
	 * WHEN THE DIAGNOSIS WAS MADE (YOU DO NOT NEED TO INCLUDE BOTH AGE AND DATE).
	 * PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF PLEASE COMPLETE THE TABLE BELOW REGARDING NYSTAGMUS.
	 * PLEASE INCLUDE THE AGE OR DATE WHEN SYMPTOMS FIRST OCCURRED AND WHEN THE
	...
	/*
	 * ----------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW FOR EACH OF
	 * THE CONDITIONS LISTED. FOR EACH CONDITION, PLEASE LIST THE AGE OR DATE WHEN
	 * SYMPTOMS FIRST OCCURRED AND WHEN THE DIAGNOSIS WAS MADE (YOU DO NOT NEED TO
	 * INCLUDE BOTH AGE AND DATE). IF YOU DO NOT RECALL THE DETAILS, PLACE AN 'X' IN
	...
	/*
	 * --------------------------- BEGINNING OF TO CONFIRM ARE YOU COMPLETING THIS
	 * FORM FOR YOURSELF OR FOR SOMEONE ELSE---------------------------
	 */
	...
	/*
	 * --------------------------- END OF TO CONFIRM ARE YOU COMPLETING THIS FORM
	 * FOR YOURSELF OR FOR SOMEONE ELSE---------------------------
	 */

	/*
	 * --------------------------- BEGINNING OF PLEASE CONFIRM THE NAME OF THE
	 * PERSON FOR WHOM YOU ARE COMPLETING THIS
	 * QUESTIONNAIRE.---------------------------
	 */

	// PLEASE CONFIRM THE NAME OF THE PERSON FOR WHOM YOU ARE COMPLETING THIS
	// QUESTIONNAIRE. FIRSTNAME TEXT BOX
	@FindBy(xpath = "//input[@id='QR~QID2~1']")
	public WebElement personFirstNameCompletingQuestionnaire;

	// PLEASE CONFIRM THE NAME OF THE PERSON FOR WHOM YOU ARE COMPLETING THIS
	// QUESTIONNAIRE. MIDDLE INITIAL TEXT BOX
	@FindBy(xpath = "//input[@id='QR~QID2~2']")
	public WebElement personMiddleInitialCompletingQuestionnaire;

	// PLEASE CONFIRM THE NAME OF THE PERSON FOR WHOM YOU ARE COMPLETING THIS
	// QUESTIONNAIRE. LAST NAME TEXT BOX
	@FindBy(xpath = "//input[@id='QR~QID2~3']")
	public WebElement personLastNameCompletingQuestionnaire;

	/*
	 * --------------------------- END OF PLEASE CONFIRM THE NAME OF THE PERSON FOR
	 * WHOM YOU ARE COMPLETING THIS QUESTIONNAIRE.---------------------------
	 */

	/*
	 * --------------------------- BEGINNING OF IS CHRISTINA STILL
	 * ALIVE?---------------------------
	 */
	...
	/*
	 * --------------------------- END OF IS CHRISTINA STILL
	 * ALIVE?---------------------------
	 */

	/*
	 * --------------------------- BEGINNING OF HAS CHRISTINA EVER BEEN INCLUDED IN
	 * A PUBLISHED CASE REPORT OR OTHERWISE REPRESENTED IN A PUBLIC MANNER BY A
	 * HEALTHCARE PROVIDER OR RESEARCHER ---------------------------
	 */

	// HAS CHRISTINA EVER BEEN INCLUDED IN A PUBLISHED CASE REPORT OR OTHERWISE
	// REPRESENTED IN A PUBLIC MANNER BY A HEALTHCARE PROVIDER OR RESEARCHER? "YES"
	// RADIO BUTTON
	@FindBy(xpath = "//span[contains(text(),'Yes')]")
	public WebElement yesChristinaHasBeenIncludedInAPublishedCase;

	/*
	 * --------------------------- END OF HAS CHRISTINA EVER BEEN INCLUDED IN A
	 * PUBLISHED CASE REPORT OR OTHERWISE REPRESENTED IN A PUBLIC MANNER BY A
	 * HEALTHCARE PROVIDER OR RESEARCHER ---------------------------
	 */

	/*
	 * ----------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW REGARDING
	 * CHRISTINAS BIOLOGICAL PARENTS. PAGE -----------------
	 */
	// BIOLOGICAL MOTHER TEXTBOX
	...
	/*
	 * ----------------- END OF PLEASE COMPLETE THE TABLE BELOW REGARDING CHRISTINAS
	 * BIOLOGICAL PARENTS. PAGE -----------------
	 */

	/*
	 * --------------------------- BEGINNING OF WAS CHRISTINA RAMIREZ DIAGNOSED WITH
	 * HYPOGLYCEMIA (LOW BLOOD SUGAR) DURING THE NEWBORN
	 * PERIOD?---------------------------
	 */

	// WAS CHRISTINA RAMIREZ DIAGNOSED WITH HYPOGLYCEMIA LOW BLOOD SUGAR DURING THE
	// NEWBORN PERIOD? "YES" RADIO BUTTON
	@FindBy(xpath = "//span[contains(text(),'Yes')]")
	public WebElement yesChristinaWasDiagnosedWithHypoglycemia;

	/*
	 * --------------------------- END OF WAS CHRISTINA RAMIREZ DIAGNOSED WITH
	 * HYPOGLYCEMIA (LOW BLOOD SUGAR) DURING THE NEWBORN
	 * PERIOD?---------------------------
	 */
	...
	/*
	 * --------------------------- BEGINNING OF WAS CHRISTINA RAMIREZ DIAGNOSED WITH
	 * ANY OF THE FOLLOWING CONDITIONS DURING THEIR MOTHER'S
	 * PREGNANCY?---------------------------
	 */
	...
	/*
	 * --------------------------- END OF WAS CHRISTINA RAMIREZ DIAGNOSED WITH ANY
	 * OF THE FOLLOWING CONDITIONS DURING THEIR MOTHER'S
	 * PREGNANCY?---------------------------
	 */

	/*
	 * --------------------------- BEGINNING OF DURING HER PREGNANCY WITH CHRISTINA
	 * RAMIREZ DID THEIR MOTHER HAVE ANY PRENATAL TESTS TO IDENTIFY FETAL BIRTH
	 * DEFECTS OR FETAL MEDICAL PROBLEMS?---------------------------
	 */

	// DURING HER PREGNANCY WITH CHRISTINA RAMIREZ DID THEIR MOTHER HAVE ANY
	// PRENATAL TESTS TO IDENTIFY FETAL BIRTH DEFECTS OR FETAL MEDICAL PROBLEMS?
	// "YES" RADIO BUTTON
	@FindBy(xpath = "(//span)[3]")
	public WebElement yesChristinasMotherHadPrenatalTestToIdentifyBirthDefects;

	/*
	 * --------------------------- END OF DURING HER PREGNANCY WITH CHRISTINA
	 * RAMIREZ DID THEIR MOTHER HAVE ANY PRENATAL TESTS TO IDENTIFY FETAL BIRTH
	 * DEFECTS OR FETAL MEDICAL PROBLEMS?---------------------------
	 */

	/*
	 * --------------------------- BEGINNING OF PLEASE INDICATE THE RESULTS OF THE
	 * PRENATAL TESTS ADMINISTERED TO THE BIOLOGICAL MOTHER OF "NAME OF PARTICIPANT"
	 * DURING HER PREGNANCY WITH CHRISTINA RAMIREZ.---------------------------
	 */
	// SERUM AFP (ALPHA-FETOPROTEIN) NORMAL RADIO BUTTON
	...
	/*
	 * --------------------------- END OF PLEASE INDICATE THE RESULTS OF THE
	 * PRENATAL TESTS ADMINISTERED TO THE BIOLOGICAL MOTHER OF CHRISTINA RAMIREZ
	 * DURING HER PREGNANCY WITH CHRISTINA RAMIREZ.---------------------------
	 */

	/*
	 * --------------------------- BEGINNING OF DURING HER PREGNANCY WITH CHRISTINA
	 * RAMIREZ, DID THEIR BIOLOGICAL MOTHER TAKE ANY MEDICATIONS, VITAMINS OR
	...
	/*
	 * --------------------------- BEGINNING OF PLEASE DESCRIBE CHRISTINAS
	 * BIOLOGICAL PARENTS OCCUPATIONS DURING THEIR MOTHERS PREGNANCY WITH CHRISTINA?
	 * PAGE ---------------------------
	 */
	...
	/*
	 * --------------------------- END OF PLEASE DESCRIBE CHRISTINAS BIOLOGICAL
	 * PARENTS OCCUPATIONS DURING THEIR MOTHERS PREGNANCY WITH CHRISTINA? PAGE
	 * ---------------------------
	 */

	/*
	 * --------------------------- BEGINNING OF WHAT IS THE HEIGHT OF CHRISTINAS
	 * BIOLOGICAL MOTHER AND FATHER? PAGE ---------------------------
	 */
	// ADULT HEIGHT BIOLOGICAL MOTHER TEXT BOX
	@FindBy(xpath = "(//input[contains(@type,'text')])[1]")
	...
	/*
	 * --------------------------- END OF WHAT IS THE HEIGHT OF CHRISTINAS
	 * BIOLOGICAL MOTHER AND FATHER? PAGE ---------------------------
	 */

	/*
	 * --------------------------- BEGINNING OF WHAT IS THE NAME OF THE
	 * ENDOCRINOLOGIST WHO COMPLETED CHRISTINAS EXAMINATION? PAGE
	 * ---------------------------
	 */
	// TYPE OF DOCTOR/MEDICAL PROVIDER NAME TEXT BOX
	...
	/*
	 * --------------------------- END OF WHAT IS THE NAME OF THE ENDOCRINOLOGIST
	 * WHO COMPLETED CHRISTINAS EXAMINATION? PAGE ---------------------------
	 */

	/*
	 * --------------- BEGINNING OF AT WHAT AGE WAS CHRISTINA ABLE TO SIT WITHOUT
	 * SUPPORT? PAGE ---------------
	 */

	// TYPE OF AT WHAT AGE WAS CHRISTINA ABLE TO SIT WITHOUT SUPPORT? 12-18 MONTHS
	// RADIO BUTTON
	...
	/*
	 * --------------- END OF AT WHAT AGE WAS CHRISTINA ABLE TO SIT WITHOUT SUPPORT?
	 * PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF AT WHAT AGE WAS CHRISTINA ABLE TO WALK WITHOUT
	 * SUPPORT? PAGE ---------------
	 */

	// TYPE OF AT WHAT AGE WAS CHRISTINA ABLE TO WALK WITHOUT SUPPORT? 12 -18 MONTHS
	// RADIO BUTTON
	...
	/*
	 * --------------- END OF AT WHAT AGE WAS CHRISTINA ABLE TO WALK WITHOUT
	 * SUPPORT? PAGE ---------------
	 */

	/*
	 * ----------------- BEGINNING OF AT WHAT AGE WAS CHRISTINA ABLE TO USE SIMPLE
	 * TWO-WORD PHRASES? PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF AT WHAT AGE WAS CHRISTINA ABLE TO USE SIMPLE
	 * TWO-WORD PHRASES? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINNING OF BETWEEN THE AGES OF 10 AND 17 (MIDDLE AND HIGH
	 * SCHOOL AGE) PLEASE SELECT THE OPTION THAT BEST DESCRIBES CHRISTINA'S
	 * SCHOOLING. PAGE -----------------
	 */
	...
	/*
	 * ----------------- BEGINNING OF WHAT IS THE NAME OF THE CARDIOLOGIST WHO
	 * COMPLETED CHRISTINAS HEART EVALUATION? PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF WHAT IS THE NAME OF THE CARDIOLOGIST WHO COMPLETED
	 * CHRISTINAS HEART EVALUATION? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW BY PROVIDING
	 * INFORMATION FOR THE FIRST TREATMENT AND THE MOST RECENT TREATMENT. YOU ONLY
	 * NEED TO PROVIDE THE AGE AT WHICH SYMPTOMS
	 * OCCURRED OR DATE NOT BOTH. IF YOU DO NOT RECALL THE DETAILS, PLEASE PLACE AN
	 * X IN THE DONT KNOW BOX. PAGE -----------------
	 */
	...
	/*
	 * --------------- BEGINNING OF PLEASE PROVIDE ANY DETAILS KNOWN FOR THE
	 * CONDITION(S) FOR WHICH CHRISTINA HAS BEEN DIAGNOSED. PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF PLEASE PROVIDE ANY DETAILS KNOWN FOR THE CONDITION(S)
	 * FOR WHICH CHRISTINA HAS BEEN DIAGNOSED. PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING PLEASE PROVIDE THE INFORMATION FOR CHRISTINAS
	 * PRIMARY CARE PROVIDER BELOW. PAGE ---------------
	 */
	...
	/*
	 * --------------- END PLEASE PROVIDE THE INFORMATION FOR CHRISTINAS PRIMARY
	 * CARE PROVIDER BELOW. PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE INDICATE IN THE TABLE BELOW IF CHRISTINA
	 * HAS ALLERGIES TO THE LISTED ITEMS. PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF PLEASE INDICATE IN THE TABLE BELOW IF CHRISTINA HAS
	 * ALLERGIES TO THE LISTED ITEMS. PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF TABLE OF ALL MEDICATIONS WHICH CHRISTINA IS
	 * ALLERGIC TO . PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF TABLE OF ALL MEDICATIONS WHICH CHRISTINA IS ALLERGIC
	 * TO . PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF TABLE OF ALL FOOD OF WHICH CHRISTINA IS ALLERGIC
	 * TO . PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF TABLE OF ALL FOOD OF WHICH CHRISTINA IS ALLERGIC TO .
	 * PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF TABLE OF ALL "OTHER" ITEMS TO WHICH CHRISTINA IS
	 * ALLERGIC THAT WERE NOT INCLUDED IN MEDICATION OR FOOD ALLERGIES. . PAGE
	 * ---------------
	 */
	...
	/*
	 * --------------- END OF TABLE OF ALL "OTHER" ITEMS TO WHICH CHRISTINA IS
	 * ALLERGIC THAT WERE NOT INCLUDED IN MEDICATION OR FOOD ALLERGIES. . PAGE
	 * ---------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE PROVIDE THE INFORMATION FOR EACH
	 * HOSPITALIZATION IN THE TABLE BELOW.
	 * TO ADD A NEW HOSPITALIZATION, PLEASE CLICK ON THE '+' SIGN IN THE UPPER LEFT
	 * CORNER OF THE TABLE. PAGE ---------------
	 */
	...
	/*
	 * --------------- BEGINNING OF PLEASE COMPLETE THE NEXT SET OF QUESTIONS
	 * REGARDING ABDOMINAL PAIN PROXY. PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF PLEASE COMPLETE THE NEXT SET OF QUESTIONS REGARDING
	 * ABDOMINAL PAIN PROXY. PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF TO WHAT FOODS IS CHRISTINA AVERSE? PLEASE
	 * DESCRIBE FOODS THAT CHRISTINA AVOIDS BECAUSE THEY DO NOT LIKE THE TEXTURE OR
	 * OTHER PHYSICAL QUALITIES OF THE FOOD PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF TO WHAT FOODS IS CHRISTINA AVERSE? PLEASE DESCRIBE
	 * FOODS THAT CHRISTINA AVOIDS BECAUSE THEY DO NOT LIKE THE TEXTURE OR OTHER
	 * PHYSICAL QUALITIES OF THE FOOD PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF AT WHAT AGE (APPROXIMATELY) WAS CHRISTINA TOILET
	 * TRAINED? PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF AT WHAT AGE (APPROXIMATELY) WAS CHRISTINA TOILET
	 * TRAINED? PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF HOW MANY BOWEL MOVEMENTS DOES CHRISTINA HAVE PER
	 * WEEK? PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF HOW MANY BOWEL MOVEMENTS DOES CHRISTINA HAVE PER WEEK?
	 * PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF WHAT IS THE LONGEST AMOUNT OF TIME THAT HAS
	 * PASSED WITHOUT CHRISTINA HAVING A BOWEL MOVEMENT? PAGE ---------------
	 */
	...
	/*
	 * --------------- END OF WHAT IS THE LONGEST AMOUNT OF TIME THAT HAS PASSED
	 * WITHOUT CHRISTINA HAVING A BOWEL MOVEMENT? PAGE ---------------
	 */

	/*
	 * --------------- BEGINNING OF PLEASE PROVIDE THE INFORMATION BELOW FOR THE
	 * PULMONOLOGIST WHO COMPLETED FOR PROXY EVALUATION. PAGE ---------------
	 */
	...
	/*
	 * ----------------- BEGINING OF WHAT WAS THE REASON FOR YOUR LAST PROXY DENTAL
	 * VISIT? PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF WHAT WAS THE REASON FOR YOUR LAST PROXY DENTAL
	 * VISIT? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF OVERALL, HOW WOULD YOU RATE PROXY THE OVERALL
	 * HEALTH OF YOUR TEETH AND GUMS? PAGE -----------------
	 */

	// OVERALL, HOW WOULD YOU RATE THE OVERALL HEALTH OF YOUR TEETH AND GUMS? PROXY
	// FAIR RADIO BUTTON
	@FindBy(xpath = "(//label[@for='QR~QID539~3'])[2]")
	public WebElement overallHealthOfTeethAndGumsFairProxyRadioButton;

	/*
	 * ----------------- END OF OVERALL, HOW WOULD YOU RATE PROXY THE OVERALL HEALTH
	 * OF YOUR TEETH AND GUMS? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF OVERALL, HOW WOULD YOU RATE PROXY DENTAL
	 * HYGIENE ROUTINE (REGULAR TOOTH BRUSHING, FLOSSING, AND YOUR HOME ORAL MOUTH
	 * RINSE)? PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF OVERALL, HOW WOULD YOU RATE PROXY DENTAL HYGIENE
	 * ROUTINE (REGULAR TOOTH BRUSHING, FLOSSING, AND YOUR HOME ORAL MOUTH RINSE)?
	 * PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF OVERALL -- IS THERE ANYTHING UNUSUAL ABOUT
	 * PROXY TEETH OR MOUTH
	 * (EXTRA TEETH, MISSING TEETH, SEVERE DENTAL DISEASES, JAWBONE PROBLEMS, ENAMEL
	 * PROBLEMS, ETC.)? PAGE -----------------
	 */

	// OVERALL -- IS THERE ANYTHING UNUSUAL ABOUT PROXY TEETH OR MOUTH...? YES
	// (PLEASE SPECIFY)RADIO BUTTON
	...
	/*
	 * ----------------- END OF OVERALL -- IS THERE ANYTHING UNUSUAL ABOUT PROXY
	 * TEETH OR MOUTH
	 * (EXTRA TEETH, MISSING TEETH, SEVERE DENTAL DISEASES, JAWBONE PROBLEMS, ENAMEL
	 * PROBLEMS, ETC.)? PAGE -----------------
	 */
	...
	/*
	 * ----------------- BEGINING OF HAVE YOU HAD TROUBLE PRONOUNCING ANY WORDS
	 * BECAUSE OF PROBLEMS WITH PROXY TEETH, MOUTH OR DENTURES? PAGE
	 * -----------------
	 */

	// HAVE YOU HAD TROUBLE PRONOUNCING ANY WORDS BECAUSE OF PROBLEMS WITH PROXY
	// TEETH, MOUTH OR DENTURES? OCCASIONALLY RADIO BUTTON
	...
	/*
	 * ----------------- END OF HAVE YOU HAD TROUBLE PRONOUNCING ANY WORDS BECAUSE
	 * OF PROBLEMS WITH PROXY TEETH, MOUTH OR DENTURES? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF HAVE YOU FELT THAT YOUR SENSE OF TASTE HAS
	 * WORSENED BECAUSE OF PROBLEMS WITH PROXY TEETH, MOUTH OR DENTURES? PAGE
	 * -----------------
	 */

	// HAVE YOU FELT THAT YOUR SENSE OF TASTE HAS WORSENED BECAUSE OF PROBLEMS WITH
	// PROXY TEETH, MOUTH OR DENTURES? OCCASIONALLY RADIO BUTTON
	...
	/*
	 * ----------------- BEGINING OF HAVE YOU HAD PAINFUL ACHING IN PROXY MOUTH?
	 * PAGE -----------------
	 */
	...
	/*
	 * ----------------- BEGINING OF HAVE YOU FOUND IT UNCOMFORTABLE TO EAT ANY
	 * FOODS BECAUSE OF PROBLEMS WITH PROXY TEETH, MOUTH OR DENTURES? PAGE
	 * -----------------
	 */
	...
	/*
	 * ----------------- BEGINING OF ARE YOU SELF-CONSCIOUS BECAUSE OF PROXY TEETH,
	 * MOUTH OR DENTURES? PAGE -----------------
	 */

	// ARE YOU SELF-CONSCIOUS BECAUSE OF PROXY TEETH, MOUTH OR DENTURES?
	// OCCASIONALLY RADIO BUTTON
	...
	/*
	 * ----------------- END OF ARE YOU SELF-CONSCIOUS BECAUSE OF PROXY TEETH, MOUTH
	 * OR DENTURES? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF HAVE YOU FELT TENSE BECAUSE OF PROBLEMS WITH
	 * PROXY TEETH, MOUTH OR DENTURES? PAGE -----------------
	 */

	// HAVE YOU FELT TENSE BECAUSE OF PROBLEMS WITH PROXY TEETH, MOUTH OR DENTURES?
	// OCCASIONALLY RADIO BUTTON
	...
	/*
	 * ----------------- END OF HAVE YOU FELT TENSE BECAUSE OF PROBLEMS WITH PROXY
	 * TEETH, MOUTH OR DENTURES? PAGE -----------------
	 */

	/*
	 * ----------------- BEGINING OF HAS YOUR DIET BEEN UNSATISFACTORY BECAUSE OF
	 * PROBLEMS WITH PROXY TEETH, MOUTH OR DENTURES? PAGE -----------------
	 */

	// HAS YOUR DIET BEEN UNSATISFACTORY BECAUSE OF PROBLEMS WITH PROXY TEETH, MOUTH
	// OR DENTURES? OCCASIONALLY RADIO BUTTON
	...
	// HAVE YOU HAD TO INTERRUPT MEALS BECAUSE OF PROBLEMS WITH PROXY TEETH, MOUTH
	// OR DENTURES? OCCASIONALLY RADIO BUTTON
	...
	/*
	 * ----------------- END OF HAVE YOU HAD TO INTERRUPT MEALS BECAUSE OF PROBLEMS
	 * WITH PROXY TEETH, MOUTH OR DENTURES? PAGE -----------------
	 */
	...
	// HAVE YOU FOUND IT DIFFICULT TO RELAX BECAUSE OF PROBLEMS WITH PROXY TEETH,
	// MOUTH OR DENTURES? OCCASIONALLY RADIO BUTTON
	...
	// HAVE YOU BEEN A BIT EMBARRASSED BECAUSE OF PROBLEMS WITH PROXY TEETH, MOUTH
	// OR DENTURES? OCCASIONALLY RADIO BUTTON
	...
	// HAVE YOU BEEN IRRITABLE WITH OTHER PEOPLE BECAUSE OF PROBLEMS WITH PROXY
	// TEETH, MOUTH OR DENTURES? OCCASIONALLY RADIO BUTTON
	...
	// HAVE YOU HAD DIFFICULTY DOING YOUR USUAL JOBS BECAUSE OF PROBLEMS WITH PROXY
	// TEETH, MOUTH OR DENTURES? OCCASIONALLY RADIO BUTTON
	...
	/*
	 * ----------------- BEGINING OF HAVE YOU FELT THAT LIFE IN GENERAL IS LESS
	 * SATISFYING BECAUSE OF PROBLEMS WITH PROXY TEETH, MOUTH OR DENTURES? PAGE
	 * -----------------
	 */

	// HAVE YOU FELT THAT LIFE IN GENERAL IS LESS SATISFYING BECAUSE OF PROBLEMS
	// WITH PROXY TEETH, MOUTH OR DENTURES? OCCASIONALLY RADIO BUTTON
	...
	// HAVE YOU BEEN TOTALLY UNABLE TO FUNCTION BECAUSE OF PROBLEMS WITH PROXY
	// TEETH, MOUTH OR DENTURES? OCCASIONALLY RADIO BUTTON
	...
	/*
	 * ----------------- BEGINNING OF PLEASE COMPLETE THE TABLE BELOW FOR EACH OF
	 * THE TUMORS LISTED. PLEASE INCLUDE PROXY AGE OR DATE WHEN SYMPTOMS FIRST
	 * STARTED AND DIAGNOSIS (YOU DO NOT NEED TO INCLUDE BOTH AGE AND DATE). IF YOU
	 * DO NOT RECALL THE DETAILS, PLEASE PLACE AN 'X' UNDER THE 'DON'T KNOW' COLUMN.
	 * PAGE -----------------
	 */
	...
	/*
	 * ----------------- END OF PLEASE COMPLETE THE TABLE BELOW FOR EACH OF THE
	 * TUMORS LISTED. PLEASE INCLUDE PROXY AGE OR DATE WHEN SYMPTOMS FIRST
	 * STARTED AND DIAGNOSIS (YOU DO NOT NEED TO INCLUDE BOTH AGE AND DATE). IF YOU
	 * DO NOT RECALL THE DETAILS, PLEASE PLACE AN 'X' UNDER THE 'DON'T KNOW' COLUMN.
	 * PAGE -----------------
	 */
	...
	/*
	 * ----------------- BEGINNING OF PROXY PLEASE COMPLETE THE TABLE BELOW FOR EACH
	 * OF THE CONDITIONS LISTED. FOR EACH CONDITION, PLEASE LIST THE AGE OR DATE
	 * WHEN
	 * SYMPTOMS FIRST OCCURRED AND WHEN THE DIAGNOSIS WAS MADE (YOU DO NOT NEED TO
	 * INCLUDE BOTH AGE AND DATE). IF YOU DO NOT RECALL THE DETAILS, PLACE AN 'X' IN
	 * THE 'DON'T KNOW' COLUMN. PAGE -----------------
	...
	/*
	 * ----------------- END OF PROXY PLEASE COMPLETE THE TABLE BELOW FOR EACH OF
	 * THE CONDITIONS LISTED. FOR EACH CONDITION, PLEASE LIST THE AGE OR DATE WHEN
	 * SYMPTOMS FIRST OCCURRED AND WHEN THE DIAGNOSIS WAS MADE (YOU DO NOT NEED TO
	 * INCLUDE BOTH AGE AND DATE). IF YOU DO NOT RECALL THE DETAILS, PLACE AN 'X' IN
	 * THE 'DON'T KNOW' COLUMN. PAGE -----------------
