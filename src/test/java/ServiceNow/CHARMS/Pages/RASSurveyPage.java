...
public class RASSurveyPage {
	...
	//UNSURE/UNKNOWN 2 RADIO BUTTON (IF FIRST UNSURE/UNKNOWN RADIO BUTTON FAILS)
	@FindBy (xpath="/html/body/div[3]/div/form/div/div[2]/div[1]/div[3]/div[1]/div[2]/div[3]/div/fieldset/div/ul/li[3]/span/label")
	public WebElement unsureUnknown2RadioButton;

	//UNSURE/UNKNOWN CHECK BOX
	@FindBy (xpath="//label[contains(@for,'QR~QID213~5')]//span")
	public WebElement unsureUnknownCheckBox;

	//UNSURE/UNKNOWN DATE OR AGE OF FIRST SYMPTOMS DON'T KNOW TEXT BOX
	@FindBy (xpath="(//input[@name='QR~QID211#1~x7~3~TEXT'])[1]")
	public WebElement unsureUnknownDateOrAgeFirstSymptomsDontKnowTextBox;

	//UNSURE/UNKNOWN DATE OR AGE OF DIAGNOSIS DON'T KNOW TEXT BOX
	@FindBy (xpath="(//input[@name='QR~QID211#2~x7~3~TEXT'])[1]")
	public WebElement unsureUnknownDateOrAgeDiagnosisDontKnowTextBox;

	//UNSURE/DON'T KNOW TREATMENT RADIO BUTTON
	@FindBy (xpath="//label[@for='QR~QID258#3~x6~3']")
	public WebElement unsureDontKnowTreatmentRadioButton;
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - ANTIBIOTICS NAME OF MEDICATION TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - ANTIBIOTICS REASON MEDICATION PRESCRIBED TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - ANTIBIOTICS LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - VITAMINS NAME OF MEDICATION TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - VITAMINS REASON MEDICATION PRESCRIBED TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - VITAMINS LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - ANTIHYPERTENSIVES (FOR HIGH BLOOD PRESSURE) NAME OF MEDICATION TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - ANTIHYPERTENSIVES (FOR HIGH BLOOD PRESSURE) REASON MEDICATION PRESCRIBED TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - ANTIHYPERTENSIVES (FOR HIGH BLOOD PRESSURE) LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - MEDICATION FOR HIGH BLOOD GLUCOSE (E.G. INSULIN) NAME OF MEDICATION TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - FOR HIGH BLOOD GLUCOSE (E.G. INSULIN) REASON MEDICATION PRESCRIBED TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - MEDICATION FOR HIGH BLOOD GLUCOSE (E.G. INSULIN) LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - ANTIEMETICS (FOR NAUSEA) NAME OF MEDICATION TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - ANTIEMETICS (FOR NAUSEA) REASON MEDICATION PRESCRIBED TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - ANTIEMETICS (FOR NAUSEA) LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - HORMONES (E.G. DES, PROGESTERONE) NAME OF MEDICATION TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - HORMONES (E.G. DES, PROGESTERONE) REASON MEDICATION PRESCRIBED TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - HORMONES (E.G. DES, PROGESTERONE) LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - ANTI-DEPRESSANTS NAME OF MEDICATION TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - ANTI-DEPRESSANTS REASON MEDICATION PRESCRIBED TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - ANTI-DEPRESSANTS LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - DIURETICS NAME OF MEDICATION TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - DIURETICS REASON MEDICATION PRESCRIBED TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - DIURETICS LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - PAIN RELIEVERS NAME OF MEDICATION TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - PAIN RELIEVERS REASON MEDICATION PRESCRIBED TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - PAIN RELIEVERS LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - MEDICATIONS FOR PRE-TERM LABOR (E.G. TERBUTALINE, MAGNESIUM SULFATE) NAME OF MEDICATION TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - MEDICATIONS FOR PRE-TERM LABOR (E.G. TERBUTALINE, MAGNESIUM SULFATE) REASON MEDICATION PRESCRIBED TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - MEDICATIONS FOR PRE-TERM LABOR (E.G. TERBUTALINE, MAGNESIUM SULFATE) LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - THYROID MEDICATIONS NAME OF MEDICATION TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - THYROID MEDICATIONS REASON MEDICATION PRESCRIBED TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - THYROID MEDICATIONS LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - ANTI-SEIZURE MEDICATIONS NAME OF MEDICATION TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - ANTI-SEIZURE MEDICATIONS REASON MEDICATION PRESCRIBED TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - ANTI-SEIZURE MEDICATIONS LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
	...
	@FindBy (xpath="(//input[@name='QR~QID62#1~x13~1~TEXT'])[1]")
	public WebElement herbalSupplementNameTextBox;
	
	// HERBAL SUPPLEMENT PLEASE SPECIFY MEDICATION TEXT BOX
	@FindBy (xpath="(//input[@name='QR~QID62#2~x13~1~TEXT'])[1]")
	public WebElement herbalSupplementPleaseSpecifyTextBox;
	
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - OREGANO NAME OF MEDICATION TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - HERBAL SUPPLEMENT REASON MEDICATION PRESCRIBED TEXT BOX
	@FindBy (xpath="(//input[@name='QR~QID340#2~x13~1~TEXT'])[1]")
	public WebElement herbalSupplementReasonForSomeoneElseTextBox;
	
	// HERBAL SUPPLEMENT LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - HERBAL SUPPLEMENT LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - TOTAL PARENTAL NUTRITION (TPN) NAME OF MEDICATION TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - TOTAL PARENTAL NUTRITION (TPN) REASON MEDICATION PRESCRIBED TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - TOTAL PARENTAL NUTRITION (TPN) LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - OTHER MEDICATION NAME OF MEDICATION TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - OTHER MEDICATION REASON MEDICATION PRESCRIBED TEXT BOX
	@FindBy (xpath="(//input[@name='QR~QID340#2~x15~1~TEXT'])[1]")
	public WebElement otherMedicationReasonForSomeoneElseTextBox;
	
	// OTHER MEDICATION LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - OTHERMEDICATION LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - OTHER MEDICATION2 NAME OF MEDICATION TEXT BOX
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - OTHER MEDICATION2 REASON MEDICATION PRESCRIBED TEXT BOX
	@FindBy (xpath="(//input[@name='QR~QID340#2~x16~1~TEXT'])[1]")
	public WebElement otherMedication2ReasonForSomeoneElseTextBox;
	
	// OTHER MEDICATION2 LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
	...
	// I AM COMPLETING THIS FORM FOR SOMEONE ELSE - OTHER MEDICATION2 LENGTH OF TIME MEDICATION WAS TAKEN (DURING PREGNANCY) DROP DOWN
