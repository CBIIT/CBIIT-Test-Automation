...
public class FHQpatientRecordProducerSteps extends PageInitializer {
	...
	public void logs_in_charms_fhq_survey_page() throws TestingException {
		...
		ComponentTestResult charmsBannerTest = FHQUtil.verifyLabel1(
				fHQSubmissionPage.dynamicLocatorContainsText("NCI Family Studies Hub: RASopathies"),
				"Family Cohort Study Management System: RASopathies");
		ComponentTestResult bannerTest = FHQUtil.verifyLabel1(fHQSurveyPortalPage.familyHealthBanner1,
		...
		ComponentTestResult labelTest = FHQUtil.verifyLabel1(
