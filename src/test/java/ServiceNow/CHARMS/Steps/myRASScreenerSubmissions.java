...
public class myRASScreenerSubmissions extends PageInitializer {
	...
	/* --------------- BEGINNING: What is the name of the person who may be eligible for this study? Page ---------------- */
	...
	/* --------------- END: What is the name of the person who may be eligible for this study? Page ---------------- */
	...
	/* --------------- -------------------BEGINNING: The next set of questions will collect basic information about the participant Page ---------------- */
	...
	/* ------------------------------- END: The next set of questions will collect basic information about the participant Page ---------------- */
	...
	/* -------------------------------- END: participants Date of Birth from the calendar picker? Page ---------------- */
...
/* ********************************************************************************************** */
	...
	public void selects_Other_option_and_enters_for_is_the_participant_participated_in_any_other_research_study_or_registry_group(String addOption) {
		MiscUtils.sleep(1000);
		rasopathyQuestionnairePage.isParticipantInOtherResearchStudyOption.click();
	...
	/* ------------  BEGINNING: Selects option for participant being diagnosed with any of the listed conditions -------------- */
	...
	/* ------------  END: Selects option for participant being diagnosed with any of the listed conditions -------------- */
	...
	/* --------------- BEGINNING: Have participant been diagnosed with a RASopathy such as Noonan syndrome, Noonan syndrome with multiple lentigines, Costello syndrome ------- */
	...
	/* ------ END: Have you been diagnosed with a RASopathy such as Noonan syndrome, Noonan syndrome with multiple lentigines, Costello syndrome ------- */
	...
	/* ----- BEGINNING: option to biological representatives of participants having been diagnosed with a RASopathy ----- */
	...
	/* ----- END: option to biological representatives of participants having been diagnosed with a RASopathy ----- */
	...
	/* ------ BEGINNING: options for any genetic changes detected for the following syndromes for the participant -------*/
	...
	/* ------ END: options for any genetic changes detected for the following syndromes for the participant -------*/
	
	/* ********************************************************************************************************************** */
	
	/* ------------ BEGINNING: user proceeds on answering few remaining questions regarding the study --------------*/
	...
	/* -- BEGINNING: How did you hear about this study. If a specific health care provider referred you to this study, please include their name in the corresponding text box --- */
	...
	/* -- END: how did you hear about this study. If a specific health care provider referred you to this study, please include their name in the corresponding text box --- */
	
	/* ********************************************************************************************************************** */
	
	/* -- BEGINNING: Options for the participant or other family members ever participated in another study on RASopathies at another medical institution --- */
	...
	/* -- END: Options for the participant or other family members ever participated in another study on RASopathies at another medical institution --- */
	
	/* ********************************************************************************************************************** */
	
	/* -- BEGINNING: provides the following information regarding previous participation in other RASopathy studies --- */
	...
	/* -- END: provides the following information regarding previous participation in other RASopathy studies --- */
