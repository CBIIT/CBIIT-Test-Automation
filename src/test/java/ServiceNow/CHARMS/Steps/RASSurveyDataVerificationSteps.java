...
public class RASSurveyDataVerificationSteps extends PageInitializer {
	...
	public void all_data_submitted_via_the_RAS_Survey_is_verified_in_Native_View() throws InvalidFormatException, IOException, TestingException {
		...
		// Logging into native view
				...
				CommonUtils.assertEquals("Cigarettes, Cigars, Pipes, Other (please specify)",
						charmsNativeViewPage.nativeVIewRasSurveyTobaccoProductsUsedAroundMotherDuringPregnancyDropDown.getText());
				...
				// Testing" dropdown
				CommonUtils.assertEquals("Yes",
						charmsNativeViewPage.nativeViewRasSurveyGrowthHasTheParticipantHadGrowthHormoneTestingDropDown.getText());
				//Has the participant ever been evaluated by an endocrinologist for any reason? DropDown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyGrowthHasTheParticipantEverBeenEvaledByAnEndrocrinologistDropDown.getText());
				...
				// Verifying Was the participant diagnosed with hypotonia as an infant or child? DropDown
				CommonUtils.assertEquals("Yes",
						charmsNativeViewPage.nativeViewRasSurveyparticipantDiagnosedWithHypotoniaAsAnInfantOrChildDropDown.getText());

				// Verifying At what age was the participant able to sit without support DropDown
				CommonUtils.assertEquals("12 - 18 months",
						charmsNativeViewPage.nativeViewRasSurveyAgeAbleToSitWithoutSupportDropdown.getText());

				// Verifying At What age was the participant able to Walk without support DropDown
				CommonUtils.assertEquals("12 - 18 months",
				...
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyEverReceivedSpeechTherapyDropDown.getText());
				...
				CommonUtils.assertEquals("Bachelor's degree (4-year college with BA, BS, AB,BBA)", charmsNativeViewPage.nativeViewRasSurveyHighestLevelOfSchoolingDropdown.getText());
				...
				//Verifying Participant selects Yes to "Has the participant ever had an evaluation by a hematologist or oncologist?" -- dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyHasTheParticipantEverHadAnEvaledByAHematologistOrOncologistDropDown.getText());

				//Verifying Participant Name of hematologist/oncologist -- textbox
				CommonUtils.assertEquals("DOCTOR LILY KING", charmsNativeViewPage.nativeViewRasSurveyNameOfHematologist_OncologistTextBox.getAttribute("value"));

				//Verifying Participant Location of hematologist/oncologist -- textbox
				CommonUtils.assertEquals("ARLINGTON, VA", charmsNativeViewPage.nativeViewRasSurveyLocationOfHematologist_OncologistTextBox.getAttribute("value"));

				//Verifying Participant Hematologist/Oncologist medical affiliation -- textbox
				CommonUtils.assertEquals("INOVA", charmsNativeViewPage.nativeViewRasSurveyHematologist_OncologistMedicalAffiliationTextBox.getAttribute("value"));

				//Verifying Participant selects Yes to "Does the participant have any issues with bleeding or bruising?" -- dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyDoesTheParticipantHaveIssuesWithBleedingOrBruisingDropDown.getText());

				//Verifying Participant selects Yes to "Does the participant have a history of frequent infections?" -- dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyDoesTheParticipantHaveAHistoryOfFrequentInfectionsDropDown.getText());

				//Verifying Participant selects Yes to "Has the participant been diagnosed with an autoimmune disorder?" -- dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyHasTheParticipantBeenDiagnosedWithAnAutoimmuneDisorderDropDown.getText());

				//Verifying Participant selects Yes to "Does the participant have any known blood disorders or symptoms such disorders?" -- dropdown  ***Mention Wording of question
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyDoesTheParticipantHaveAnyKnownBloodDisordersOrSymptomsDropDown.getText());

				//Verifying Participant selects Yes to "Has the participant been evaluated by an immunologist or rheumatologist?" -- dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyHasTheParticipantBeenEvaledByAnImmunologistOrRheumatologistDropDown.getText());}
				...
				//Verifying Participant selects Yes to "Has the participant ever been evaluated by a neurologist or neurosurgeon?" -- dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyHasTheParticipantEverBeenEvaledByANeurologistOrNeurosurgeonDropDown.getText());
				
				//Verifying Participant Name of neurologist -- textbox
				CommonUtils.assertEquals("DOCTOR JENNIFER LOPEZ", charmsNativeViewPage.nativeViewRasSurveyNameOfNeurologistTextBox.getAttribute("value"));
				
				//Verifying Participant Location of neurologist -- textbox
				CommonUtils.assertEquals("MAIMI, FL", charmsNativeViewPage.nativeViewRasSurveyLocationOfNeurologistTextBox.getAttribute("value"));
				
				//Verifying Participant Neurologist affiliation -- textbox
				CommonUtils.assertEquals("MERCY HOSPITAL", charmsNativeViewPage.nativeViewRasSurveyNeurologistAffiliationTextBox.getAttribute("value"));
				
				//Verifying Participant selects Yes to "Has the participant ever been diagnosed with a structural brain abnormality?" -- dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyHasTheParticipantBeenDiagnosdWithAStructuralBrainAbnormalityDropDown.getText());
				
				//Verifying Participant selects Yes to "Evaluated by a psychiatrist, psychologist or behavioral pediatrician?" -- dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyEvaluatedByAPsychiatristPsychologistOrBehavioralPediatricianDropDown.getText());
				
				//Verifying Participant selects Yes to "Does the participant have a history seizures?" -- dropdown	  ***Mention Wording of question
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyDoesTheParticipantHaveAHistorySeizuresDropDown.getText());
				
				//Verifying Participant selects Yes to "Has the participant been diagnosed with a behavioral or psychiatric condition?" -- dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyHasTheParticipantBeenDiagnosedWIthABehavioralOrPsychiatricConditionDropDown.getText());
				
				//Verifying Participant Name of physician -- textbox
				CommonUtils.assertEquals("DOCTOR BRAD PITT", charmsNativeViewPage.nativeViewRasSurveyNameOfPhysicianTextBox.getAttribute("value"));
				
				//Verifying Participant Location of physician -- textbox
				CommonUtils.assertEquals("WASHINGTON, DC", charmsNativeViewPage.nativeViewRasSurveyLocationOfPhysicianTextBox.getAttribute("value"));
				
				//Verifying Participant Psychiatrist affiliation -- textbox
				CommonUtils.assertEquals("G.W. HOSPITAL", charmsNativeViewPage.nativeViewRasSurveyPsychiatristAffiliationTextBox.getAttribute("value"));

				//Verifying Participant Psychiatrist affiliation -- textbox
				CommonUtils.assertEquals("", charmsNativeViewPage.nativeViewRasSurveyAdditionalNeurologicalConditionsTextBox.getAttribute("value"));}
				...
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyDiagnosedWithPtosisDropDown.getText());

				//Verifying Participant selects Yes to "Did the ptosis require treatment?" -- dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyDidThePtosisRequireTreatmentDropDown.getText());

				//Verifying Participant selects Yes to "Participant experienced hearing loss" -- dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyParticipantExperiencedHearingLosssDropDown.getText());

				//Verifying Participant selects Yes to "Issues with vision or eyesight" -- dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyIssuesWithVisionOrEyeSightDropDown.getText());

				//Verifying Participant selects Yes to "Participant experienced strabismus" -- dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyParticipantExperiencedStrabismusDropDown.getText());

				//Verifying Participant selects Yes to "Participant experienced nystagmus" -- dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyParticipantExperiencedNystagmusDropDown.getText());

				//Verifying Participant Participant ear issues -- paragraph
				CommonUtils.assertEquals("Excessive earwax, Chronic or recurrent ear infection, Other", charmsNativeViewPage.nativeViewRasSurveyParticipantEarIsssuesPTag.getText());

				//Verifying Participant Participant ear issues, Please specify -- textbox
				CommonUtils.assertEquals("INNER EAR INFECTION", charmsNativeViewPage.nativeViewRasSurveyPleaseSpecifyEarIssuesTextBox.getAttribute("value"));}
				...
				CommonUtils.assertEquals("WASHINGTON DC, USA", charmsNativeViewPage.nativeViewRasSurveyHeartTabLocationCityStateCountryTextBox.getAttribute("value"));
				...
				//Verifying Participant selects Yes to Does the participant have a primary care provider? Drop Down
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyDoesTheParticipantHaveAPrimaryCareProviderDropDown.getText());

				//Verifying Participant Name of primary care provider Text Box
				CommonUtils.assertEquals("DOCTOR GEORGE PEABODY", charmsNativeViewPage.nativeViewRasSurveyNameOfPrimaryCareProviderTextBox.getAttribute("value"));
				
				//Verifying Participant Location of primary care provider Text Box
				CommonUtils.assertEquals("FAIRFAX", charmsNativeViewPage.nativeViewRasSurveyLocationOfPrimaryCareProviderTextBox.getAttribute("value"));

				//Verifying Primary Care Provider Affiliation Text Box
				CommonUtils.assertEquals("INOVA", charmsNativeViewPage.nativeViewRasSurveyPrimaryCareProviderAffiliationTextBox.getAttribute("value"));

				//Verifying Participant selects Yes to "Has the participant ever had a biopsy?" Drop Down
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyHasTheParticipantEverHadABiopsyDropDown.getText());

				//Verifying Participant selects Yes to "Is the participant allergic to any medications" Drop Down
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyIsTheParticipantAllergicToAnyMedicationsDropDown.getText());

				//Verifying Participant selects Yes to "Have you ever been diagnosed with a lymphatic system issue" Drop Down
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyHaveYouEverBeenDiagnosedWithALymphaticSystemIssueDropDown.getText());

				//Verifying Participant selects Yes to "Has the participant ever been evaluated by a nephrologist?" Drop Down
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyHasTheParticipantEverBeenEvaluatedByANephrologistDropDown.getText());

				//Verifying Name of nephrologist Text Box
				CommonUtils.assertEquals("DOCTOR LAUREN RODNEY", charmsNativeViewPage.nativeViewRasSurveyNameOfNephrologistTextBox.getAttribute("value"));

				//Verifying Nephrologist Location Text Box
				CommonUtils.assertEquals("ARLINGTON, VA", charmsNativeViewPage.nativeViewRasSurveyNephrologistLocationTextBox.getAttribute("value"));

				//Veifying Nephrologist affiliation Text Box
				CommonUtils.assertEquals("INOVA", charmsNativeViewPage.nativeViewRasSurveyNephrologistAffilitionTextBox.getAttribute("value"));

				//Verifying Has the participant ever been diagnosed with a kidney problem Drop Down
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyHasTheParticipantEverBeenDiagnosedWithAKidneyProblemDropDown.getText());

				//Verifying Hospitalized for any reason other than accidental injury or childbirth Drop Down
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyHospitalizedForAnyReasonOtherThanAccidentalInjuryOrChildbirthDropDown.getText());

				//Verifying Is the participant allergic to any foods Drop Down
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyIsTheParticipantAllergicToAnyFoodsDropDown.getText());

				//Verifying Is the participant allergic to other things? Drop Down
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyIsTheParticipantAllergicToOtherThingsDropDown.getText());

				//Verifying Participant ear issues Text Area
				CommonUtils.assertEquals("Excessive earwax, Chronic or recurrent ear infection, Other", charmsNativeViewPage.nativeViewRasSurveyParticipantEarIssuesTextArea.getText());
				...
				// Verifying Has the participant had any symptoms that likely involved the GI system- Dropdown
				...
				CommonUtils.assertEquals("DOCTOR PHIL VOSS", charmsNativeViewPage.nativeViewRasSurveyGiSpecialistNameTextbox.getAttribute("value"));

				//Verfying GI Specialist City, State- Textbox
				CommonUtils.assertEquals("FAIRFAX, VA", charmsNativeViewPage.nativeViewRasSurveySpecialistCityStateTextbox.getAttribute("value"));

				//Verfying GI Specialist Hospital / Health Center Affiliation- Textbox
				CommonUtils.assertEquals("INOVA", charmsNativeViewPage.nativeViewRasSurveyHospitalAffiliationTextbox.getAttribute("value"));
				...
				CommonUtils.assertEquals("TROUBLE SWALLOWING", charmsNativeViewPage.nativeViewRasSurveyOtherFeedingDifficultiesTextBox.getAttribute("value"));

				//Verfying Age NJ/NG-tube was placed- Textbox
				CommonUtils.assertEquals("10 DAYS", charmsNativeViewPage.nativeViewRasSurveyAgeNJNGTubeTextbox.getAttribute("value"));

				//Verfying Age G/G-J tube was placed- Textbox
				CommonUtils.assertEquals("20 DAYS", charmsNativeViewPage.nativeViewRasSurveyAgeGGJTubeTextbox.getAttribute("value"));
				
				//Age gastronomy tube(G/G-J) removed- Textbox
				CommonUtils.assertEquals("30 DAYS", charmsNativeViewPage.nativeViewRasSurveyAgeGastroTubeRemovedTextbox.getAttribute("value"));

				//This step did not show up in Native View 
				//All that apply Which of the following symptoms related to the GI system have occurred?
				...
				CommonUtils.assertEquals("2", charmsNativeViewPage.nativeViewRasSurveyAgeSuccesfullyToiletTrainedTextbox.getAttribute("value"));

				//Any episodes of repeated urine accidents after being toilet trained?- Dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyEpisodesRepeatedUrineafterTrainedDropdown.getText());

				//Does the patient consistently use the toilet for all urination?- Dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyConsistentlyUseToiletUrinationDropdown.getText());
				
				//Does the patient consistently use the toilet for all bowel movements?- Dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyToiletForAllBowelMovementDropdown.getText());
			
				//Any episodes of repeated bowel movement accidents after being toilet trained?- Dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyRepeatedBowelAccidentsAfterTrainedDropdown.getText());
				...
				CommonUtils.assertEquals("2", charmsNativeViewPage.nativeViewRasSurveyBowelMovementsPerWeekTextbox.getText());
				...
				CommonUtils.assertEquals("2 days", charmsNativeViewPage.nativeViewRasSurveyLongestTimeWithoutBowelMovementDropdown.getText());

				//Has the participant had a procedure, test or study to evaluate their GI?- Dropdown
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyProcedureToEvaluateGIDropdown.getText());
			
				// ------- HAIR & SKIN DATA VERIFICATION --------
				charmsNativeViewPage.nativeViewRasSurveyHairAndSkinTab.click();

				//Verifying Participant selects Yes to "Has participant been evaluated by a dermatologist?" Drop Down
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyHasTheParticipantBeenEvaluatedByAnOrthopaedicSurgeonDropDown.getText());

				//Verifying Name of dermatlogist Text Box
				CommonUtils.assertEquals("DOCTOR DERMA CLOONEY", charmsNativeViewPage.nativeViewRasSurveyNameOfDermatologistTextBox.getAttribute("value"));

				//Verifying City, State of dermatologist Text Box
				CommonUtils.assertEquals("WASHINGTON, DC", charmsNativeViewPage.nativeViewRasSurveyCityStateOfDermatologistTextBox.getAttribute("value"));

				//Verifying Hospital or Medical Center Affiliation of Dermatologist Text Box
				CommonUtils.assertEquals("G.W. HOSPITAL", charmsNativeViewPage.nativeViewRasSurveyHospitalOrMedicalCenterAffilitionOfDermatologistTextBox.getAttribute("value"));

				//Verifying Description of participant's hair Text Area
				CommonUtils.assertEquals("Waveless, Wavy, Sparse/having too little hair, Fine, Curly/wooly, East to pluck, Other", charmsNativeViewPage.nativeViewRasSurveyDescriptionOfParticipantsHairTextArea.getText());

				//Verifying Other hair description Text Box
				CommonUtils.assertEquals("THICK HAIR", charmsNativeViewPage.nativeViewRasSurveyOtherHairDescriptionTextBox.getAttribute("value"));

				//Verifying Diagnosed skin issues Text Area
				CommonUtils.assertEquals("Keratosis pilaris (patches of small, hard bumps often found on the upper arms. These look similar to goose bumps), Palmar/plantar hyperkeratosis (significant thickening of the skin on the palms of the hands or soles of the feet), Facial keratosis/Ulerythema ophryogenes (patches of dry, hard sandpaper-like bumps on the face, particularly in and near the eyebrows), Ichthyosis (dry, scaly skin), Other (please specify)", charmsNativeViewPage.nativeViewRasSurveyDiagnosedSkinIssuesTextArea.getText());

				//Verifying Other skin issues Text Box
				CommonUtils.assertEquals("VITILIGO", charmsNativeViewPage.nativeViewRasSurveyOtherSkinIssuesTextBox.getAttribute("value"));

				//Verifying Pigmented skin findings Text Area
				CommonUtils.assertEquals("Three or more cafe-au-lait spots (light brown birthmarks the color of coffee with milk), Diffuse hyperpigmentation (patches of skin that are darker than the rest of your skin), Three or more nevi (small brown, tan, pink or red spots, also called moles), Three or more lentigines (dark, smooth/flat freckles or spots on the skin), Other (please specify)", charmsNativeViewPage.nativeViewRasSurveyPigmentedSkinFindingsTextArea.getText());

				//Verifying Other pigmented findings Text Box
				CommonUtils.assertEquals("ALBINISM", charmsNativeViewPage.nativeViewRasSurveyOtherPigmentedFindingsTextBox.getAttribute("value"));

				//Verifying Diagnosed skin tumors Text Area
				CommonUtils.assertEquals("Granular cell tumor (soft tissue tumor, often benign, commonly located in the head and neck area and tongue), Melanoma, Dysplastic nevi, Papilloma (wart-like growths), Other (please specify)", charmsNativeViewPage.nativeViewRasSurveyDiagnosedSkinTumorsTextArea.getText());

				//Verifying Other skin tumors Text Box
				CommonUtils.assertEquals("BENIGN TUMOR", charmsNativeViewPage.nativeViewRasSurveyOtherSkinTumorsTextBox.getAttribute("value"));

				//Verifying Is the texture or amount of hair similar to a biological relatives? Drop Down
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyIsTheTextureOrAmountOfHairSimilarToABiologicalRelativesDropDown.getText());

				//Verifying Does the participant have any hemangiomas? Drop Down
				CommonUtils.assertEquals("Three or more hemangiomas", charmsNativeViewPage.nativeViewRasSurveyDoesTheParticipantHaveAnyHemangiomasDropDown.getText());


				// ------- SKELETAL DATA VERIFICATION --------
				charmsNativeViewPage.nativeViewRasSurveySkeletalTab.click();

				//Verifying Participant selects Yes to "Has the participant been evaluated by an orthopaedic surgeon?" Drop Down
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyHasTheParticipantBeenEvaluatedByAnOrthopaedicSurgeonDropDown.getText());

				//Verifying Name of orthopaedic surgeon Text Box
				CommonUtils.assertEquals("DOCTOR BASHIR ZIKRIA", charmsNativeViewPage.nativeViewRasSurveyNameOfOrthopaedicSurgeonTextBox.getAttribute("value"));

				//Verifying Location of Orthopaedic surgeon Text Box
				CommonUtils.assertEquals("BETHESDA, MD", charmsNativeViewPage.nativeViewRasSurveyLocationOfOrthopaedicSurgeonTextBox.getAttribute("value"));

				//Verifying Orthopaedic surgeons hospital or medical center affiliation Text Box
				CommonUtils.assertEquals("JOHNS HOPKINS", charmsNativeViewPage.nativeVIewRasSurveyOrthopaedicSurgeonsHospitalOrMedicalCenterAffiliationTextBox.getAttribute("value"));

				//Verifying Diagnosed skeletal findings Text Area Check if assertion error
				CommonUtils.assertEquals("Pectus carinatum (breastbone sticks out from the chest), Pectus excavatum (breastbone appears sunken or caved into the chest), Broad chest, nipples widely spaced, Other (please specify)", charmsNativeViewPage.nativeViewRasSurveyDiagnosedSkeletalFindingsTextArea.getText());

				//Verifying Other skeletal findings Text Box
				CommonUtils.assertEquals("RICKETS", charmsNativeViewPage.nativeViewRasSurveyOtherSkeletalFindingsTextBox.getAttribute("value"));

				//Verifying Participant selects Yes to "Does the participant have any issues with curving of the spine" Drop Down
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyDoesTheParticipantHaveAnyIssuesWithCurvingOfTheSpineDropDown.getText());

				//Verifying Participant selects Yes to "Has the participant's neck been described as short or webbed?" Drop Down
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyHasTheParticipantsNeckBeenDescribedAsShortOrWebbedDropDown.getText());

				//Verifying Participant selects Yes to "Has the participant ever been diagnosed with joint issues?" Drop Down
				CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyHasTheParticipantEverBeenDiagnosedWithJointIssuesDropDown.getText());
			
				//Asserts native view data table, Prenatal Test History, Medication Taken While Pregnant, Growth Hormone Details, Heart Symptoms, Heart Treatments, Participant Heart Issues
	...
	public void data_verification() throws TestingException, InvalidFormatException, IOException {
		...
		// Verifying Tobacco Products Used Around Mother During Pregnancy
		CommonUtils.assertEquals("Cigarettes, Cigars, Pipes, Other (please specify)",
				charmsNativeViewPage.nativeVIewRasSurveyTobaccoProductsUsedAroundMotherDuringPregnancy.getText());

		// Verifying Other Please Specify Tobacco Products Used Around Mother During
		// Pregancy textbox
		CommonUtils.assertEquals("JUUL",
				charmsNativeViewPage.nativeViewRasSurveyOtherTobaccoUsedAroundMotherDuringPregPleaseSpecifyTextbox
						.getAttribute("value"));
		...
		// Testing" dropdown
		CommonUtils.assertEquals("Yes",
				charmsNativeViewPage.nativeViewRasSurveyGrowthHasTheParticipantHadGrowthHormoneTesting.getText());

		//Verifying Participant Has the participant ever been evaluated by an endocrinologist for any reason? Dropdown
		CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyEvaluatedByEndocrinologistDropdown.getText());
		...
		CommonUtils.assertEquals("Yes",
				charmsNativeViewPage.nativeViewRasSurveyparticipantDiagnosedWithHypotoniaAsAnInfantOrChild.getText());
		...
		CommonUtils.assertEquals("Yes",
				charmsNativeViewPage.nativeViewRasSUrveyReceivedReceivedPhysicalTherapy.getText());
		...
		CommonUtils.assertEquals("Simple speech compared to other people the same age",
				charmsNativeViewPage.nativeVIewRasSurveyCurrentSpeechCapabilities.getText());

		// Verifying If Participant Ever Received Speech Therapy
		CommonUtils.assertEquals("Yes", charmsNativeViewPage.nativeViewRasSurveyEverReceivedSpeechTherapy.getText());
		...
		CommonUtils.assertEquals("Yes",
				charmsNativeViewPage.nativeViewRasSurveyReceiveOccupationalTherapyBetween3And6.getText());

		// Verifying Schooling between the ages of 6 and 10
		CommonUtils.assertEquals("Attended typical elementary school without support",
				charmsNativeViewPage.nativeViewRasSurveySchoolingBetweenSixAndTen.getText());
		...
		CommonUtils.assertEquals(
				"Short attention span - includes attention deficit disorder (ADD) and attention deficit hyperactivity diosrder (ADHD), "
						+ "Dyslexia/legasthenie - difficulty with language skills, particularly reading, due to problems relating speech sounds to letters and words, Dyscalculia - difficulty with math skills and understanding numbers and arithmetic, Other (please specify)",
				charmsNativeViewPage.nativeViewRasSurveyDiagnosedLearningDifferences.getText());
