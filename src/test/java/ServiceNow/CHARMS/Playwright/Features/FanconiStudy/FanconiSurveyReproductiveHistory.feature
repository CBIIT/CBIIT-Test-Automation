...
Feature: Reproductive History section of the Fanconi Survey on the Fanconi Longitudinal Cohort Study Portal
  Description:This feature file contains submission and assertion scenarios for the Reproductive History section of the Fanconi Survey by the proband or the legal guardian (Proxy)

  @jains @ReproductiveHistory @CP2-3178 @CP2-3133 @playwright @Fanconi_Regression
