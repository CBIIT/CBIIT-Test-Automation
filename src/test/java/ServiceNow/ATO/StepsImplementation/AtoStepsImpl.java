...
public class AtoStepsImpl extends AtoPage {
	...
	public void clickOnRenewButton() {
		clickOnElementByXpath(renewButtonXpath);
	}
	...
	public void setFormStatusToIssoPendingFSecond() {
		try {
			waitForElementIgnoreStaleException(
					By.xpath("//*[@name=\"x_g_nci_atoaas_system_security_plan.form_status\"]"));
			selectOption(find(By.xpath("//*[@name=\"x_g_nci_atoaas_system_security_plan.form_status\"]")),
					"Pending ISSO Review");
		} catch (Exception e) {
			throw e;
		}
