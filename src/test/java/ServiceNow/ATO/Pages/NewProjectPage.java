...
public class NewProjectPage extends BasePage{
	...
	@FindBy(id="verify_change")
	public WebElement verifyChange;
	
	@FindBy(xpath="//button[text()='Delete']")
	public WebElement deleteButton;
	
	@FindBy(xpath="//select[@aria-labelledby='label.x_g_nci_atoaas_eauthentication.involves_online_transactions']")
	public WebElement onlineTxnDropdown;
}