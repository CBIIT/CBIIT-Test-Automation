Feature: Top Accomplishments Submission
  ...
  @SS-4188 @bucurgb @Regression @Smoke @selenium @Progression
  Scenario: Verifying a Program Staff member sees options to Submit, Edit, and Delete for Top Accomplishments
    ...
    And on the CRS Knowledge Management System page, the Program Staff member sees options to Submit and Edit