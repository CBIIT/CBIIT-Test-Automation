...
public class CRSReviewers_Constants {

    /* TOP ACCOMPLISHMENTS THE GENETICS OF EPIGENETICS */
    public static final String TOP_ACCOMPLISHMENTS_THE_GENETICS_OF_EPIGENETICS = "The genetics and epigenetics of susceptibility to dietary-induced non-alcoholic fatty liver disease";

    /* CBIIT TEST ACCOUNT NAME  */
