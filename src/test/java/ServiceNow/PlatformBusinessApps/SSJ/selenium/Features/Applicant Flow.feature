Feature: Applicant Flow Scenarios
  ...
  @Regression @Nekrashevich @APPTRACK-758 @selenium
  ...
  @Regression @Nekrashevich @APPTRACK-712 @selenium
  ...
  @Regression @Nekrashevich @SSJ-948 @selenium
  ...
  @Regression @Nekrashevich @selenium
