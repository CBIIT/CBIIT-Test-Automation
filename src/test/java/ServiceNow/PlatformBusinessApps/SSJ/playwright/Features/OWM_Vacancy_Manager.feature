Feature: OWM Vacancy Manager Scenarios
  ...
  @SSJ-7 @SSJ-8 @juarezds @Regression @playwright @Smoke @SSJRegression_Part_1
...
#    #REVIEW ABOVE STEP WITH BA
  ...
  @SSJ-69 @juarezds @Regression @playwright @Smoke @SSJRegression_Part_1
  ...
  @SSJ-185 @SSJ-306 @juarezds @Regression @playwright @SSJRegression_Part_2
  ...
  @SSJ-11 @Regression @playwright @carberalf @SSJRegression_Part_1
