...
public class OBF_Notifications_Page {
     ...
     */
    public static String nv_Email_Notification_Application_Content_Line = "Application: " + OBF_NCI_NV_Form_Page.obf_NV_Page_Selected_Application_OneStream_BUS_Value;
