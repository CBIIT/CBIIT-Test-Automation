...
public class OBF_Notifications_StepImpl {
    ...
    public static void i_submit_a_ticket_for_and_the_ticket_is_approved() {
        ...
        page.frameLocator(OBF_NCI_NV_Form_Page.nv_Page_Frame_Locator).getByLabel(OBF_NCI_NV_Form_Page.obf_NV_Page_Preview_Record_Ticket_Number).click();
    ...
    public static void the_requested_for_should_get_a_notification() {
        ...
        page.frameLocator(OBF_NCI_NV_Form_Page.nv_Page_Frame_Locator).getByRole(AriaRole.CELL, new FrameLocator.GetByRoleOptions().setName(OBF_Notifications_Page.nv_Email_First_Row_Search_Drop_Down_Field).setExact(true)).locator(OBF_Notifications_Page.nv_Email_First_Row_Search_Drop_Down_Field_Locator).click();
        page.frameLocator(OBF_NCI_NV_Form_Page.nv_Page_Frame_Locator).getByRole(AriaRole.COMBOBOX, new FrameLocator.GetByRoleOptions().setName(OBF_Notifications_Page.nv_Email_Search_Drop_Down_Field_Choose_Option).setExact(true)).click();
        page.frameLocator(OBF_NCI_NV_Form_Page.nv_Page_Frame_Locator).getByRole(AriaRole.COMBOBOX, new FrameLocator.GetByRoleOptions().setName(OBF_Notifications_Page.nv_Email_Search_Drop_Down_Field_Choose_Option).setExact(true)).fill(OBF_Notifications_Page.nv_Email_Search_Recipients_Option);
        page.frameLocator(OBF_NCI_NV_Form_Page.nv_Page_Frame_Locator).getByRole(AriaRole.COMBOBOX, new FrameLocator.GetByRoleOptions().setName(OBF_Notifications_Page.nv_Email_Search_Drop_Down_Field_Choose_Option).setExact(true)).press(OBF_Notifications_Page.press_Enter_Key);
        page.frameLocator(OBF_NCI_NV_Form_Page.nv_Page_Frame_Locator).getByLabel(OBF_Notifications_Page.nv_Email_First_Row_Operator_Condition).selectOption(OBF_Notifications_Page.nv_Email_Operator_Condition_Select_Option_IS);
        page.frameLocator(OBF_NCI_NV_Form_Page.nv_Page_Frame_Locator).getByLabel(OBF_Notifications_Page.nv_Email_Search_Recipients_Option, new FrameLocator.GetByLabelOptions().setExact(true)).click();
        page.frameLocator(OBF_NCI_NV_Form_Page.nv_Page_Frame_Locator).getByLabel(OBF_Notifications_Page.nv_Email_Search_Recipients_Option, new FrameLocator.GetByLabelOptions().setExact(true)).fill(OBF_Notifications_Page.nv_Email_First_Row_Recipient_Email);
        ...
        page.frameLocator(OBF_NCI_NV_Form_Page.nv_Page_Frame_Locator).getByRole(AriaRole.CELL, new FrameLocator.GetByRoleOptions().setName(OBF_Notifications_Page.nv_Email_Second_Row_Search_Drop_Down_Field).setExact(true)).locator(OBF_Notifications_Page.nv_Email_First_Row_Search_Drop_Down_Field_Locator).click();
        page.frameLocator(OBF_NCI_NV_Form_Page.nv_Page_Frame_Locator).getByRole(AriaRole.COMBOBOX, new FrameLocator.GetByRoleOptions().setName(OBF_Notifications_Page.nv_Email_Search_Drop_Down_Field_Choose_Option)).fill(OBF_Notifications_Page.nv_Email_Search_Email_Subject_Option);
        page.frameLocator(OBF_NCI_NV_Form_Page.nv_Page_Frame_Locator).getByRole(AriaRole.COMBOBOX, new FrameLocator.GetByRoleOptions().setName(OBF_Notifications_Page.nv_Email_Search_Drop_Down_Field_Choose_Option)).press(OBF_Notifications_Page.press_Enter_Key);
