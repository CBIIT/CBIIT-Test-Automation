package ServiceNow.PlatformBusinessApps.SEER.Pages;
...
public class NativeViewAccessRequestPage extends CommonUtils {
    ...
    /**NativeView Access Request Save Changes Discard Button1*/
    @FindBy(xpath = "//button[normalize-space()='Discard']")
    public WebElement nativeViewAccessRequestSaveChangesDiscardButton1;

    /**NativeView Access Request Save Changes Discard Button*/
    @FindBy(xpath = "//div[@class='now-modal-footer'][3]")
    public WebElement nativeViewAccessRequestSaveChangesDiscardButton;

    /* IMPERSONATE WINDOW USER BUTTON  */
    @FindElementBy(xpath = "//div[@class='now-modal-footer']/now-button[3]")
    ...
    /**NativeView Access Request Save Button */
    @FindBy(xpath = "//button[@id='sysverb_insert_and_stay']")
    public WebElement nativeViewAccessSaveButton;
