package ServiceNow.PlatformBusinessApps.SEER.Constants;
...
public class DUA_Constants {
    ...
    public static final String SEER_DATA_ACCESS_REQUEST_INSTITUTION_URL = "https://service-test.nci.nih.gov/seer-data-access?id=seer_data_access_request&sysparm_user=7a3c0aa587544a506cad86e7cebb35f4";
    ...
    public static final String NCCR_REASEARCH_DATA_USER_AGREEMENT ="National Childhood Cancer Registry (NCCR) Research Data Use Agreement\n" +
            ...
            "No Data Linkage across SEER Databases: Authorized User will not attempt to link data from individual NCCR Databases with Research Plus or other Specialized or Customized Databases. This includes, but is not limited to, combining two or more NCCR or SEER Databases to which Authorized User has access. Analyses using Authorized data for approved projects with a government-provided encrypted identifier are permitted.\n" +
            "No Re-Identification of Individuals: Authorized User will not attempt to learn the identity of any individual whose Data is contained in the Databases or share information that would lead to the identification of individuals described in the Databases. If Authorized User or any other person inadvertently discovers the identity of an individual whose Data is in the Databases, Authorized User will: (a) make no use of this knowledge, including informing others, other than NCI Surveillance Research Program (SRP), of the discovered identity, (b) not contact any individual, and (c) notify NCI SRP of the incident under Section 10, below. Authorized User agrees not to generate information from Data that could allow the identities of individuals to be readily ascertained.\n" +
            ...
            "No Attempt to identify any Geography Area: Authorized User will not attempt to identify or infer any geographic area if they are not specifically released in the Database (e.g., identify state, registry, or county, etc. if they are not included in the specific Database).\n" +
            "No Attempt to identify any Data Source: Authorized User will not attempt to identify or infer any data source or individual healthcare provider or healthcare facility (e.g., hospital, laboratory, oncology office, etc.).\n" +
