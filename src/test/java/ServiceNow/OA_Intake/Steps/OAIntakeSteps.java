...
public class OAIntakeSteps extends PageInitializer {
    ...
    public void submitter_user_can_fill_in_psc_code_field_as(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void submitter_user_can_enter_for_please_enter_the_estimated_value_of_it_and_or_biomedical_computing_requirement_field(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void submitter_user_can_enter_for_sso_clearance_ticket_field(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Then("Submitter User can see ISSO Clearance Ticket Status field")
    public void submitter_user_can_see_isso_clearance_ticket_status_field() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @Then("Submitter User can confirm they are redirected to {string} page")
    public void submitter_user_can_confirm_they_are_redirected_to_page(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @Then("Submitter User chooses Internal NCI Call Task Order option on BPA IDIQ as Yes")
    public void submitter_user_chooses_internal_nci_call_task_order_option_on_bpa_idiq_as_yes() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
