...
Feature: Native View Scenarios
  ...
  @New @Smoke @updatedFeb042021 @Daniyar 
  Scenario: Native View My Inquiry Tracking Records - Verify Add Assigned Nurses Field
    Given a Study Nurse is in Native View
