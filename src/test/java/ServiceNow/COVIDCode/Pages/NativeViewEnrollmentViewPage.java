...
public class NativeViewEnrollmentViewPage extends CommonUtils {
	...
	/** --------------- NATIVE VIEW COVIDcode ENROLLMENT VIEW  ---------------  */ 
	...
	@FindBy(xpath = "//*[@id='x_g_nci_geco_covid_geco_covid_19_enrollment.user_group_id']") // Found
	...
	@FindBy(xpath = "//*[@id='x_g_nci_geco_covid_geco_covid_19_enrollment.zip_code']")
	 ...
	 */
	@FindBy(xpath = "//*[@id='x_g_nci_geco_covid_geco_covid_19_enrollment.date_of_birth']")
	...
	@FindBy(xpath = "//select[@id='x_g_nci_geco_covid_geco_covid_19_enrollment.height_choice']")
	...
	@FindBy(xpath = "//*[@id='x_g_nci_geco_covid_geco_covid_19_enrollment.height_feet']")
	...
	@FindBy(xpath = "//*[@id='x_g_nci_geco_covid_geco_covid_19_enrollment.height_inches']")
	 ...
	 * down
	 */
	@FindBy(xpath = "//select[@id='x_g_nci_geco_covid_geco_covid_19_enrollment.weight_choice']")
	...
	/** --------------- NATIVE VIEW COVIDcode ENROLLMENT VIEW PARTICIPANT EVENTS SECTION TABLE ---------------  */ 
