...
public class ServicePortalQuestionnairePageImp extends PageInitializer {
	...
	public void startNewFollowUpQuestionnaire() throws TestingException {
		...
		CommonUtils.selectValueFromBootStrapDropDown(servicePortalQuestionnairePage.enrollmentLookUpPatientIDSearchValues, "HCC0001198");
	...
	public void verifyingEnrollmentCreationPopUp(String enrollmentCreation, String userGroupID1, String userGroupID2, String userGroupId3) {
		Assert.assertTrue(servicePortalQuestionnairePage.enrollmentCreationTitle.getText().contentEquals(enrollmentCreation));
