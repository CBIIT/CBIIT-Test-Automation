...
public class NativeViewStepsImpl extends PageInitializer {
	...
	/***
	 * The below method navigates and fills out demographics section for an enrollment
	 * questionnaire in Native View
	...
	/***
	 * The below method navigates to and fills out the Symptomology section for an enrollment
	 * questionnaire in native view
	 * values are hard coded
	 */
	...
	/***
	 * The below navigates to and fills out the Exposures and Risk Factors section for an
	 * enrollment questionnaire in native view
	 * Values are hard coded
	 */
	 ...
	 * for an enrollment questionnaire and entering a consent date
	 * values are hard coded
	 */
	...
	/***
	 * This method navigates to a new COVIDcode enrollment questionnaire form in native view
	 */
	...
	/***
	 * This method consents, chooses group ID, and fills out patient basic information on the enrollment questionnaire form in Native View
	 * values are hard coded
	 */
	public void nativeViewConsentingWithGroupIDandFillPatientBasicInfo(String group, String consent) {
		...
		CucumberLogUtils.logScreenShot();
		CommonUtils.selectDropDownValue(group, nativeViewEnrollmentViewPage.nativeViewEnrollmentViewUserGroupIDDropDown);
	 ...
	 * Values are hard coded
	 * This method is to follow any enrollment that has been submitted with the email address email@automatedtest.com
	 */
	public void nativeViewVerifyingEnrollmentQuestionnaireWasSubmitted() {
		MiscUtils.sleep(2000);
		/*
		 * Clicking on the 'All' breadcrumb is necessary to properly search without added filters - refer to UI for further review
		 */
		nativeViewEnrollmentViewPage.nativeViewAllBreadCrumbLink.click();
		MiscUtils.sleep(1000);
		CommonUtils.selectDropDownValue("Contact Email Address", nativeViewEnrollementsPage.covidCodeEnrollmentsSearchDropDown);
