Feature: Applicant Flow Scenarios
  ...
  @Regression @Smoke @Nekrashevich @SSJ-758
  ...
  @Regression @Smoke @Nekrashevich @SSJ-712
  Scenario: User chooses to share Demographics
    And User is on Profile tab
  ...
  @Regression @Smoke @Nekrashevich @SSJ-948
