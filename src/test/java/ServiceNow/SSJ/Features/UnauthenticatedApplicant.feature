Feature: Unauthenticated applicant Scenarios
  ...
  @Regression  @Nekrashevich @SSJ-124  @SSJ-365
  ...
  @Regression  @Nekrashevich  @SSJ-31
  ...
  @Regression  @Nekrashevich @SSJ-122 @SSJ-36
  ...
  @Regression  @Nekrashevich @SSJ-298
  ...
  @Regression   @Nekrashevich @SSJ-27
