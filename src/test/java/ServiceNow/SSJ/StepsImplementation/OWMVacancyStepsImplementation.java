...
//        CommonUtils.sendKeys(owmVacancyPage.vacancyOpenDateTextBox, OWMVacanciesConstants.TODAYS_DATE);
    ...
    public void usedNavigatesToSeeReports(String reports) {
        ...
        CommonUtils.assertEqualsWithMessage(NativeViewSSJConstants.FOCUS_AREA_REPORTING_TEXT , nativeViewSCSSReportsPage.focusAreaReportingText.getText(), "-- VERIFYING FOCUS AREA REPORTING TEXT --");
        JavascriptUtils.scrollIntoView(nativeViewSCSSReportsPage.nativeViewReportsText(NativeViewSSJConstants.VACANCY_DATES_OPEN_CLOSE_TEXT));
        CommonUtils.assertEqualsWithMessage(NativeViewSSJConstants.VACANCY_DATES_OPEN_CLOSE_TEXT, nativeViewSCSSReportsPage.nativeViewReportsText(NativeViewSSJConstants.VACANCY_DATES_OPEN_CLOSE_TEXT).getText(), "-- SCSS VACANCY DATES - OPEN AND CLOSE TEXT --");
        JavascriptUtils.scrollIntoView(nativeViewSCSSReportsPage.nativeViewReportsText(NativeViewSSJConstants.VACANCY_DATES_INDIVIDUAL_SCORING_TEXT));
        CommonUtils.assertEqualsWithMessage(NativeViewSSJConstants.VACANCY_DATES_INDIVIDUAL_SCORING_TEXT, nativeViewSCSSReportsPage.nativeViewReportsText(NativeViewSSJConstants.VACANCY_DATES_INDIVIDUAL_SCORING_TEXT).getText(), "-- SCSS VACANCY DATES - INDIVIDUAL SCORING TEXT --");
        JavascriptUtils.scrollIntoView(nativeViewSCSSReportsPage.nativeViewReportsText(NativeViewSSJConstants.APPLICANT_DECISION_DATE_TEXT));
        CommonUtils.assertEqualsWithMessage(NativeViewSSJConstants.APPLICANT_DECISION_DATE_TEXT, nativeViewSCSSReportsPage.nativeViewReportsText(NativeViewSSJConstants.APPLICANT_DECISION_DATE_TEXT).getText(), "-- SCSS APPLICANT DECISION DATE TEXT --");
    }
}