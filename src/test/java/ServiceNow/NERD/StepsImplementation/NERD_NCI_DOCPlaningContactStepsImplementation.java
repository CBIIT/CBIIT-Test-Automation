...
public class NERD_NCI_DOCPlaningContactStepsImplementation extends PageInitializer {
    ...
    /**
     * This method will resubmit the existing Submission by DOC Planing Contact to CRS Reviewer
     *
     * @param submissionName
     */
    public static void resubmittingOfSubmissionByDOCContactToCRSREviewer(String submissionName) throws TestingException {
        nativeViewImpersonateUser.impersonateToDocPlanningContact();
        WebDriverUtils.webDriver.get(EnvUtils.getApplicationUrl("NERD"));
        CommonUtils.waitForVisibility(
                nerdCrsKnowledgeDatabaseSubmissionsPage.crsKnowledgeManagementSystemSubmissionsPageCollaborationsLink);
     ...
     * @param FiscalYear
     */
    public static void fillingOutRequiredFieldsByDOCPlaningContact(String submissionName, String PleaseSpecify, String FiscalYear) throws TestingException {
        nativeViewImpersonateUser.impersonateToDocPlanningContact();
        WebDriverUtils.webDriver.get(EnvUtils.getApplicationUrl("NERD"));
        CommonUtils.waitForVisibility(
                nerdCrsKnowledgeDatabaseSubmissionsPage.crsKnowledgeManagementSystemSubmissionsPageCollaborationsLink);
     ...
     * @param FiscalYear
     */
    public static void verifyingByDOCContactThatFieldsOfSubmissionAreClearedAndRequired(String submissionName, String PleaseSpecify, String FiscalYear) throws TestingException {
        nativeViewImpersonateUser.impersonateToDocPlanningContact();
        WebDriverUtils.webDriver.get(EnvUtils.getApplicationUrl("NERD"));
        WebDriverUtils.webDriver.navigate().refresh();
        MiscUtils.sleep(5000);
     ...
     * @param submissionName
     */
    public static void returningSubmissionToProgramStaffByDOCContact(String submissionName) throws TestingException {
        nativeViewImpersonateUser.impersonateToDocPlanningContact();
        WebDriverUtils.webDriver.get(EnvUtils.getApplicationUrl("NERD"));
        WebDriverUtils.webDriver.navigate().refresh();
     ...
     * @param submissionName
     */
    public static void creatingOfCollaborationSubmissionByDOCPlaningContact(WebElement SubmissionType, String submissionName) throws TestingException {
        nativeViewImpersonateUser.impersonateToDocPlanningContact();
        WebDriverUtils.webDriver.get(EnvUtils.getApplicationUrl("NERD"));
        MiscUtils.sleep(1000);
        ...
        JavascriptUtils.scrollIntoView(createNewSubmissionPage.productsOutputsListResearchToolDevelopmentCheckBox);
        ...
        CommonUtils.selectDropDownValue("Strategic Goal 2: Protect the Health of Americans Where They Live, Learn, Work, and Pay",
