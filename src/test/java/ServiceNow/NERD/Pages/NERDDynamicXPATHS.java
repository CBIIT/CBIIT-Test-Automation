...
public class NERDDynamicXPATHS extends CommonUtils {
	...
	/** ------------ CRS BUTTONS ------------ */
	/**
	 * This locators will work on CRS pages for staff member with all links such as:
	 * Top Accomplishments, Collaborations and etc For Submit button - we can use
	 * Submit to CRS Button locator.
	 * 
	 */
