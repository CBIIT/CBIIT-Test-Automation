...
public class NERDSubmissionsPage extends CommonUtils {
	...
	/**
	 *  ------------ BEGINNING OF CRS Knowledge Management System Submissions Page COVID-19 Activities ------------
	 */	
	...
	/** COVID-19 Activities This Activity Aligns With The Following NIH Covid-19 Strategic Plan Text */
	...
	/**
	 *  ------------ END OF CRS Knowledge Management System Submissions Page COVID-19 Activities ------------
	 */
	...
	/** ------------ THE BEGINNING OF NCI CANCER DATA STANDARDS REPOSITORY AND REGISTRY (CADSR) PAGE -----------*/
	...
	/** ------------ END OF NCI CANCER DATA STANDARDS REPOSITORY AND REGISTRY (CADSR) PAGE -----------*/
	...
	/** Yes Button for Are you ready to submit this entry to DOC Planning Contact? Pop Up */
	...
	/** Collaboration Select Type Of Collaborative Activity Check Boxes Committee, Work Group, or Advisory Group 
       Check Box */
	@FindBy(xpath="(//div)[236]")
	public WebElement collaborationCommitteeWorkGroupOrAdvisoryGroupCheckBox;

	/** Collaboration IF COMMITTEE IS SELECTED ABOVE, Is this a FACA committee Drop Down */
	@FindBy(xpath="//div[31]//div[2]//select[1]")
	public WebElement collaborationIfCommitteeIsSelectedAoveIsThisAFacaCommitteeDropDown;

	/** Collaboration Is this collaboration related to a regulatory activity? Drop Down */
	...
	/** Collaboration Are you ready to submit this entry to DOC Planning Contact? Yes Button  */
