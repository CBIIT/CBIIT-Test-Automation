...
public class NERDCollaborationSubmissionSteps extends PageInitializer {
    ...
    public void user_is_on_the_COVID19_Activities_submissions_page() throws TestingException {
        ...
        NERDApplicationStepsImplementation
                .creatingNewSubmission(nerdCrsKnowledgeDatabaseSubmissionsPage.covid19CreateNewSubmissionButton);
    }
    ...
    public void the_section_displays(String thisActivityAlignsWithTheFollowingNIHCovid19StrategicPlan) {
        NERDApplicationStepsImplementation
                .sectionOfCovid_19_SubmissionIsDisplayed(thisActivityAlignsWithTheFollowingNIHCovid19StrategicPlan);
    }
    ...
    public void the_following_check_box_options_are_also_displayed(String covid19, String communications, String rare,
        ...
        NERDApplicationStepsImplementation.checkBoxOptionsAreDisplayed(covid19, communications, rare,
                bigDataDataSharing, researchResourcesAndInfrastructure, sexGenderDifferences, partnerships,
                technologyDevelopment, trainingWorkforceDevelopment, workforce, metastatic, meetingWorkshopConference,
