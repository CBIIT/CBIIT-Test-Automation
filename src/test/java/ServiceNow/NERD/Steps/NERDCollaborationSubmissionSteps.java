...
public class NERDCollaborationSubmissionSteps extends PageInitializer{
	...
	public void creates_a_new_submission_for_Collaboration_category() {
		CommonUtils.click(nerdCrsKnowledgeDatabaseSubmissionsPage.crsKnowledgeManagementSystemSubmissionsPageCollaborationsCreateNewSubmissionLink);
	...
	public void the_created_Collaborations_submission_is_displays_in_the_Collaborations_category_section_with_the_status(String string) throws TestingException {
	    ...
	    MiscUtils.sleep(1000);
	    CommonUtils.selectDropDownValue(createNewSubmissionPage.nihStrategicAlignment_Primary_DropDown, "4.2 Balance Outputs with Outcomes");
	    CommonUtils.selectDropDownValue(createNewSubmissionPage.nihStrategicAlignment_SecondaryOptional_DropDown, "4.2 Balance Outputs with Outcomes");
	    CommonUtils.selectDropDownValue(createNewSubmissionPage.hhsStrategicPlanAlignment_Primary_DropDown, "1.4: Strengthen and expand the healthcare workforce to meet America's diverse needs");
	    CommonUtils.selectDropDownValue(createNewSubmissionPage.hhsStrategicPlanAlignment_SecondaryOptional_DropDown, "1.4: Strengthen and expand the healthcare workforce to meet America's diverse needs");
	    MiscUtils.sleep(1000);
	    CucumberLogUtils.logScreenShot();
		...
		CucumberLogUtils.logScreenShot();
		Assert.assertEquals("Under Review", createNewSubmissionPage.crsKnowledgeManagementSystemAutomationTestUnderReviewText.getText());
		...
		MiscUtils.sleep(5000);
		CommonUtils.click(nerdCrsKnowledgeDatabaseSubmissionsPage.crsKnowledgeManagementSystemSubmissionsPageCollaborationsLink);
		MiscUtils.sleep(1000);
		...
		MiscUtils.sleep(2000);
		Assert.assertEquals("Submission has been successfully deleted.", createNewSubmissionPage.crsKnowledgeManagementSystemSubmissionHasBeenSuccessfullyDeletedPopUpText.getText());
		CucumberLogUtils.logScreenShot();
