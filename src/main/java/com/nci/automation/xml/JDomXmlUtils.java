...
public class JDomXmlUtils {
     ...
     * 
     * @NOTE: Beaware this method will remove all the elements that matches the
     *        given xpath in the xmlcontent.
     * 
     * @param xmlContent
     *                   the xml document.
     * 
     * @param xPath
     *                   xPath of the element/elements that needs to be removed from
     *                   the given {@code xmlContent}
     * 
     * @throws JDOMException
     *                       if there is any error while parsing the xml for the
     *                       xpath.
     * 
     */
    ...
    /**
     * This method will set the given {@code text} to the xml elements that matches
     * the given xpath expression with in
     * the given {@code xmlContent}.
     * 
     * @param xmlContent
     *                   The xml string to whose matching elements the will have to
     ...
     * 
     */
    public static String setElementText(String xmlContent, String xPath, String text)
    ...
    /**
     * Returns the list of elements that matches the given {@code xPath expression}
     * with in the parent {@code context}
     * 
     * @param context
     *                the xml element with in which xPath expression will be
     *                evaluated.
     * 
     * @param xPath
     *                the xPath expression
     * 
     * @return Returns the list of xml elements that matches the given {@code xPath}
     *         expression in the given element
     */
    ...
    /**
     * Returns the root element of the xml document represented by given
     * {@code xmlContent}
     * 
     * @param xmlContent
     *                   the xmlContent whose root element is required.
     * 
     * @returns Returns the root element as described above. It will return null if
     *          some reason there if the content is
    ...
    /**
     * Returns the list of xml elements that matches the given {@code xPath}
     * expression.
     * 
     * @param xmlContent
     *                   the xml String against which the {@code xPath} will be
     *                   evaluated
     * 
     * @param xPath
     *                   the xpath expression.
     ...
     * 
     * @param xmlFile
     *                the xml file in against which the {@code xPath} will be
     *                evaluated.
     * 
     * @param xPath
     *                the xpath expression.
     * 
     * @return Returs the list of elements that matches the given {@code xPath}
     *         expression
     * @throws TestingException
     */
    ...
    /**
     * Returns the list of element values that matches the given
     * {@code xPath expression} with in the parent
     * {@code context}.
     * 
     * NOTE:This method assumes this result elements are leaf elements and contains
     * text value.
     * 
     * @param context
     *                the xml element with in which xPath expression will be
